...
class Materialdc_model extends CI_Model {




	        var $table = 'materialdc_details';
...
return $query=$this->db->get('materialdc_details')->result_array();
...
return $query->result_array();
	...
	{
          $this->db->insert('materialdc_details',$data);
  ...
  {       
          $this->db->where('id',$id);
          $this->db->update('materialdc_details',$data);
          return $this->db->affected_rows()!=1? false:true;
  }
	...
	{
		$this->db->select('*');
		$this->db->from('materialdc_details');
