...
class Oldjoborderdc_model extends CI_Model {


	        var $table = 'jobworkdc_details_backup';
...
return $query=$this->db->get('jobworkdc_details_backup')->result_array();
...
return $query->result_array();
	...
	{
          $this->db->insert('jobworkdc_details_backup',$data);
  ...
  {       
          $this->db->where('id',$id);
          $this->db->update('jobworkdc_details_backup',$data);
          return $this->db->affected_rows()!=1? false:true;
  }
	...
	{
		$this->db->select('*');
		$this->db->from('jobworkdc_details_backup');
