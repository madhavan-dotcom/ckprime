...
class Oldmaterialdc_model extends CI_Model {




	        var $table = 'materialdc_details_backup';
...
return $query=$this->db->get('materialdc_details_backup')->result_array();
...
return $query->result_array();
	...
	{
          $this->db->insert('materialdc_details_backup',$data);
  ...
  {       
          $this->db->where('id',$id);
          $this->db->update('materialdc_details_backup',$data);
          return $this->db->affected_rows()!=1? false:true;
  }
	...
	{
		$this->db->select('*');
		$this->db->from('materialdc_details_backup');
