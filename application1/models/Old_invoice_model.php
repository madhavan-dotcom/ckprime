...
class Old_invoice_model extends CI_Model {


        var $table = 'invoice_details_backup';
...
$this->db->where('customername',$this->session->userdata('rcbio_cusname'));
    }
    ...
    if($gsttype=='sgst')
    {
      $this->db->where('typesgst',$this->session->userdata('rcbio_gsttype'));
    }
       if($gsttype=='cgst')
    {
      $this->db->where('typecgst',$this->session->userdata('rcbio_gsttype'));
    }

    if($gsttype=='igst')
    {
      $this->db->where('typeigst',$this->session->userdata('rcbio_gsttype'));
    }
...
$this->db->where('invoiceno',$this->session->userdata('rcbio_invoiceno'));
    }
return $query=$this->db->get('invoice_details_backup')->result_array();
...
public function delete_by_id($id)
{
    ...
    {
        $this->db->insert('invoice_details_backup',$data);
        return $this->db->affected_rows()!=1? false:true;
    }
    ...
    {
        $this->db->select('*');
        $this->db->from('invoice_details_backup');
    ...
    public function update_invoice($data,$id)
    {
        ...
        $this->db->where('id',$id);
        $this->db->update('invoice_details_backup',$data);
        return $this->db->affected_rows()!=1? false:true;
    }
       ...
       public function search_pending()
    {
        ...
        return $query= $this->db->where('balance >',0)->get('invoice_details_backup')->result_array();
