...
<div class="caption">
<i class="fa fa-reorder"></i>HSN Master Reports
</div>
<div class="tools">
<a href="javascript:void();" data-toggle="collapse" data-target="#form_div" style="color:white;"> <i class="fa fa-plus"></i> Add HSN</a>&nbsp;
</div>
</div>
<div class="portlet-body form">
<!-- BEGIN FORM-->
<div class="well collapse <?php //if ($id != ""){ echo "in";} ?>" id="form_div">
<form class="horizontal-form" id="form" method="post" action="<?php echo base_url();?>hsnMaster/insert">
<div class="form-body">
<div class="row">
<div class="col-md-3">
&nbsp;
...
<label class="control-label col-md-3">HSNNO</label>
<div class="col-md-9">
<input type="text" class="form-control" name="hsnno" id="hsnno" value="" >
...
<button  class="btn btn-primary" id="submit" type="submit">Add HSN</button>
...
<td class=""><?php echo $row['hsnno'];?>&nbsp;&nbsp;</td>
...
<div class="row">
<form name="form" action="<?php echo base_url();?>hsnMaster/delete" method="post" id="form1">
...
{
uom.focus();
$('#uom_valid').html('<span><font color="red"> Enter the HSNNO  </span>');
uom.keyup(function(){
$('#uom_valid').html('');
});
return false;
...
{
$('#uom').focus();
$('#uom_valid').html('<span><font color="red"> HSNNO Already Exists!</span>');
return false;
}
}
});
