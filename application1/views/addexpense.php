					...
					<div class="col-sm-12">
						<section>
							<header class="panel-heading" style="color:rgb(255, 255, 255);background: #2477c9;">
								<i class="zmdi zmdi-money-box"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Expenses</i>  ( <?php echo $expensesid;?> )</span>
							</header>
							<div class="card-box">
								<div class="row">
									<form class="form-horizontal" role="form" method="post"  action="<?php echo base_url();?>expenses/insert">
										<!--       
										<div class="form-group">
											<label for="inputPassword" class="col-lg-3 control-label">Bill No</label>
											<div class="col-lg-3">
												<input type="text" name="billno" class="form-control" id="billno" placeholder=""  value="" readonly>
											</div>
											<label for="inputPassword" class="col-lg-2 control-label">Tin No</label>
											<div class="col-lg-3">
												<input type="text" name="tinno" class="form-control" id="tinno" placeholder=""  value="" >
											</div>
										</div>  -->
										...
										<div class="form-group">
											...
											<div class="col-lg-4">
												<input type="text" name="expensesdate" class="form-control datepicker-autoclose" id="datepicker-autoclose" placeholder=""  value="<?php echo date('d-m-Y');?>" required>
											</div>
											<!--   
											<label for="inputPassword" class="col-lg-2 control-label">Tin No</label>
											<div class="col-lg-3">
										...
										<div class="form-group">
											...
											<div class="col-lg-4">
												...
												<input type="hidden" name="expensesid" value="<?php echo $expensesid;?>" class="form-control" placeholder="" readonly>
											</div>
										</div>

										<div class="form-group">
											<label for="inputStandard" class="col-lg-3 control-label" style="color:red;">Name <span style="color:red;font-size:18px;">*</span></label>
											<div class="col-lg-4">
										...
										<div class="form-group">
											<label for="inputPassword" class="col-lg-3 control-label" style="color:red;">Purpose<span style="color:red;font-size:18px;">&nbsp;*</span></label>
											<div class="col-lg-4">
										...
										<div class="form-group">
											...
											<div class="controls col-sm-1" style="width:125px;">
												<input type="radio" name="paymentmode" id="optionsRadios3" value="Bank" onchange="bank()" required> RTGS/ Neft
											</div>
											<div class="controls col-sm-1" style="width:142px;">
												<input type="radio" name="paymentmode" id="optionsRadios4" value="Card" onchange="card()" required> Card
											</div>
										</div>

										<div  id="through" class="form-group" >
											<div class="form-group">                                
												<label class="control-label col-sm-3" style="color:red;">Bank Name</label>
												<div class="col-lg-3">
											...
											<div class="form-group">                                
												<label class="control-label col-sm-3" style="color:red;">Cheque No</label>
												<div class="col-lg-3">
											...
											<div class="form-group">                                
												<label class="control-label col-sm-3" style="color:red;">Amount</label>
												<div class="col-lg-3">
