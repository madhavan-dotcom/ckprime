...
<i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Inward Pending Reports</span></i>
</header>
...
<td><?php echo $u['customerdcno'];?></td>
<td><?php echo $u['cusname'];?></td>
<td><?php echo $u['itemcode'];?></td>
<td><?php echo $u['heatno'];?></td>
