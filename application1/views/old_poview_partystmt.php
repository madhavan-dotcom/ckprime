...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $( "#suppliername" ).autocomplete({
      ...
      source: function(request, response) {
        $.ajax({ 
          url: "<?php echo base_url();?>old_purchase_statement/autocomplete_invoiceno",
...
"ajax": {
  "url": "<?php echo site_url('old_purchase_statement/ajax_list')?>",
  "type": "POST",
  "data": function ( data ) {
...
$('#print').click(function(){
  ...
  $.post('<?php echo base_url();?>old_purchase_statement/search',{'fromdate':fromdate,'suppliername':suppliername,'todate':todate,'invoiceno':invoiceno},function(data){

    window.open('<?php echo base_url();?>old_purchase_statement/search_reports', '_blank');
...
$('#download').click(function(){
 var fromdate = $('#fromdate').val();
  ...
  $.post('<?php echo base_url();?>old_purchase_statement/billing_reportdownload',{'fromdate':fromdate,'todate':todate,'invoiceno':invoiceno,'suppliername':suppliername},function(data){
