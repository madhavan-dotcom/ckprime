...
<?php }?>
<td><input class="itemname_class" style="width: 250px;" data-id="0" id="itemname0" parsley-trigger="change" required  type="text" name="itemname[]" value="" ><div id="itemname_valid0"></div><input type="text" name="item_desc[]" value="" placeholder="Description" style="margin-top: 2px;" ><input type="hidden" name="priceType[]" id="priceType0" /></td>
...
<td><input class="discount_class decimals" data-id="0" id="discount0"  type="text" name="discount[]" maxlength="2" onkeypress="return isNumberKey_With_Dot(event)" value="0"  autocomplete="off"><div id="discount_valid0"></div></td>
