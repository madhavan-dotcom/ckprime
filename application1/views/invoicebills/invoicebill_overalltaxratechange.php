...
<tr>
<td width="150" ><img src="<?php echo base_url();?>upload/<?php echo $profileimage->image;?>" width="180" height="50" alt="logo" /></td>
...
<tr>
	<td width="434" style="font-size:14px;border-right:1px solid black;">
		<table>
			<tr>
				<td width="500" style="font-size:16px;" ><b>&nbsp;Bill To <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $bil->customername;?></b></td>
			</tr>
			<tr>
	<td width="500"  valign="top" style="font-size:16px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo @$addresss1;?>,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo @$addresss2;?></td>
	</tr>
	<tr>
	<td width="500"  style="font-size:16px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo @$citys;?>&nbsp;,&nbsp;<?php echo $states; ?>-<?php echo @$pincode;?>,<?php echo @$mobileno;?></td>
	</tr>
	<tr>
<td width="500" style="font-size:16px;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;GSTIN:<?php echo @$gstnos;?><span style="float:right">State Code : <?php echo @$statecode;?></span></b></td>
...
<?php $odate=$orderdate; if($odate == '1970-01-01' || '1969-12-31'){echo "";}else{ $order_date=date('d/m/Y',strtotime($odate)); echo date('d/m/Y',strtotime($orderdate));}?>
</b></td>
</tr>
<tr>
<tr>
<td style="font-size:14px;">&nbsp;&nbsp;&nbsp;Delivery At&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:<b>&nbsp;
...
<table width="<?php echo $page_width;?>"   height="450" align="center"  style="border-bottom:1px solid black;border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;">
...
<td width="<?php echo $itemwidth;?>" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center"><b>Description</b></td>
<td width="38" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center"><strong>HSN</strong></td>
...
<td width="20" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center"><b>Rate</b></td>
...
<td width="48" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center"><b>Amount</b></td>
</tr>          
<?php
$j=0;
 foreach ($pre  as  $vob)
...
<td align="left" style="border-right: 1px solid black;padding:3px;font-size:14px;"><?php echo $itemname[$i];?><br><?php echo $dc_details.$descDet;?>
</td>
...
<tr>
<td colspan="3" valign="top" style="font-size:14px;font-weight:bold; border-right: 1px solid black;">Grand Total in words<br><span style="font-size:13px;">Rupees :<b style="font-size:13px;"><?php echo $fin;?> only</span></td>

<td width="155" align="right" style=""><span style="font-size:16px;font-weight:bold;">Sub Total&nbsp;&nbsp;:</span></td>
<td width="90" align="right">&nbsp;<b><?php echo number_format($bottomTot,2); ?></b></td>
</tr>
<tr style="margin-top:10px !important;">
    <td colspan="3" style="border-right: 1px solid #000;border-top:1px solid black;"><b>&nbsp;&nbsp;<u>Bank Details</b></u></td>
<td align="right" style="margin-top:10px !important;"><span style="font-size:16px;font-weight:bold;">Frieght Charges&nbsp;&nbsp;:</span></td>
<td align="right" ><b><?php echo  number_format((float)$bil->freightamount,2);?></b></td>
</tr>
<tr>
    <td colspan="3" style="border-right: 1px solid #000;">&nbsp;&nbsp;Bank Name &nbsp;: <b><?php echo $profile->bankname;?></b></td>
<td align="right" style=""><span style="font-size:16px;font-weight:bold;">P & F Charges&nbsp;&nbsp;:</span></td>
...
<td align="right" ><b><?php echo  number_format($bil->roundOff,2);?></b></td>
 ...
 <tr>
     <td colspan="3" style="border-right: 1px solid #000;">&nbsp;&nbsp;Account No &nbsp;: <b><?php echo $profile->accountno;?></b></td>
...
<tr>
    <td colspan="3" style="border-bottom: 1px solid #000;border-right: 1px solid #000;"></td>
    <td align="right" style="border-bottom: 1px solid black;border-top:1px solid black"><span style="font-size:18px;font-weight:bold;">Grand Total &nbsp;&nbsp;:</span></td>
<td align="right" style="border-bottom: 1px solid black;border-top:1px solid black;font-size:18px;"><strong><?php echo number_format(round($bil->grandtotal),2);?></strong></td>
...
<tr>
<td width="495" style="font-size:13px;border-right:1px solid black; ">
...
<td width="180" height="5" valign="top" style="font-size:13px;border-right:1px solid black;"><span style="font-size:13px;">1.Goods Once Sold Cannot be Taken Back.</span><br>&nbsp;<br>&nbsp;<br>&nbsp;</td>

<td width="280" style="font-size:14px;border-right:1px solid black;margin-top:10px;" align="right" valign="bottom"><b>Authorised Signatory</b></td>
</tr>    
</table>
<br>
<?php 
