...
<td width="40" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center"><strong>UNITS</strong></td>
...
<td width="42" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center"><b>QTY</b></td>
<td width="29" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center"><b>RATE</b></td>
...
<td align="center" style="border-right:1px solid black;padding:3px;font-size:13px;text-transform: capitalize;">&nbsp;<?php echo $dc_details.$descDet;?></td>
...
<td align="center" style="border-right:1px solid black;padding:3px;font-size:13px;"><?php echo $qty[$i];?></strong></td>
<td align="center" style="border-right: 1px solid black;padding:3px;font-size:13px;"><?php echo number_format($rate[$i],2);?></td>
...
<td align="center" style="border-right: 1px solid black;padding:3px;font-size:12px;"><?php echo number_format($taxableamt[$i],2);?></td> 
...
<td colspan="3" style="border-right: 1px solid #000;">&nbsp;&nbsp;Account Holder Name:</td>
...
<td align="right" ><b><?php echo  number_format($bil->roundOff,2);?></b></td>
 ...
 <tr>
 <td colspan="3" style="border-right: 1px solid #000;">&nbsp;&nbsp;Branch &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <b><?php echo $profile->bankbranch;?></b> 
...
<tr>
<td colspan="3" style="border-right: 1px solid #000;border-bottom: 1px solid #000">&nbsp;&nbsp;IFSC Code &nbsp;&nbsp;: <b><?php echo $profile->ifsccode;?></b></td>
...
<td width="180" height="5" valign="top" style="font-size:13px;border-right:1px solid black;"><span style="font-size:13px;">1.No Claim For breakage or Loss during transit.<br>2.All disputes subject to Coimbatore Jurisdiction only.<br>3.Our Responsibility Ceases after the goods have been delivered to carriers.</span></td>
