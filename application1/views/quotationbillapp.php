...
foreach ($datas as $profileimage)
  ...
  <table width="750" border="0" style="border:1px solid black;border-collapse: collapse;" align="center">
    <tr>
      ...
      <td width="590" align="left" valign="top" style="font-size:14px;color:green;">
      ...
      <?php foreach ($pre  as  $vob)
      {
        ...
        for($i=0; $i< $count; $i++){
          ...
          <tr style="height:1px;">
            ...
            <span align="center" style="font-size:11px;">(HSN/SAC :&nbsp;<?php echo $hsnno[$i];?>)</span><?php echo $dc_details;?></strong></td>
    ...
    <table width="750" border="0" align="center" style="border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;">
      ...
      <tr>
          ...
          <tr>
            ...
            <td align="right">&nbsp;<b><?php if($bil->othercharges=='') { echo "0.00"; } else { echo  number_format($bil->othercharges,2); } ?></b></td>
          </tr>
          <tr>
