...
<td><input class="itemcode_class" data-id="<?php echo $i;?>" type="text" style="width:80px;border:1px solid #605f5f;" name="itemcode[]" id="itemcode<?php echo $i;?>" value="<?php echo @$itemcode[$i];?>"></td>
<td>
...
+'<td <?php echo $hidden?>><input class="itemcode_class" id="itemcode'+total+'" data-id="'+total+'" style="width:80px;border:1px solid #605f5f;" type="text" name="itemcode[]"   autocomplete="off"></td>'
