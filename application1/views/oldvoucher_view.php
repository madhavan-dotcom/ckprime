...
"ajax": {
  "url": "<?php echo site_url('old_voucher/ajax_list')?>",
  "type": "POST",
  "data": function ( data ) {
    data.name = $('#name').val();
...
$('#print').click(function(){
  ...
  var name = $('#name').val();
var type = $('#type').val();
  $.post('<?php echo base_url();?>old_voucher/search',{'fromdate':fromdate,'name':name,'todate':todate,type:type},function(data){

    window.open('<?php echo base_url();?>old_voucher/search_reports', '_blank');
...
$('#download').click(function(){
 var fromdate = $('#fromdate').val();
  ...
  $.post('<?php echo base_url();?>old_voucher/billing_reportdownload',{'fromdate':fromdate,'todate':todate,'name':name,type:type},function(data){
...
$('#delete_form').submit(function(){
  ...
  $.post('<?php echo base_url(); ?>old_voucher/delete',{id:id},function(res){
