...
<i class="zmdi zmdi-account"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Add Supplier / Customer</span></i> <span style="float: right;"  ><a href="javascript:void()" onclick="upload_excel()" style="color:white;"> <i class="fa fa-plus"></i> Upload Excel</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>assets/Addcustomer.xlsx"  style="color:white;"> <i class="fa fa-download"></i>&nbsp; Sample Excel</a></span>
</header>
<div class="card-box">
<div class="row">
...
<label for="inputStandard"><span style="color:red;">Add Supplier / Customer&nbsp;*</span></label>
...
<option value="Export">SEZ / EPZ</option>
...
<div class="col-lg-4">
<div class="form-group">
<label for="inputStandard"><span style="color:red;">Supplier / Customer / company Name&nbsp;*</span></label>
<input type="text" name="name" id="customername" class="form-control" required parsley-trigger="change" placeholder="Enter The Supplier Customer Company Name" required>
<div id="type_valid"></div>
</div>
</div>
<!-- <div class="col-lg-4">
...
<input type="text" name="gstno" class="form-control" onblur="return gstValidation()" id="gstno" placeholder="Enter The GSTIN" MaxLength="15">
...
<div class="col-lg-4">
<div class="form-group">
<label for="inputPassword"><span style="color:red;">Address Line 1&nbsp;*</span></label>
<input type="text" name="address1" class="form-control" id="address1" parsley-trigger="change" required placeholder="Enter The Address">
...
<div class="col-lg-4">
<div class="form-group">
<label for="inputPassword"><span style="color:red;">Address Line 2&nbsp;*</span></label>
<input type="text" name="address2" class="form-control" id="address2" parsley-trigger="change" required placeholder="Enter The Address">
</div>
</div>
<!-- <div class="col-lg-4">
...
<div class="col-lg-4">
<div class="form-group">
<label for="inputPassword"><span style="color:red;">State&nbsp;*</span></label>
<select  autocomplete="off"  class="form-control decimal"  name="state" id="state">
<option value="">Select state</option>
<?php
$state=$this->db->where('status',1)->get('statecode')->result_array();
...
<div class="col-lg-4">
<div class="form-group">
<label for="inputPassword"><span style="color:red;">State Code&nbsp;*</span></label>
<input type="text" name="statecode" class="form-control" id="statecode" parsley-trigger="change" readonly required placeholder="Enter State Code">
</div>
</div>
<!-- <div class="col-lg-4">
...
<div class="col-lg-4">
<div class="form-group">
<label for="inputPassword"><span style="color:red;">City&nbsp;*</span></label>
<input type="text" parsley-trigger="change" required name="city" class="form-control" id="city" placeholder="Enter The City">
</div>
</div>
<!-- <div class="col-lg-4">
...
<div class="col-lg-4">
<div class="form-group">
<label for="inputPassword"><span style="color:red;">Pincode&nbsp;*</span></label>
<input type="text" name="pincode" class="form-control" onkeypress="return isNumberKey(event)" id="pincode" parsley-trigger="change" required placeholder="Enter The Pincode">
</div>
</div>
<!--<div class="clearfix"></div>-->
...
<div class="col-lg-4">
<div class="form-group">
<label for="inputPassword">Aadhaar No</label>
<input type="text" name="adharno" class="form-control" id="adharno" placeholder="Enter The Aadhaar No">
...
<div class="col-lg-4">
<div class="form-group">
<label for="inputPassword">Account Payee</label>
<input type="text" name="accountpay" class="form-control" id="accountpay" placeholder="" value="">
</div>
</div>
<div class="col-lg-4">
<div class="form-group">
...
<div class="col-lg-4">
<div class="form-group">
<label for="inputPassword">Bank Branch<span style="color:red;">&nbsp;</span></label>
<input type="text" name="printname" class="form-control" id="printname" placeholder="Enter Branch">
</div>
</div>
...
<input type="text" name="chequename" class="form-control" id="chequename" placeholder="Enter The IFSC Code">
</div>
</div>
<div class="col-lg-4">
<div class="form-group">
...
function gstValidation(){
  ...
  var textgst=$("#gstno").val();
  if (gstinformat.test(textgst)) {    
                 
                    $('#gstno_valid').html('<div><font color="green">Available! </font></div>');
                    return true;
                } else { 
                     
                    $('#gstno_valid').html('<div><font color="red">Please Enter Valid GSTIN Number</font></div>');
