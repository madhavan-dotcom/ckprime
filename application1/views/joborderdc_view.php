...
<i class="zmdi zmdi-view-headline">&nbsp;Jobwork Dc Reports</i>
</header>
...
$.ajax({ 
url: "<?php echo base_url();?>joborder_dc/autocomplete_cusname",
...
"ajax": {
"url": "<?php echo site_url('joborder_dc/ajax_list')?>",
"type": "POST",
"data": function ( data ) {
...
$.post('<?php echo base_url();?>joborder_dc/search',{'fromdate':fromdate,'customername':customername,'todate':todate},function(data){

window.open('<?php echo base_url();?>joborder_dc/search_reports', '_blank');
...
$.post('<?php echo base_url(); ?>joborder_dc/delete',{id:id},function(res){
...
$.post('<?php echo base_url();?>joborder_dc/viewdc',{'id':id},function(data){
