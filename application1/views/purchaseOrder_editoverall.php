...
<div class="card-box">
<div class="row">
<form class="form-horizontal"  method="post" name="logoForm" id="myform"  action="<?php echo base_url();?>purchaseorder/update"><!---->
...
<div class="col-md-2">
<label >Date</label>
<input type="text" class="form-control datepicker-autoclose" name="purchasedate" parsley-trigger="change" id="datepicker-autoclose" required value="<?php echo $result->purchasedate;?>"	 >
</div>
...
<input type="text" class="form-control" parsley-trigger="change" required name="customername" id="customername" value="<?php echo $result->customername;?>">
...
<input type="text" class="form-control" parsley-trigger="change" required name="purchaseorder" id="purchaseorder" value="<?php echo $result->purchaseorder;?>">
<div id="purchaseorder_valid" style="position: absolute;"></div>
</div>
</div>
<div class="col-md-3">
<label>Work Order  Date</label>
<input type="text" auotocomplete="off" class="form-control datepicker-autoclose" required name="invoicedate" id="invoicedate" value="<?php echo $result->invoicedate;?>" >
</div>


<div class="col-md-3">
<label>Delivery Date</label>
<input type="text" auotocomplete="off" class="form-control datepicker-autoclose" required name="deliverydate" id="deliverydate" value="<?php echo $result->deliverydate;?>" >
</div>
...
<tr>
<td><input class="" id="hsnno<?php echo $i;?>" parsley-trigger="change" required readonly type="text" name="hsnno[]" value="<?php echo $hsnno[$i];?>"><div id="hsnno_valid<?php echo $i;?>"></div></td>


<td><input class="itemcode_class" data-id="<?php echo $i;?>" id="itemcode<?php echo $i;?>" parsley-trigger="change" required type="text" name="itemcode[]" value="<?php echo $itemcode[$i];?>"><div id="itemcode_valid0"><input type="hidden" name="itemid[]" id="itemid<?php echo $i;?>" value="<?php echo $itemid[$i];?>"> </div></td>

<td><input class="itemname_class" style="width: 250px;" data-id="<?php echo $i;?>" id="itemname<?php echo $i;?>" parsley-trigger="change" required  type="text" name="itemname[]" value="<?php echo $itemname[$i];?>" ><div id="itemname_valid<?php echo $i;?>"></div><input type="text" name="item_desc[]" value="<?php echo $itemdesc[$i];?>" placeholder="Description" style="margin-top: 2px;" ><input type="hidden" name="priceType[]" id="priceType<?php echo $i;?>" /></td>
...
<td><input class="qty_class decimals" data-id="<?php echo $i;?>" id="qty<?php echo $i;?>"   parsley-trigger="change" required type="text" name="qty[]" value="<?php echo $qty[$i];?>"   autocomplete="off" ><input class="" id="qtys<?php echo $i;?>"   type="hidden" name="qtys[]"><div id="qty_valid<?php echo $i;?>"></div></td>  
...
<td><input class="rate_class decimals"  data-id="<?php echo $i;?>" parsley-trigger="change" required id="rate<?php echo $i;?>"  type="text" name="rate[]" value="<?php echo $rate[$i];?>"  autocomplete="off"><div id="rate_valid<?php echo $i;?>"></div></td>

<td><input class="decimals" id="amount<?php echo $i;?>" parsley-trigger="change" required readonly type="text" name="amount[]" value="<?php echo $amount[$i];?>"  autocomplete="off"><div id="amount_valid<?php echo $i;?>"></div></td>

<td><input class="discount_class decimals" data-id="<?php echo $i;?>" id="discount<?php echo $i;?>"  type="text" name="discount[]" maxlength="2" onkeypress="return isNumberKey_With_Dot(event)" value="<?php echo $discount[$i];?>"  autocomplete="off"><div id="discount_valid0"></div></td>
...
+'<td><input class="itemcode_class" data-id="'+total+'" id="itemcode'+total+'" type="text" name="itemcode[]" value=""><input type="hidden" name="itemid[]" id="itemid'+total+'" class="form-control"><div id="itemcode_valid'+total+'"></div></td>'
