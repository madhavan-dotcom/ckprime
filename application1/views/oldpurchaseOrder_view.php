...
<i class="zmdi zmdi-shopping-cart">&nbsp;Old Purchase Order Reports</i>
</header>
...
"ajax": {
"url": "<?php echo site_url('oldpurchaseOrder/ajax_list')?>",
"type": "POST",
"data": function ( data ) {
...
$.post('<?php echo base_url();?>oldpurchaseorder/search',{'fromdate':fromdate,'customername':customername,'todate':todate,'purchaseorderno':purchaseorderno},function(data){
window.open('<?php echo base_url();?>oldpurchaseorder/search_reports', '_blank');
});
});
...
$.post('<?php echo base_url(); ?>oldpurchaseorder/delete',{id:id},function(res){
...
source: function(request, response) {
$.ajax({ 
url: "<?php echo base_url();?>oldpurchaseorder/autocomplete_purchaseorderno",
