        ...
        <div class="col-sm-12">
          <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
            <header class="panel-heading" style="color:rgb(255, 255, 255)">
              <i class="zmdi zmdi-apps"></i><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Account Header</span></header>
            <div class="card-box">
              <div class="row">
        ...
        <div class="col-sm-12">
          <section>
            <header class="panel-heading" style="color:rgb(255, 255, 255);    background: #2477c9;">
              <i class="zmdi zmdi-apps"></i><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Account Header Reports</span>
            </header>
