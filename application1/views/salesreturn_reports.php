  ...
  <div class="col-sm-12">
    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
      <header class="panel-heading" style="color:rgb(255, 255, 255)">
        <i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Debit/Credit Reports</span></i>
      </header>
...
"ajax": {
  "url": "<?php echo site_url('salesreturn/ajax_list')?>",
  "type": "POST",
  "data": function ( data ) {
