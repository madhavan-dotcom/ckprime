        ...
        <div class="col-sm-12">
          <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
            <header class="panel-heading" style="color:rgb(255, 255, 255)">
              <i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">GST Reports</span></i>
            </header>
            <div class="card-box table-responsive">
				...
				<form name="from" id="form-filter" method="post" >
					<table style="margin: 0 auto;">
						<tr>
							...
							<td>
								<div class="col-sm-12">
									<input type="text" class="form-control" name="purchaseno" id="purchaseno" style="font-size:16px;width: 115px;" value="" placeholder="Invoice No">
								</div>
							</td>
							-->
              ...
              <div align="center">
              <button id="print" class="btn btn-info" value="Print"><i class="fa fa-print"></i>  Print Tax Reports</button>
...
"ajax": {
  "url": "<?php echo site_url('purchasetax/ajax_list')?>",
  "type": "POST",
  "data": function ( data ) {
...
$('#print').click(function(){
  ...
  $.post('<?php echo base_url();?>purchasetax/search',{'fromdate':fromdate,'cusname':cusname,'todate':todate,'purchaseno':purchaseno,gsttype:gsttype,tax_percent:tax_percent},function(data)
  {

    window.open('<?php echo base_url();?>purchasetax/search_reports', '_blank');
...
$('#download').click(function(){
	...
	var gsttype = $('#gsttype').val();
	var tax_percent = $("#tax_percent").val();
	$.post('<?php echo base_url();?>purchasetax/excel_download',{'fromdate':fromdate,'cusname':cusname,'todate':todate,'purchaseno':purchaseno,gsttype:gsttype,tax_percent:tax_percent},function(data){
		window.open('<?php echo base_url();?>purchasetax/search_reports', '_blank');
	});
});
