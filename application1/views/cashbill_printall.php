...
<table width="1000" border="0" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif;">
	<tr style="font-size: 16px;">
		<td height="35" width="173" align="left" style="border-bottom:1px solid black;text-transform:uppercase;"><strong>CASH BILL REPORT </strong></td>
		<td height="35" width="206" align="left" style="border-bottom:1px solid black;"><strong><em>Cash Bill No:<?php echo $this->session->userdata('rcbio_invoiceno');?></em></strong>     </td>
		<td height="35" width="206" align="left" style="border-bottom:1px solid black;"><strong><em>Customer:<?php echo $this->session->userdata('rcbio_cusname');  ?></em></strong>     </td>
