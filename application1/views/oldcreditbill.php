	...
	<table width="750" border="0" style="" align="center">
		<tr>
			<td align="center" style="font-size:20px;font-weight:bold;"><?php echo $bil->types;?> Note</td>
		</tr>
	</table>
	...
	{ 
		...
		$dateofinvoice=$this->db->select('invoicedate')->where('invoiceno',$bil->invoiceno)->get('invoice_details_backup')->row()->invoicedate;
		?>
