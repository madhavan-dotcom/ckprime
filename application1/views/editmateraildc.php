...
<?php 	$itemcode = $this->db->select('itemcode')->where('id',1)->get('preference_settings')->row()->itemcode;
											if($itemcode==1){?>
<td><input class="form-control clear" parsley-trigger="change" id="itemcode<?php echo $i;?>" type="text" name="itemcode[]" value="<?php echo $itemcode[$i];?>">
...
data: { keyword: $("#itemcodea<?php echo $i;?>").val()},
dataType: "json",
type: "POST",
success: function(data){              
response(data);
...
<?php 	$itemcode = $this->db->select('itemcode')->where('id',1)->get('preference_settings')->row()->itemcode;
											if($itemcode==1){?>
+'<td><input class="form-control clear" parsley-trigger="change" id="itemcode'+total+'" type="text" name="itemcode[]"><div id="itemcode_valid'+total+'"></div></td>'
<?php }?>
