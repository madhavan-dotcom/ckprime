    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="alert btn-info alert-micro btn-rounded pastel light dark success">
                <a href="#" class="close" data-dismiss="alert">&times;</a>UT Report Deleted Successfully !
            </div>

            <div class="alert btn-info alert-micro btn-rounded pastel light dark unsuccess">
                <a href="#" class="close" data-dismiss="alert">&times;</a>UT Report Deleted Unsuccessfully
            </div>
                ...
                <form id="delete_form">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Delete MPT</h4>
                        </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#table').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url('Mtc/ajaxlist_mpt') ?>",
                        "type": "POST",
                        "data": function(data) {
