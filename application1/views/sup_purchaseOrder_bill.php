...
foreach ($datas as $profileimage)
  ...
  <table width="750" border="0" style="" align="center">
    ...
    <td align="left" id="backButon"><a class="btn btn-success" href="<?php echo base_url().'purchaseorder';?>">Go back to Add Purchase Order</a></td>
    <td align="left" id="backButon"><a class="btn btn-success" href="javascript:window.close();">Close</a></td>
      <td width="300" align="left" style="font-size:20px;font-weight:bold;">Purchase Order</td>
  ...
  <table width="750" border="0" style="border:1px solid black;border-collapse: collapse;" align="center">
    <tr>
      <td width="200" ><img style="width:100px;" src="<?php echo base_url();?>upload/<?php echo $profileimage->image;?>" alt="logo" /></td>
...
<table width="750" border="0" style="border-left:1px solid black;border-collapse: collapse;border-right:1px solid black;" align="center" cellpadding="1">
    <tr>
      ...
      <td width="150" style="font-size:14px;border-right:1px solid black;" >&nbsp;&nbsp;&nbsp;Purchase order No</td>
      <td width="150" style="font-size:14px;" >&nbsp;&nbsp;&nbsp;Invoice Date</td>
    </tr>
    <tr>
        ...
        <td width="150" style="font-size:14px;border-right:1px solid black;" >&nbsp;&nbsp;&nbsp;<b><?php echo $bil->purchaseorderno;?></b></td>
        <td width="150" style="font-size:14px;border-right:1px solid black;" >&nbsp;&nbsp;&nbsp;<b><?php {$a=$bil->date; $d=date('d/m/Y',strtotime($a)); echo $d;};?></b></td>
    </tr>
      <tr>
        <td width="150" style="font-size:14px;border-right:1px solid black;" >&nbsp;&nbsp;&nbsp;</td>
        <td width="150" style="font-size:14px;border-right:1px solid black;" >&nbsp;&nbsp;&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="150" style="font-size:14px;border-right:1px solid black;border-bottom:1px solid black;" >&nbsp;&nbsp;&nbsp;</td>
        <td width="150" style="font-size:14px;border-right:1px solid black;border-bottom:1px solid black;" >&nbsp;&nbsp;&nbsp;</td>
      </tr>
...
if ($bil->shipTo=='') {
?>
<td width="500" style="font-size:14px;border-top:1px solid black;border-right:1px solid black;" ><b>Ship To<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $bil->customername;?></b></td>
<?php } 

else { ?>
<td width="500" height="60" style="font-size:14px;border-top:1px solid black;border-right:1px solid black;" ><b>Ship To<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $bil->shipTo;?></b></td>
<?php } ?>
</tr>
...
?>
<td width="500"  style="font-size:14px;border-right:1px solid black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo @$shipToadd1;?>,<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo @$shipToadd2;?><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo @$shipTocity;?>,<?php echo @$shipTostate;?>&nbsp;<?php echo $shipTopincode; ?>,&nbsp;<?php echo @$shipTomobileno;?></td>
<?php } 
else {
?> 
<td width="500" style="font-size:14px;border-right:1px solid black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo @$bil->shipToAddress;?></td>
  ...
  */
      ...
      $grandTotIgsth = array_sum($igsth);
          ...
          <tr style="height:1px;">
            ...
            <span align="center" style="font-size:12px;">(HSN/SAC :&nbsp;<?php echo $hsnno[$i];?>)</span></strong></td>
...
if($vob->loadingamount)
{
  ...
  ?>
    ...
    <table width="750" border="0" align="center" style="border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;">
      ...
      <tr>
            <td colspan="3" rowspan="4" valign="top" style="font-size:14px;font-weight:bold;"><span style="font-size:13px;">Rupees :<b style="font-size:13px;"><?php echo $fin;?> only</b></span></td>
        ...
        <table width="750" align="center" style="border-collapse:collapse;border-bottom:1px solid black;border-right:1px solid black;border-left:1px solid black;" cellspacing="5">  
          <tr>
            <td style="font-size:12px;padding:2px;">
						<!-- <p>Certified that the particulars given are true and correct the amount indicated represents the price actually charged and  there is no flow of additional consideration directly or indirectly from the buyer.</p>         -->
            </td>
          </tr>
</table>
