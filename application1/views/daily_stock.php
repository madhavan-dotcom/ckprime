  ...
  <div class="col-sm-12">
    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
      <header class="panel-heading" style="color:rgb(255, 255, 255)">
        <i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Daily Stock Reports</span></i>
      </header>
        ...
        <table id="table" class="table table-striped table-bordered">
          <thead>
           <tr>
                                            ...
                                            <th>Date</th>
                                            <th>HSN No</th>
                                            <?php 	$itemcode = $this->db->select('itemcode')->where('id',1)->get('preference_settings')->row()->itemcode; if($itemcode==1){?>
                                            <th>Itemcode</th>
                                            <?php }?>
                                            <th>Item Name</th>
                                            <th>Qty</th>
