...
<div class="content-page">
                ...
                <div class="col-sm-12">
                    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
                        ...
                        <header class="panel-heading" style="color:rgb(255, 255, 255)">
                            <i class="zmdi zmdi-assignment-o"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Edit Joborder Dc (<?php echo $dcno; ?>)</i></span>
                        </header>
                        <div class="card-box" style="min-height: 500px;">
                            <div class="row">
                                <?php foreach ($result as $row) { ?>
                                    <form class="form-horizontal" id="dc_forms" data-parsley-validate novalidate method="post" action="<?php echo base_url(); ?>joborder_dc/update">
                                            ...
                                            <div class="col-md-8 forms">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" parsley-trigger="change" required readonly class="form-control" name="customername" <?php echo $readonly; ?> id="customername" value="<?php echo $row['cusname']; ?>">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="vehicleno" id="vehicleno" value="<?php echo $row['vehicleno']; ?>" >
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>Time</label>
                                                        <!-- <input type="text" class="form-control" name="time" id="time" value="<?php echo date('h:i:A'); ?>" style="width:148px;"> -->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Process</label>
                                                        <input type="text" class="form-control" name="process" id="process" value="<?php echo $row['process']; ?>">
                                                        <div id="invoiceno_valid"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label>Remarks</label>
                                                        <input type="text" class="form-control" name="remarkss" id="remarkss" value="<?php echo $row['remarkss']; ?>">
                                                        <div id="invoiceno_valid"></div>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        if (dctype == 'Direct DC') {
            var id = $('#id').val();
            $.post('<?php echo base_url(); ?>joborder_dc/geteditinward_details', {
                'dctype': dctype,
                'id': id
            }, function(data) {
            ...
            var id = $('#id').val();
            $.post('<?php echo base_url(); ?>joborder_dc/geteditinwarddetails', {
                'id': id
            }, function(data) {
                $('.inwarddetails').html(data);
            });
