    ...
    <div class="container">
      ...
      <?php } ?>
       ...
       <div class="alert btn-info alert-micro btn-rounded pastel light dark success" >
                            <a href="#" class="close" data-dismiss="alert">&times;</a>Cash Bill Deleted Successfully !
                        </div>

                         <div class="alert btn-info alert-micro btn-rounded pastel light dark unsuccess" >
                            <a href="#" class="close" data-dismiss="alert">&times;</a>Cash Bill Deleted Unsuccessfully 
                        </div>
      <div class="row">
        <div class="col-sm-12">
        </div>
        ...
        <div class="col-sm-12">
          <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
            <header class="panel-heading" style="color:rgb(255, 255, 255)">
              <i class="zmdi zmdi-view-headline">&nbsp;Cash Bill Reports</i>
            </header>
          ...
          <table >
            <tr>
              ...
              <td>
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="invoiceno" id="invoiceno" style="font-size:16px;width: 115px;" value="" placeholder="Cash Bill No">
                </div>
              </td>
      ...
      <!--         <form method="post" action="<?php echo base_url();?>invoice/search">
            ...
            <?php if($_POST) {?>
        <form name="form" method="post" action="<?php echo base_url();?>cashbill/reports" target="_blank" >
            <table>
                <tr>
          ...
          <form id="delete_form">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Delete Cash Bill?</h4>
              </div>
...
$( "#name" ).autocomplete({
  source: function(request, response) {
    $.ajax({ 
      url: "<?php echo base_url();?>cashbill/autocomplete_customername",
     ...
     $( "#invoiceno" ).autocomplete({
      source: function(request, response) {
        $.ajax({ 
          url: "<?php echo base_url();?>cashbill/autocomplete_name",
...
"ajax": {
  "url": "<?php echo site_url('cashbill/ajax_list')?>",
  "type": "POST",
  "data": function ( data ) {
...
$('#print').click(function(){
  ...
  $.post('<?php echo base_url();?>cashbill/search',{'fromdate':fromdate,'cusname':cusname,'todate':todate,'invoiceno':invoiceno,gsttype:gsttype},function(data)
  {

    window.open('<?php echo base_url();?>cashbill/search_reports', '_blank');
...
$('#delete_form').submit(function(){
  ...
  $.post('<?php echo base_url(); ?>cashbill/delete',{id:id},function(res){
