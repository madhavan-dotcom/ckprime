...
//print_r($invoice);  
  foreach ($invoice as $row) {
    if($row['sgstamount']!="")
    {
      ...
      $sgst_amount=array_sum($sgstamount)+(float)$row['loadingsgstamount']+(float)$row['freightsgstamount'];
      $sgst_amounts[]=array_sum($sgstamount)+(float)$row['loadingsgstamount']+(float)$row['freightsgstamount'];
    }
    else
    {
      $sgst_amount=0;
       ...
       if($row['igstamount']!="")
    {
      ...
      $igst_amount=array_sum($igstamount)+(float)$row['loadingigstamount']+(float)$row['freightigstamount'];
      $igst_amounts[]=array_sum($igstamount)+(float)$row['loadingigstamount']+(float)$row['freightigstamount'];
    }
    else
    {
      $igst_amount=0;
       ...
       if($row['cgstamount']!="")
    {
      ...
      $cgst_amount=array_sum($cgstamount)+(float)$row['loadingcgstamount']+(float)$row['freightcgstamount'];
      $cgst_amounts[]=array_sum($cgstamount)+(float)$row['loadingcgstamount']+(float)$row['freightcgstamount'];;
    }
    else
    {
      $cgst_amount=0;
