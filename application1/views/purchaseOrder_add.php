...
<i class="zmdi zmdi-shopping-cart"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Customer Purchase Order - <?php echo $invoiceno;?></span></i>
</header>
<div class="card-box">
<div class="row">
...
<?php 	$itemcode = $this->db->select('itemcode')->where('id',1)->get('preference_settings')->row()->itemcode;
											if($itemcode==1){?>
<th style="width:70px" >Itemcode Code</th>
<?php }?>
...
<td <?php echo $hidden?>><input class="itemcode_class" data-id="0" id="itemcode0" parsley-trigger="change"   type="text" name="itemcode[]" value="0" ><div id="itemcode_valid0"></div></td>
...
<td><input class="discount_class decimals" id="discount0" data-id="0"  type="text" name="discount[]" maxlength="2" onkeypress="return isNumberKey_With_Dot(event)" value=""  autocomplete="off"><div id="discount_valid0"></div></td>
...
<button  class="btn btn-info" name="save"  id="submit">Add Customer Purchase Order</button>
...
$(' <tr>'
+'<td hidden><input class="" id="hsnno'+total+'" readonly type="text" name="hsnno[]" value="" ><div id="hsnno_valid'+total+'"></div></td>'
+'<td <?php echo $hidden;?>><input class="itemcode_class" data-id="'+total+'" id="itemcode'+total+'" type="text" name="itemcode[]" value="0" ><div id="itemcode_valid'+total+'"></div></td>'
