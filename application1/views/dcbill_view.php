...
<i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Dc Reports</span></i>
</header>
...
$.ajax({ 
url: "<?php echo base_url();?>dcbill/autocomplete_cusname",
...
"ajax": {
"url": "<?php echo site_url('dcbill/ajax_list')?>",
"type": "POST",
"data": function ( data ) {
...
$.post('<?php echo base_url();?>dcbill/search',{'fromdate':fromdate,'customername':customername,'todate':todate},function(data){

window.open('<?php echo base_url();?>dcbill/search_reports', '_blank');
...
$.post('<?php echo base_url();?>dcbill/download',{'fromdate':fromdate,'todate':todate,'invoiceno':invoiceno,'customername':customername},function(data){

window.open('<?php echo base_url();?>dcbill/excel_download', '_blank');
...
$.post('<?php echo base_url(); ?>dcbill/delete',{id:id},function(res){
...
$.post('<?php echo base_url();?>dcbill/viewdc',{'id':id},function(data){
