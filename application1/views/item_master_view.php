								...
								<div class="row-fluid well">
									<form name="logoForm" id="logoForm" class="form-horizontal" action="<?php echo $action; ?>" method="post">
										...
										<div class="row">
											...
											if ($itemcode == 1) { ?>
												...
												<div class="col-md-2">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="itemcode" id="div1" autocomplete="off" id="itemcode" value="<?php echo $this->validation->itemcode; ?>" required>
														<div id="itemcode_valid" -style="position:fixed;"></div>
														<?php echo form_error('itemcode'); ?>
													</div>
												</div>
											<?php } ?>
											...
											<div class="col-md-2">
												<div class="form-group">
													<label class="control-label">Pattern Code</label>
													<input type="text" class="form-control" name="patterncode" autocomplete="off" id="patterncode" value="<?php echo $this->validation->patterncode; ?>">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" name="drawingno" autocomplete="off" id="drawingno" value="<?php echo $this->validation->drawingno; ?>">
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<script>
														document.logoForm.uom.value = '<?php echo $this->validation->uom; ?>';
													</script>
										...
										<div class="row">
											<div class="col-md-2">
												<div class="form-group">
													<label class="control-label">Pattern Material & Qty</label>
													<input type="text" class="form-control" name="pattern_material" id="div1" autocomplete="off" id="pattern_material"  value="<?php echo $this->validation->pattern_material; ?>" >
											...
											<div class="col-md-3">
												<div class="form-group">
													<label class="control-label">Casting Weight</label>
													<input type="text" class="form-control" name="casting_weight" autocomplete="off" id="casting_weight" value="<?php echo $this->validation->casting_weight; ?>">
											...
											<div class="col-md-3">
												<div class="form-group">
													<label class="control-label">Liquid Weight</label>
													<input type="text" class="form-control" name="liquid_weight" autocomplete="off" id="liquid_weight" value="<?php echo $this->validation->liquid_weight; ?>">
											...
											<div class="col-md-3">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="yield" autocomplete="off" id="yield" value="<?php echo $this->validation->yield; ?>" readonly>
										...
										<div class="row">
											...
											<div class="col-md-2">
												<div class="form-group">
													...
													<script>
														document.logoForm.taxtype.value = '<?php echo $this->validation->taxtype; ?>';
													</script>
											...
											<div class="col-md-4">
												<div class="form-group">
													...
													<?php
													if ($priceType == '1') { ?>
														<div><label class="radio-inline" style="color:blue;"><input type="radio" name="priceType" value="Exclusive" checked>Exclusive</label></div>

													<?php } elseif ($priceType == '0') { ?>
														<div><label class="radio-inline" style="color:blue;"><input type="radio" name="priceType" id="priceType1" value="Inclusive" checked>Inclusive</label></div>
													<?php } ?>
...
<script>
	$(document).ready(function() {
		...
		$('#taxtype').change(function() {
			...
			$.post('<?php echo base_url(); ?>itemmaster/gettax', {
				'taxtype': taxtype
			}, function(data) {
		...
		$('#itemname').keyup(function() {
			var name = $(this).val();
			if (name != '') {
				$.post('<?php echo base_url(); ?>itemmaster/getname', {
					name: name
				}, function(res) {
					if (res > 0) {
						$('#itemname').focus();
						$('#itemname_valid').html('<span><font color="red">itemname already taken!</span>');
						$('#submit').attr('disabled', true); //set button enable 
					} else {
		...
		$("#logoForm").validate({
			...
			"messages": {
				...
				"taxtype": {
					"required": "Tax Type cannot be blank."
				},
				"priceType": {
					"required": "Price Type cannot be blank."
				}
			}
...
<script>
$(function () {
    $('#casting_weight, #liquid_weight').on('input', function () {
        var castingweight = parseFloat($('#casting_weight').val()) || 0;
        var liquidweight  = parseFloat($('#liquid_weight').val()) || 0;

        if (castingweight > 0 && liquidweight > 0) {
            var yieldValue = ((castingweight / liquidweight) * 100).toFixed(2);
            $('#yield').val(yieldValue);
        } else {
            $('#yield').val('');
        }
    });
