...
<input type="text" auotocomplete="off" class="form-control datepicker-autoclose" name="orderdate" id="orderdate" value="<?php if($r['orderdate'] == '1970-01-01'){}else{echo date('d-m-Y',strtotime($r['orderdate']));}?>" >
</div>
</div>
...
<input type="text" auotocomplete="off" class="form-control datepicker-autoclose" name="removalDate" id="removalDate" value="<?php if($r['removalDate'] == '1970-01-01'){}else{echo date('d-m-Y',strtotime($r['removalDate']));}?>" >
</div>
</div>
...
<textarea type="text" readonly class="form-control" name="address" id="address" rows="4"><?php echo $r['shipToAddress'];?></textarea>
</div>
</div>
</div>
...
?>
<tr>
<td><input class="" <?php if($checkItemType=='without_item'){ } else { echo 'required'; } ?> id="hsnno<?php echo $i;?>" style="border:1px solid #605f5f;" type="text"  name="hsnno[]" value="<?php echo $hsnno[$i];?>"><input class="form-control"  id="itemno<?php echo $i;?>" type="hidden" name="itemno[]" value=""><input class="form-control"  id="ida<?php echo $i;?>" type="hidden"  value="<?php echo $i;?>">
<div id="hsnno_valid<?php echo $i;?>"></div></td>

<td><input class="itemname_class" data-id="<?php echo $i;?>" id="itemname<?php echo $i;?>"  value="<?php echo $itemname[$i];?>" <?php echo $readonly;?> style="border:1px solid #605f5f;" required type="text" name="itemname[]" value="" ><div id="itemname_valid<?php echo $i;?>"></div><input type="text" name="item_desc[]" value="<?php echo $item_desc[$i];?>" style="margin-top: 2px;border:1px solid #605f5f;" ><?php if($checkItemType=='without_item') { } else { ?><input type="hidden" id="priceType<?php echo $i;?>" name="priceType[]" value="<?php echo $item_result->priceType;?>" /><?php } ?></td>
...
<td><input class="" value="<?php echo $uom[$i];?>" id="uom<?php echo $i;?>"  style="border:1px solid #605f5f;"  type="text" name="uom[]"  autocomplete="off"></td>
...
<td><input class="discount_class decimals"  data-id="<?php echo $i;?>" id="discount<?php echo $i;?>" value="<?php echo $discount[$i];?>"  style="border:1px solid #605f5f;" type="text" name="discount[]" value="0"  autocomplete="off" onkeypress="return isNumberKey_With_Dot(event)"><div id="discount_valid<?php echo $i;?>"></div></td>
...
<td class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals cgstClass" data-id="<?php echo $i;?>" value="<?php echo $cgst[$i];?>" id="cgst<?php echo $i;?>"  type="text" name="cgst[]" style="border:1px solid #605f5f;" autocomplete="off" <?php if($checkItemType=='without_item'){ } else { echo 'readonly'; } ?>  ><div id="cgst_valid"></div></td>

<td class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" value="<?php echo $cgstamt[$i];?>" id="cgstamount<?php echo $i;?>"   type="text" name="cgstamount[]"   onkeypress="return isNumberKey(event)" autocomplete="off" readonly style="border:1px solid #605f5f;" value=""></td>

<td class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="sgst<?php echo $i;?>" value="<?php echo $sgst[$i];?>"  type="text" name="sgst[]"  value="" readonly style="border:1px solid #605f5f;"  onkeypress="return isNumberKey(event)" autocomplete="off" ><div id="sgst_valid<?php echo $i;?>"></div></td>

<td class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" data-id="<?php echo $i;?>" value="<?php echo $sgstamt[$i];?>" id="sgstamount<?php echo $i;?>"  type="text" name="sgstamount[]" autocomplete="off" style="border:1px solid #605f5f;" readonly>
...
<td class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals igstClass" id="igst<?php echo $i;?>"  type="text" name="igst[]" style="border:1px solid #605f5f;" value="<?php echo $igst[$i];?>"  onkeypress="return isNumberKey(event)" autocomplete="off" <?php if($checkItemType=='without_item'){ } else { echo 'readonly'; } ?> ><div id="igst_valid"></div></td>

<td class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="igstamount<?php echo $i;?>" value="<?php echo $igstamt[$i];?>" type="text" name="igstamount[]"   onkeypress="return isNumberKey(event)"  autocomplete="off" readonly style="border:1px solid #605f5f;" value=""></td>
...
<td  class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals"  id="freightcgst"  type="text" name="freightcgst" placeholder="CGST"  value="<?php echo $r['freightcgst'];?>" style="border:1px solid #605f5f;"   autocomplete="off" ></td>

<td  class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" readonly id="freightcgstamount" placeholder="CGST Amount"  type="text" name="freightcgstamount"   autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['freightcgstamount'];?>"></td>

<td  class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="freightsgst" placeholder="SGST"  type="text" name="freightsgst" readonly value="<?php echo $r['freightsgst'];?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="sgst_valid"></div></td>

<td  class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="freightsgstamount"  type="text" name="freightsgstamount" placeholder="SGST Amount" readonly  autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['freightsgstamount'];?>"></td>


<td  class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="freightigst"  type="text" name="freightigst"  placeholder="IGST" value="<?php echo $r['freightigst'];?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="igst_valid"></div></td>

<td  class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="freightigstamount"  type="text" name="freightigstamount"  placeholder="IGST Amount"  autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['freightigstamount'];?>"></td>
...
<td  class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals"  id="loadingcgst"  type="text" name="loadingcgst" placeholder="CGST" value="<?php echo $r['loadingcgst'];?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="cgst_valid"></div></td>

<td  class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" readonly id="loadingcgstamount"  type="text" name="loadingcgstamount"   placeholder="CGST Amount" autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['loadingcgstamount'];?>"></td>

<td  class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="loadingsgst" placeholder="SGST"  type="text" name="loadingsgst" readonly value="<?php echo $r['loadingsgst'];?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="sgst_valid"></div></td>

<td  class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="loadingsgstamount"  type="text" name="loadingsgstamount" readonly  placeholder="SGST Amount" autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['loadingsgstamount'];?>"></td>

<td  class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="loadingigst"  type="text" name="loadingigst" placeholder="IGST" value="<?php echo $r['loadingigst'];?>"  style="border:1px solid #605f5f;"   autocomplete="off" ><div id="igst_valid"></div></td>

<td  class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="loadingigstamount" placeholder="IGST Amount" type="text" name="loadingigstamount"    autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['loadingigstamount'];?>"></td>
