						...
						<div class="col-sm-12">
							<section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
								<header class="panel-heading" style="color:rgb(255, 255, 255)">
									...
									?>
									<i class="zmdi zmdi-money-box">&nbsp;Edit Voucher</i> (<?php echo $voucherid;?>)
								</header>
								<div class="card-box">
									<div class="row">
									<?php
									...
									$invoiceno=implode(",",explode("||",$row['invoiceno']));
									$purchaseno=implode(",",explode("||",$row['purchaseno']));
									?>
											<form class="form-horizontal" name="editForm" role="form" method="post"  action="<?php echo base_url();?>voucher/update">
												<input type="hidden" name="voucherid" id="voucherid" value="<?php echo $row['voucherid'];?>">
												<input type="hidden" name="id" id="id" value="<?php echo $row['id'];?>">
												<input type="hidden" name="oldamount" id="oldamount" value="<?php echo $row['voucheramount'];?>">
												<div class="form-group">
													<label for="inputPassword" class="col-lg-3 control-label">Type</label>
													<div class="col-lg-4">
														<input type="text" class="form-control" readonly   value="<?php if($row['vouchertype']=='receipt') { echo 'Payable'; } else { echo 'Receivable'; } ?>">
														<input type="hidden" name="vouchertype" id="vouchertype" value="<?php echo $row['vouchertype'];  ?>">
													</div>
												</div>
												...
												<div class="form-group">
													...
													<div class="col-lg-3">
														<input type="text" name="purpose" class="form-control" id="purpose" placeholder="" value="<?php echo $row['purpose'];?>">
											...
											<div class="form-group">
												...
												<div class="col-lg-4">
													<input type="text" name="name1" value="<?php echo $row['name'];?>"  id="username1" class="form-control character" placeholder="" readonly>
											...
											<div class="form-group">
												<label for="inputStandard" class="col-lg-3 control-label">Purchaseno</label>
												<div class="col-lg-3">
													<input type="text" name="purchaseno" id="purchaseno"  class="form-control" placeholder="" value="<?php echo $purchaseno;?>" readonly>
													<span id="name_valid"></span>
												</div>
												<div class="col-lg-1" style="width: 177px;">
													<input class="form-control" name="bal_purchase_amt" id="bal_purchase_amt" type="text" readonly="">
												</div>
											</div>
											<?php 
											}
											...
											<div class="form-group">
												<label for="inputStandard" class="col-lg-3 control-label">Invoiceno</label>
												<div class="col-lg-3">
													<input type="text" name="invoiceno" id="invoiceno"  class="form-control" placeholder="" value="<?php echo $invoiceno;?>" readonly>
													<span id="name_valid"></span>
												</div>
												<div class="col-lg-1" style="width: 177px;">
													<input class="form-control" name="balamt" id="balamt" type="text" readonly="">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="controls col-sm-1" style="width:142px;">
													<input type="radio" name="paymentmode" id="optionsRadios4" value="Card" <?php if($row['paymentmode']=='Card') echo 'checked';?> onchange="card()" required> Card
												</div>
											</div>
												...
												<div class="form-group">                                
													...
													<div class="col-lg-4">
														<select  name="throughcheck" class="form-control clears" id="tc" data-rel="chosen1" >
															...
															<option <?php if($row['otherBank']=='1'  && $row['paymentmode']=='Cheque') echo 'selected';?> value="Other">Other</option>
														</select>
														<span id="tc_valid"></span>
													</div>
												</div>
												<div class="form-group" id="tcBankDiv" <?php if($row['otherBank']=='1'  && $row['paymentmode']=='Cheque') { } else { echo 'style="display:none"'; } ?>>
													<label class="control-label col-sm-3">Bank Name<span style="color:red;">*</span></label>
													<div class="col-lg-4">
														<input type="text"  class="form-control" id="tcbankName" name="tcbankName" value="<?php echo $row['throughcheck'];?>" ><span id="tcbankName_valid"></span>
													</div>
												</div>
												<div class="form-group">                                
												...
												<div class="form-group">                                
													...
													<div class="col-lg-4">
														<select  name="banktransfer" class="form-control clears"  id="ss" data-rel="chosen1" >
															...
															<option <?php if($row['otherBank']=='1' && $row['paymentmode']=='Bank') echo 'selected';?> value="Other">Other</option>
														</select>
														<div id="ss_valid"></div>
													</div>
												</div>
												<div class="form-group" id="ssBankDiv" <?php if($row['otherBank']=='1' && $row['paymentmode']=='Bank') { } else { echo 'style="display:none"'; } ?>>
													<label class="control-label col-sm-3">Bank Name<span style="color:red;">*</span></label>
													<div class="col-lg-4">
														<input type="text"  class="form-control" id="ssbankName" name="ssbankName" value="<?php echo $row['banktransfer'];?>" ><span id="ssbankName_valid"></span>
													</div>
												</div>
												<div class="form-group">                                
											...
											<div id="cards" >
												<div class="form-group">                                
													...
													<div class="col-lg-3">
														...
														<script>document.editForm.cardtype.value='<?php echo $row['cardtype'];?>';</script>
													</div>
												</div>
												...
												<div class="form-group">                                
													<label class="control-label col-sm-3">Amount <span style="color:red;">*</span></label>
													<div class="col-lg-3">
														<input type="text"  class="form-control decimal clears" min="0" max="9999999999"  id="cardamount" name="cardamount" value="<?php echo $row['overallamount'];?>" >
...
if(purchaseno!="")
{
$.post('<?php echo base_url();?>voucher/get_purchase_balance',{purchaseno:purchaseno},function(res){
...
if(invoiceno!="")
{
$.post('<?php echo base_url();?>voucher/getbalance_edit',{invoiceno:invoiceno},function(res){
$('#balamt').val(res);
});
}
