...
<input type="text" class="form-control" name="gsttype" id="gsttype" readonly value="<?php echo $r['gsttype'];?>">
</div>
</div>
<div class="col-md-4">
<div class="form-group"> 
...
<th  class="igst igstreadonly" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>>&nbsp;&nbsp;&nbsp;IGST</th>
<th  class="igst igstreadonly" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>>&nbsp;&nbsp;&nbsp;IGST <br> &nbsp;&nbsp;&nbsp;Amount</th>
<th class="igstreadonly">Total</th>
</tr>  
</thead>
<tbody>
<?php 
...
<td class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals igstreadonly igst_class" id="igst<?php echo $i;?>"  type="text" name="igst[]" style="border:1px solid #605f5f;" value="<?php echo $igst[$i];?>"  onkeypress="return isNumberKey(event)" autocomplete="off" <?php if($checkItemType=='without_item'){ } else { echo 'readonly'; } ?> ><div id="igst_valid"></div></td>

<td class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals igstreadonly" id="igstamount<?php echo $i;?>" value="<?php echo $igstamt[$i];?>" type="text" name="igstamount[]"   onkeypress="return isNumberKey(event)"  autocomplete="off" readonly style="border:1px solid #605f5f;" value=""></td>


<td><input class="igstreadonly" id="total<?php echo $i;?>" type="text" value="<?php echo @$overalltotal[$i];?>" name="total[]"   value=""  readonly style="border:1px solid #605f5f;"></td>
<?php
if($r['invoicetype']=='Against DC')
{
}
...
<td  class="sgst" <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals frightamt" id="freightsgstamount"  type="text" name="freightsgstamount" placeholder="SGST Amount" readonly  autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['freightsgstamount'];?>"></td>


<td  class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals frightamt" id="freightigst"  type="text" name="freightigst"  placeholder="IGST" value="<?php echo $r['freightigst'];?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="igst_valid"></div></td>

<td  class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals frightamt" id="freightigstamount"  type="text" name="freightigstamount"  placeholder="IGST Amount"  autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['freightigstamount'];?>"></td>
...
<td  class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals frightamt" id="loadingigst"  type="text" name="loadingigst" placeholder="IGST" value="<?php echo $r['loadingigst'];?>"  style="border:1px solid #605f5f;"   autocomplete="off" ><div id="igst_valid"></div></td>

<td  class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals frightamt" id="loadingigstamount" placeholder="IGST Amount" type="text" name="loadingigstamount"    autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['loadingigstamount'];?>"></td>
...
//alert(rowNumber);
var priceType = $("#priceType"+rowNumber).val();
var rate=$('#igst'+rowNumber+'').val();
$('#igst_valid'+rowNumber+'').html('');
...
{
$('#igst_valid'+rowNumber+'').html('<span><font color="red">Invalid igst !</span>');
$('#igst_valid'+rowNumber+'').val('');
}
});
...
$('.sgst').hide();
$('.igst').show();
	$('.igstreadonly').attr('hidden',false);
	$('.frightamt').attr('hidden',false);
...
+'<td class="sgst" style="display:'+samples1+';"><input class="decimals" id="sgstamount'+total+'"  type="text" name="sgstamount[]"   onkeypress="return isNumberKey(event)" autocomplete="off" value=""></td>'
...
+'<td style="display:'+samples2+';"><input class="" id="total'+total+'" type="text" name="total[]" value=""  readonly ></td>'
