...
.navbar-nav>li>a {
 ...
 <?php $msg = $this->session->flashdata('msg'); if((isset($msg)) && (!empty($msg))) { ?>
             ...
             <i class="zmdi zmdi-money-box"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Expenses Reports</span></i>
                                </header>
                  ...
                  <option value="All">All</option>
                         ...
                         <table id="table" class="table table-striped table-bordered">
                                ...
                                <div align="center">
             <button id="print" class="btn btn-info" value="Print">Print Expenses Reports</button>
            <!--<button id="download" class="btn btn-default" value="Download">Download</button>-->
