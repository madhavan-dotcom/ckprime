                ...
                <div class="col-sm-12">
                    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
                        ...
                        <header class="panel-heading" style="color:rgb(255, 255, 255)">
                            <i class="zmdi zmdi-shopping-cart"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">View Purchase Receipt - <?php echo $vi['invoiceno'];?>
                    </span></i>
                        </header>
                        <div class="card-box">
                            <div class="row">
                                                ...
                                                <div class="col-md-8 forms" style="margin-bottom: 10px;">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" auotocomplete="off" class="form-control" name="purchasetype" value="<?php echo $ptype; ?>" readonly>
                                                        </div>
                                                    </div>
