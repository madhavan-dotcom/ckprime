					...
					<div class="row">
						<div class="col-sm-12">
							<section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
								...
								<div class="card-box">
									<div class="row">
										<form class="form-horizontal"  method="post" action="<?php echo base_url();?>cashbill/update" name="editForm" data-parsley-validate novalidate >
                                    	...
                                    	<select type="text" disabled class="form-control" parsley-trigger="change" required name="taxtype" id="taxtype" value="">
                                    	    <option value="with_tax">With Tax</option>
                                    	    <option value="without_tax">Without Tax</option>
                                    	    </select>
                                    	   <script>document.editForm.taxtype.value='<?php echo $r['taxtype'];?>';</script>
                                    	</div>
                                    	</div>
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<input disabled type="text" class="form-control" name="customername" value="<?php echo $r['customername'];?>" id="customername">
															<input disabled type="hidden" id="oldName" value="<?php echo $r['customername'];?>" />
															<input disabled type="hidden" class="form-control" name="customerid"  id="customerid" value="<?php echo $r['customerId'];?>" >
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<input type="text" class="form-control"  disabled name="cust_mobno" id="cust_mobno" value="<?php echo $r['cust_mobno'];?>" >
															<div id="invoiceno_valid"></div>
														</div>
													</div>
													
													
											<?php if($r['taxtype']=='with_tax'){
											    ?>
													<div class="col-md-4 gsttypes" >
														<div class="form-group">
															<label>GST Type</label>
															<select  class="form-control" name="gsttype" disabled id="gsttype" readonly>
												...
												<div class="col-md-3">
													<div class="form-group"> 
														<label>Address</label>
														<textarea type="text" readonly class="form-control" name="address" id="address" rows="4" disabled><?php echo $r['address'];?></textarea>
													</div>
												</div>
											</div>
											...
											<div class="table-responsive myform" >
												<table class="table">
													...
													<tbody>
														...
														?>
														<tr>
															<td><input disabled class="" id="hsnno<?php echo $i;?>" readonly style="border:1px solid #605f5f;" type="text"  name="hsnno[]" value="<?php echo $hsnno[$i];?>"><input class="form-control"  id="itemno<?php echo $i;?>" type="hidden" name="itemno[]" value=""><input class="form-control"  id="ida<?php echo $i;?>" type="hidden"  value="<?php echo $i;?>">
															<div id="hsnno_valid<?php echo $i;?>"></div></td>
															
															<td><input class="itemname_class" disabled data-id="<?php echo $i;?>" id="itemname<?php echo $i;?>"  value="<?php echo $itemname[$i];?>"  style="border:1px solid #605f5f;" required type="text" name="itemname[]" value="" ><div id="itemname_valid<?php echo $i;?>"></div><input type="hidden" id="priceType<?php echo $i;?>" name="priceType[]" disabled value="<?php echo $item_result->priceType;?>" /></td>

															<td><input class="qty_class" disabled data-id="<?php echo $i;?>" id="qty<?php echo $i;?>" required type="text" name="qty[]" value="<?php echo $qty[$i];?>"   autocomplete="off" style="border:1px solid #605f5f;"><input type="hidden" id="prevQty<?php echo $i;?>" value="<?php echo $qty[$i];?>" /><input type="hidden" name="qtys" id="qtys<?php echo $i;?>" value="<?php echo $vob_balance;?>"><div id="qty_valid<?php echo $i;?>"></div></td>  

															<td><input disabled class="" value="<?php echo $uom[$i];?>" id="uom<?php echo $i;?>"  style="border:1px solid #605f5f;"  type="text" name="uom[]"  readonly autocomplete="off"></td>

															<td><input disabled class="rate_class decimals"  data-id="<?php echo $i;?>" value="<?php echo $rate[$i];?>" id="rate<?php echo $i;?>" required style="border:1px solid #605f5f;" type="text" name="rate[]"   autocomplete="off"><div id="rate_valid<?php echo $i;?>"></div></td>

															<td><input disabled class="decimals"  id="amount<?php echo $i;?>" value="<?php echo $totalamount[$i];?>" readonly style="border:1px solid #605f5f;" type="text" name="amount[]" value=""  autocomplete="off"><div id="rate_valid<?php echo $i;?>"></div></td>

															<td><input disabled class="discount_class decimals"  data-id="<?php echo $i;?>" id="discount<?php echo $i;?>" value="<?php echo $discount[$i];?>"  style="border:1px solid #605f5f;" type="text" name="discount[]" value="0"  autocomplete="off"><div id="discount_valid<?php echo $i;?>"></div></td>

												<?php 
														if($r['taxtype']=='with_tax'){ ?>
														<td class="sgst"><input class="decimals" disabled id="taxableamount<?php echo $i;?>" value="<?php echo $taxableamount[$i];?>" readonly style="border:1px solid #605f5f;" type="text" name="taxableamount[]" value=""  autocomplete="off"><input type="hidden" name="discountamount[]" id="discountamount<?php echo $i;?>"></td>
															
															
															<td class="sgst" <?php } if($r['taxtype']=='with_tax'){
															if($r['gsttype']=='interstate') { echo 'style="display:none"'; }  ?>><input class="decimals"  value="<?php echo $cgst[$i];?>" readonly id="cgst<?php echo $i;?>"  disabled type="text" name="cgst[]" value="" style="border:1px solid #605f5f;"  onkeypress="return isNumberKey(event)" autocomplete="off" ><div id="cgst_valid"></div></td>
															
															<td class="sgst" <?php if($r['gsttype']=='interstate') { echo 'style="display:none"'; }  ?>><input class="decimals" value="<?php echo $cgstamt[$i];?>" disabled id="cgstamount<?php echo $i;?>"   type="text" name="cgstamount[]"   onkeypress="return isNumberKey(event)" autocomplete="off" readonly style="border:1px solid #605f5f;" value=""></td>

															<td class="sgst" <?php if($r['gsttype']=='interstate') { echo 'style="display:none"'; }  ?>><input class="decimals" id="sgst<?php echo $i;?>" disabled value="<?php echo $sgst[$i];?>"  type="text" name="sgst[]"  value="" readonly style="border:1px solid #605f5f;"  onkeypress="return isNumberKey(event)" autocomplete="off" ><div id="sgst_valid<?php echo $i;?>"></div></td>

															<td class="sgst" <?php if($r['gsttype']=='interstate') { echo 'style="display:none"'; }  ?>><input disabled class="decimals" value="<?php echo $sgstamt[$i];?>" id="sgstamount<?php echo $i;?>"  type="text" name="sgstamount[]"   onkeypress="return isNumberKey(event)"  autocomplete="off" readonly style="border:1px solid #605f5f;" value="">
															...
															<td class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; }  ?> ><input disabled class="decimals" id="igst<?php echo $i;?>"  type="text" name="igst[]" readonly style="border:1px solid #605f5f;" value="<?php echo $igst[$i];?>"  onkeypress="return isNumberKey(event)" autocomplete="off" ><div id="igst_valid"></div></td>
															
															<td class="igst" <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; }  ?> ><input class="decimals" disabled id="igstamount<?php echo $i;?>" value="<?php echo $igstamt[$i];?>" type="text" name="igstamount[]"   onkeypress="return isNumberKey(event)"  autocomplete="off" readonly style="border:1px solid #605f5f;" value=""></td>
														<?php }?>	
															<td><input disabled class="" id="total<?php echo $i;?>" type="text" value="<?php echo $overalltotal[$i];?>" name="total[]"   value=""  readonly style="border:1px solid #605f5f;"></td>
															<?php
															if($i==0)
															{
											...
											<table class="table myform">
												<tr>
													...
													<td><input class="decimals" id="freightamount" disabled parsley-trigger="change"  placeholder="Amount" style="border:1px solid #605f5f;" type="text" name="freightamount" value="<?php echo $r['freightamount'];?>"  autocomplete="off"></td>

													<?php if($r['taxtype']=='with_tax'){
													if($r['gsttype']=='intrastate') { ?>
													<td ><input disabled class="decimals"  id="freightcgst"  type="text" name="freightcgst" placeholder="CGST"  value="<?php echo $r['freightcgst'];?>" style="border:1px solid #605f5f;"   autocomplete="off" ></td>

													<td ><input disabled class="decimals" readonly id="freightcgstamount" placeholder="CGST Amount"  type="text" name="freightcgstamount"   autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['freightcgstamount'];?>"></td>

													<td ><input disabled class="decimals" id="freightsgst" placeholder="SGST"  type="text" name="freightsgst" readonly value="<?php echo $r['freightsgst'];?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="sgst_valid"></div></td>

													<td ><input disabled class="decimals" id="freightsgstamount"  type="text" name="freightsgstamount" placeholder="SGST Amount" readonly  autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['freightsgstamount'];?>"></td>
													<?php 
													} 
													else 
													{
													?> 
													<td ><input disabled class="decimals" id="freightigst"  type="text" name="freightigst"  placeholder="IGST" value="<?php echo $r['freightigst'];?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="igst_valid"></div></td>

													<td ><input disabled class="decimals" id="freightigstamount"  type="text" name="freightigstamount"  placeholder="IGST Amount"  autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['freightigstamount'];?>"></td>
													<?php }} ?>

													<td>
													<input class="" id="freighttotal" disabled placeholder="Total" type="text" name="freighttotal" value="<?php echo $r['freighttotal'];?>"  readonly style="border:1px solid #605f5f;">
													</td>
												</tr>
												<tr>
													<td>Loading & Packing Charges</td>

													<td><input disabled class="decimals" id="loadingamount" parsley-trigger="change" placeholder="Amount"  style="border:1px solid #605f5f;" type="text" name="loadingamount" value="<?php echo $r['loadingamount'];?>"  autocomplete="off"><div id="rate_valid"></div></td>

													<?php if($r['taxtype']=='with_tax'){
													if($r['gsttype']=='intrastate') { ?>
													<td ><input disabled class="decimals"  id="loadingcgst"  type="text" name="loadingcgst" placeholder="CGST" value="<?php echo $r['loadingcgst'];?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="cgst_valid"></div></td>

													<td ><input disabled class="decimals" readonly id="loadingcgstamount"  type="text" name="loadingcgstamount"   placeholder="CGST Amount" autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['loadingcgstamount'];?>"></td>

													<td ><input disabled class="decimals" id="loadingsgst" placeholder="SGST"  type="text" name="loadingsgst" readonly value="<?php echo $r['loadingsgst'];?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="sgst_valid"></div></td>

													<td ><input disabled class="decimals" id="loadingsgstamount"  type="text" name="loadingsgstamount" readonly  placeholder="SGST Amount" autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['loadingsgstamount'];?>"></td>
													<?php 
													} 
													else 
													{
													?> 
													<td ><input disabled class="decimals" id="loadingigst"  type="text" name="loadingigst" placeholder="IGST" value="<?php echo $r['loadingigst'];?>"  style="border:1px solid #605f5f;"   autocomplete="off" ><div id="igst_valid"></div></td>

													<td ><input disabled class="decimals" id="loadingigstamount" placeholder="IGST Amount" type="text" name="loadingigstamount"    autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $r['loadingigstamount'];?>"></td>
													<?php } }?>

													<td><input disabled class="" id="loadingtotal" type="text" placeholder="Total" name="loadingtotal" value="<?php echo $r['loadingtotal'];?>"  readonly style="border:1px solid #605f5f;"></td>
												</tr>
											</table>
											...
											<div class="col-sm-offset-5">
												<label class="col-sm-5  control-label" >Sub Total</label>
													<div class="col-sm-7">
													<input disabled class="form-control"  type="text" name="subtotal" value="<?php echo $r['subtotal'];?>" id="subtotal" readonly  placeholder="0" value="0">
												</div>
											</div>
											<br>
											<br>    
											...
											<div class="col-sm-offset-5">
												...
												<div class="col-sm-7">
													<input class="form-control decimals"  type="text" disabled name="roundOff" id="roundOff"   placeholder="0" value="<?php echo $r['roundOff'];?>" onfocus="if(this.value == '0') { this.value = ''; }" onblur="if(this.value == '') { this.value = '0'; }">
												</div>
											</div>
											<br>
											<br>  
											...
											<div class="col-sm-offset-5">
												...
												<div class="col-sm-7">
													<input disabled class="form-control"  type="text" value="<?php echo $r['othercharges'];?>" name="othercharges" id="othercharges"   placeholder="0" onkeypress="return isNumber(event)" value="0" onfocus="if(this.value == '0') { this.value = ''; }" onblur="if(this.value == '') { this.value = '0'; }">
												</div>
											</div>
											<br>
											<br>  
											...
											<div class=" col-sm-offset-5">
												...
												<div class="col-sm-7">
													<input disabled class="form-control" readonly value="<?php echo $r['grandtotal'];?>" type="text" name="grandtotal" id="grandtotal" >
												</div>                      
											</div>
  ...
  if(type=="with_tax"){
   ...
   $(".gsttypes").hide();
			...
			$("#customername").on('keyup blur', function (e) {
				...
				if(name !='')
				{
					$.post('<?php echo base_url();?>cashbill/getcustomer_edit',{oldName:oldName,name:name},function(res){
						if(res > 0)
						{
			...
			$('.add').click(function(){
				...
				+'<td class="sgst"><input class="decimals" id="taxableamount'+total+'" readonly style="border:1px solid #605f5f;" type="text" name="taxableamount[]" value=""  autocomplete="off"><input type="hidden" name="discountamount[]" id="discountamount'+total+'"></td>'
	...
	if(taxtype=="with_tax"){		
			...
			else  if(gsttype=='interstate')
			{
		    	...
		    	$('#total'+rowNumber).val(taxableamount);
		}
	}
