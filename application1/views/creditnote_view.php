...
<i class="zmdi zmdi-money-box">&nbsp;Credit Note Reports</i>
</header>
...
"ajax": {
"url": "<?php echo site_url('creditnote/ajax_list')?>",
"type": "POST",
"data": function ( data ) {
data.name = $('#name').val();
...
$.post('<?php echo base_url(); ?>creditnote/delete',{id:id},function(res){
