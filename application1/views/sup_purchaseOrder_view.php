  ...
  <div class="content">
        ...
        <div class="col-sm-12">
          <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
            <header class="panel-heading" style="color:rgb(255, 255, 255)">
              <i class="zmdi zmdi-shopping-cart"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Supplier Purchase Order Reports</span></i>
            </header>
              ...
              <table id="s" class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th>Date</th>
                    <th>PO No</th>
                    <th>Work Order <br> Customer Name</th>
                    <th>Supplier Name</th>
                    <th>Bill Age</th>
                    <th>Total</th>
                    <th>Action</th>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        table = $('#s').DataTable({
          ...
          "ajax": {
            "url": "<?php echo site_url('supplier_purchaseorder/ajax_list') ?>",
            "type": "POST",
            "data": function(data) {
        ...
        $('#print').click(function() {
          ...
          $.post('<?php echo base_url(); ?>supplier_purchaseorder/search', {
            'fromdate': fromdate,
            'customername': customername,
            'todate': todate,
            'purchaseorderno': purchaseorderno
          }, function(data) {
            window.open('<?php echo base_url(); ?>supplier_purchaseorder/search_reports', '_blank');
          });
        });
        ...
        $('#download').click(function() {
          ...
          var customername = $('#customername').val();
          $.post('<?php echo base_url(); ?>purchase/billing_reportdownload', {
            'fromdate': fromdate,
            'todate': todate,
            'invoiceno': invoiceno,
            'customername': customername
    ...
    <script type="text/javascript">
      ...
      $('#delete_form').submit(function() {
        ...
        $.post('<?php echo base_url(); ?>supplier_purchaseorder/delete', {
          id: id
        }, function(res) {
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        ...
        $("#purchaseorderno").autocomplete({
          source: function(request, response) {
            $.ajax({
              url: "<?php echo base_url(); ?>supplier_purchaseorder/autocomplete_purchaseorderno",
              data: {
                keyword: $("#purchaseorderno").val()
              },
              dataType: "json",
              type: "POST",
              success: function(data) {
