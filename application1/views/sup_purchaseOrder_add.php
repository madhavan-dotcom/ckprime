...
<i class="zmdi zmdi-shopping-cart">&nbsp;Supplier Purchase Order - <?php echo $invoiceno;?></i>
</header>
<div class="card-box">
<div class="row">
<form class="form-horizontal"  method="post" name="logoform" id="logoform" -onsubmit="setTimeout(function () { location.href = '<?php echo base_url();?>supplier_purchaseorder';},2000)" action="<?php echo base_url();?>supplier_purchaseorder/insert">
...
<select  class="form-control" parsley-trigger="change" required name="gsttype" id="gsttype" readonly>
...
<!--<div class="form-group">-->
<!--<label>Ship To </label>-->
<!--<input type="text" class="form-control" parsley-trigger="change" required name="shipTo" id="shipTo" value="">-->
<!--<div id="shipto_valid" style="position: absolute;"></div>-->
<!--</div>-->
<!--</div>-->
<!-- <div class="col-md-3">
...
<!--<textarea type="text" class="form-control" readonly name="shipToAddress" id="shipToAddress" required  rows="4"></textarea>-->
<!--</div>-->
</div>
...
<td><input class="discount_class decimals" id="discount0" maxlength="2" data-id="0"  type="text" name="discount[]" onkeypress="return isNumberKey_With_Dot(event)" value=""  autocomplete="off"><div id="discount_valid0"></div></td>
...
<button  class="btn btn-primary"  name="print" id="print" type="submit" value="print">Print Purchase Order</button>
</div>
</form>
</div>
</div>
...
{
$.post('<?php echo base_url();?>supplier_purchaseorder/getbomdetails',{'selected_bom':selected_bom},function(data){
...
$.ajax({
type: "POST",
url: "<?php echo base_url();?>supplier_purchaseorder/get_bomno",
...
//             $.ajax({ 
//                 url: "<?php echo base_url();?>supplier_purchaseorder/autocomplete_customername",
//                 data: { keyword: $("#shipTo").val()},
//                 dataType: "json",
//                 type: "POST",
//                 success: function(data){ 
//                     response(data);
...
$('#tinno').val(ui.item.tinno); 
$('#cstno').val(ui.item.cstno); 
$('#customerid').val(ui.item.supplierid); 
var name = $('#customername').val();
if(name !='')
{
$.post('<?php echo base_url();?>invoice/getcustomer',{name:name},function(res){
