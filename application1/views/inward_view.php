...
<i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Inward Reports</span></i>
</header>
...
<div align="center">
<button id="print" class="btn btn-info" value="Print">Print Inward Reports
</button>
...
<h4 class="modal-title">View Inward</h4>
</div>
...
$.ajax({ 
url: "<?php echo base_url();?>inward/autocomplete_cusname",
...
"ajax": {
"url": "<?php echo site_url('inward/ajax_list')?>",
"type": "POST",
"data": function ( data ) {
...
$.post('<?php echo base_url();?>inward/search',{'fromdate':fromdate,'customername':customername,'todate':todate},function(data){

window.open('<?php echo base_url();?>inward/search_reports', '_blank');
...
$.post('<?php echo base_url();?>inward/download',{'fromdate':fromdate,'customername':customername,'todate':todate},function(data){

window.open('<?php echo base_url();?>inward/excel_download', '_blank');
...
$.post('<?php echo base_url(); ?>inward/delete',{id:id},function(res){
...
$.post('<?php echo base_url();?>inward/viewbilling',{'id':id},function(data){
