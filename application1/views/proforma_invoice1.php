...
<i class="zmdi zmdi-shopping-cart"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Add Proforma Invoice - <?php echo $invoiceno;?></span></span></i>
</header>
<div class="card-box" style="min-height: 500px;">
<div class="row">
<form class="horizontal-form" id="myform" method="post" onsubmit="setTimeout(function () { location.href = '<?php echo base_url();?>proforma_invoice';},2000)" action="<?php echo base_url();?>proforma_invoice/insert" data-parsley-validate novalidate >
...
$.post('<?php echo base_url();?>proforma_invoice/getdc_details',{'gsttype':gsttype},function(data){
$('.dcdetails').html(data);
});
//}
