...
$.post('<?php echo base_url();?>invoice/search',{'fromdate':fromdate,'cusname':cusname,'todate':todate,'invoiceno':invoiceno,gsttype:gsttype},function(data)
{
...
$.post('<?php echo base_url();?>invoice/download',{'fromdate':fromdate,'cusname':cusname,'todate':todate,'invoiceno':invoiceno,gsttype:gsttype},function(data)
{
...
$.post('<?php echo base_url(); ?>invoice/delete',{id:id},function(res){
