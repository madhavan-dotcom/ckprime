...
foreach ($datas as $profileimage)
  ...
  <!--<table width="1050" id="backButon">
	<tr>
		<td align="right"><a class="btn btn-success">Go back to Add Invoice</a></td>
	</tr>
  </table>-->
  <table width="750" border="0" style="" align="center">
    <tr>
      <td width="250" align="center" style="font-size:20px;font-weight:bold;"></td>
      <td width="250" align="center" style="font-size:20px;font-weight:bold;">CASH BILL</td>
...
<table width="750" border="0" style="border-left:1px solid black;border-collapse: collapse;border-right:1px solid black;" align="center" cellpadding="1">
    <tr>
      ...
      <td width="150" style="font-size:14px;border-right:1px solid black;" >&nbsp;&nbsp;&nbsp;CashBill No</td>
      <td width="150" style="font-size:14px;" >&nbsp;&nbsp;&nbsp;Cash Bill Date</td>
    </tr>
    <tr>
        <td width="700" rowspan="2" valign="top" style="font-size:14px;border-right:1px solid black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo @$bil->address;?></td>
        <td width="150" style="font-size:14px;border-right:1px solid black;" >&nbsp;&nbsp;&nbsp;<b><?php echo $bil->invoiceno;?></b></td>
        <td width="150" style="font-size:14px;border-right:1px solid black;" >&nbsp;&nbsp;&nbsp;<b><?php {$a=$bil->invoicedate; $d=date('d/m/Y',strtotime($a)); echo $d;}; ?></b></td>
    </tr>
  ...
  ?>
    ...
    <table width="750" border="0" align="center" style="border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;">
      ...
      <tr>
          ...
          <tr>
            <td width="114" style="font-size:14px;font-weight:bold;">&nbsp;</td>
            <td width="195">&nbsp;</td>
            <td width="126" align="right" style="">&nbsp;</td>
            <td align="right" style=""><span style="font-size:16px;font-weight:bold;">Cash Bill Amount &nbsp;&nbsp;:</span></td>
