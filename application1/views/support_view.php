...
.support .panel-heading {
	...
	<div class="col-sm-12">
	<section>
	<header class="panel-heading" style="color:rgb(255, 255, 255);background-color: #2477c9;">
	<i class="zmdi zmdi-account"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Support Center</span></i>
	</header>
	...
	<div class="panel-body" style="background:#ececec !important;height: 296px;">
	
	<div>
	<table class="table">
	<tbody>
	<tr>
	<td width="10%" style="border-top: none;"><img id="myImgCmp" src="<?php echo base_url().'upload/'.$row['cont_logo'];?>" alt="<?php echo $row['cmp_companyname'];?>" width="auto" height="auto"></td>
	<td  style="border-top: none; color:#000;">
	<li>
	<strong style="font-size: 15px;text-transform: uppercase;">Coimbatore</strong><br /></li>
	<hr>
	<ul class="address">
	<li><span><?php echo $row['cmp_address1'];?><br> <?php echo $row['cmp_address2'];?>-<?php echo $row['cmp_pincode'];?>.</span></li>
	</ul>
	<li><i class="fa fa-envelope"></i><?php echo $row['cmp_emailid'];?></li>
	<li><i class="fa fa-phone"></i><?php echo $row['cmp_phoneno'];?></li>
	<li><i class="fa fa-mobile"></i>
	<?php echo $row['cmp_mobileno'];?></li>
	</td>
	<td  style="border-top: none; color:#000;">
	</td>
	</tr>
