	...
	?>
						...
						<div class="col-sm-12">
							<section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
								<header class="panel-heading" style="color:rgb(255, 255, 255)">
									<i class="zmdi zmdi-shopping-cart">&nbsp;View Purchase Receipt</i>
								</header>
								<div class="card-box">
									<div class="row">
									...
									<div class="card-box">
									<div class="row">
									<form class="horizontal-form myform" id="dc_forms"  method="post" action="<?php echo base_url();?>purchase/update" data-parsley-validate novalidate>
												...
												<div class="row">
													<div class="col-md-12">
														...
														<div class="col-md-4">
															...
															<input type="text" readonly class="form-control" name="purchasetype" id="purchasetype" value="<?php echo $vi['purchasetype'];?>" />
														</div>
														
														<div class="col-md-6 jobOrderClass" <?php if($vi['purchasetype']=='Direct Purchase') { echo 'style="display:none"'; } ?>>
															<div class="form-group">
																<label>Vendor  Name</label>
																<input type="text" class="form-control" name="vendorname" id="vendorname" value="<?php echo $vi['suppliername'];?>">
																<input type="hidden" name="vendorId" id="vendorId" value="<?php echo $vi['supplierId'];?>" />
																<div id="vendorname_valid" style="position: absolute;"></div>
															</div>
														</div>
														
														<div class="col-md-6 directPurchaseDet" <?php if($vi['purchasetype']=='Job Order') { echo 'style="display:none"'; } ?>>
															<div class="form-group">
										...
										<div class="col-md-4 jobOrderClass" <?php if($vi['purchasetype']=='Direct Purchase') { echo 'style="display:none"'; } ?>>
											<div class="form-group">
												<label>Job Order No</label>
												<div class="clearfix"></div>
												<input type="hidden" class="form-control" readonly name="jobOrder" id="jobOrder" value="<?php echo $vi['joborderno'];?>">
												<input type="text" class="form-control" readonly  value="<?php echo str_replace('||', ',', $vi['joborderno']);?>">
											</div>
										</div>
										...
										<table class="table">
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<input class="itemname_class" data-id="<?php echo $i;?>" id="itemname<?php echo $i;?>" value="<?php echo $itemname[$i];?>" style="width:150px;border:1px solid #605f5f;" type="text" name="itemname[]" value="" <?php if($vi['purchasetype']=='Job Order') { echo 'readonly="readonly"'; } ?>><div id="itemname_valid<?php echo $i;?>"></div><input type="hidden" id="priceType<?php echo $i;?>" name="priceType[]" value="<?php echo $item_result->priceType;?>" />
													</td>
													<td>
		...
		function reportFun()
		{
			window.location.href="<?php echo base_url().'oldPurchaseReports';?>";
		}
		</script>
