                  ...
                  <div class="form-group ">
                        ...
                        <div class="form-group">
                          <label class="">Dc Type</label>
                            <input type="hidden" required class="form-control" name="id" id="id" value="<?php echo $row['id'];?>">
                             ...
                             <input type="text" required class="form-control" name="dctype" id="dctype" value="<?php echo $row['dctype'];?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" parsley-trigger="change" required class="form-control" name="cusname" <?php echo $readonly;?> id="cusname" value="<?php echo $row['cusname'];?>">
