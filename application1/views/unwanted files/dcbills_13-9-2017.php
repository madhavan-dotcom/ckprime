<?php foreach($pre as $bil) {
  ...
  <table width="700" border="0" align="center" style="border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;border-bottom: 1px solid black;">
    <tr>
    ...
    <tr>
      <td height="30">&nbsp;</td>
      <td rowspan="2" valign="top"><p><?php echo $bil->address;?><br><b>&nbsp;</b></p></td>
  ...
  <?php
   if($bil->inwardno)
      {
  ?>
  <table width="700" border="0" style="border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;" align="center">
    <tr>
  ...
  <?php } ?>
  <table width="700"   height="200" align="center" style="border-bottom:1px solid black;border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;">
    <tr>
      <td width="38" height="30" align="center" style="border-right:1px solid black;border-bottom:1px solid black;" scope="row">S.No</td>
      <td width="371" style="border-right:1px solid black;border-bottom:1px solid black;" align="center">Particular</td>
      <td width="77" style="border-right:1px solid black;border-bottom:1px solid black;" align="center">Qty</td>
       <td width="77" style="border-right:1px solid black;border-bottom:1px solid black;" align="center">UOM</td>
    </tr>
    <?php foreach ($pre  as  $vob)
    {
      ...
      for($i=0; $i< $count; $i++){
        ...
        <tr height="1">
          ...
          <td align="left" style="border-right: 1px solid black;font-size: 14px;"><strong>&nbsp;&nbsp;&nbsp;<?php echo $itemname[$i];?></strong><br>&nbsp;&nbsp; <small>( <b>HSN/SAC </b>: <?php echo $hsnno[$i];?> )<?php echo $dc_details;?></small></td>
      ...
      <table width="700" height="80" align="center" style="border-collapse:collapse;border-bottom:1px solid black;border-right:1px solid black;border-left:1px solid black;">
