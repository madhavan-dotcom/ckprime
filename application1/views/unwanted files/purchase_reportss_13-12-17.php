...
<table width="1000" border="0" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif;">
	<tr style="font-size: 16px;">
		<td height="35" width="173" align="left" style="border-bottom:1px solid black;text-transform:uppercase;"><strong>PURCHASE TAX REPORT </strong></td>
...
<table width="1000" border="0" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif; font-size: 15px;">
  ...
  foreach ($invoice as $row) {
    ...
    else
    {
     ...
     @$phoneno=$this->db->select('phoneno')->where('id',$row['supplierId'])->where("(type = 'Intra supplier' OR type = 'Inter supplier')")->get('customer_details')->row()->phoneno;
  
   ?>
  <tr>

    <td align="left" style=""><?php echo date('d-m-Y',strtotime($row['purchasedate']));?></td>
    <td align="left" style=""><?php echo $row['invoiceno'];?></td>
    <td align="left" style=""><?php echo ucfirst($row['suppliername']);?></td>
