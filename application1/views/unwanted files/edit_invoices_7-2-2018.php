	...
	?>
					...
					<div class="row">
						<div class="col-sm-12">
							<section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
								...
								<div class="card-box">
									<div class="row">
										<form class="form-horizontal" name="editForm" method="post" action="<?php echo base_url();?>invoice/update" data-parsley-validate novalidate >
												...
												<table class="table">
													...
													<tbody>
														...
														<tr>
															...
															<td><input class="itemname_class" data-id="<?php echo $i;?>" id="itemname<?php echo $i;?>"  value="<?php echo $itemname[$i];?>" <?php echo $readonly;?> style="border:1px solid #605f5f;" required type="text" name="itemname[]" value="" ><div id="itemname_valid<?php echo $i;?>"></div><input type="text" name="item_desc[]" value="<?php echo $item_desc[$i];?>" style="border:1px solid #605f5f;margin-top: 2px;" ><input type="hidden" id="priceType<?php echo $i;?>" name="priceType[]" value="<?php echo $item_result->priceType;?>" /></td>
															...
															<td class="sgst"  <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals"  value="<?php echo $cgst[$i];?>" readonly id="cgst<?php echo $i;?>"  type="text" name="cgst[]" value="" style="border:1px solid #605f5f;"  onkeypress="return isNumberKey(event)" autocomplete="off" ><div id="cgst_valid"></div></td>
															...
															<td class="sgst"  <?php if($r['gsttype']!='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" value="<?php echo $sgstamt[$i];?>" id="sgstamount<?php echo $i;?>"  type="text" name="sgstamount[]"   onkeypress="return isNumberKey(event)"  autocomplete="off" readonly style="border:1px solid #605f5f;" value="">
															...
															<td class="igst"  <?php if($r['gsttype']=='intrastate') { echo 'style="display:none"'; } ?>><input class="decimals" id="igst<?php echo $i;?>"  type="text" name="igst[]" readonly style="border:1px solid #605f5f;" value="<?php echo $igst[$i];?>"  onkeypress="return isNumberKey(event)" autocomplete="off" ><div id="igst_valid"></div></td>
		...
		$(document).ready(function() {
			...
			$('.add').click(function(){
				...
				+'<td><input class="itemname_class" data-id="'+total+'" parsley-trigger="change" required id="itemname'+total+'" style="border:1px solid #605f5f;" type="text" name="itemname[]" value=""><div id="itemname_valid'+total+'"></div><input type="text" name="item_desc[]" value="" style="border:1px solid #605f5f;margin-top: 2px;" ><input type="hidden" name="priceType[]" id="priceType'+total+'" /></td>'
