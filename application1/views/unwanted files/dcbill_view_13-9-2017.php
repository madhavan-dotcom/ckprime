  ...
  $(document).ready(function(){
    ...
    $( "#customername" ).autocomplete({
      source: function(request, response) {
        $.ajax({ 
          url: "<?php echo base_url();?>invoice_statement/autocomplete_cusname",
...
$('#print').click(function(){
  ...
  $.post('<?php echo base_url();?>dcbill/search',{'fromdate':fromdate,'customername':customername,'todate':todate,'invoiceno':invoiceno},function(data){
