...
<input type="text" name="chequename" class="form-control" id="chequename" placeholder="Enter The IFC Code">
</div>
</div>
<div class="col-lg-4">
<div class="form-group">
