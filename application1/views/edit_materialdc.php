...
<i class="zmdi zmdi-assignment-o">&nbsp;Edit Material Dc (<?php echo $dcno;?>)</i>
</header>
<div class="card-box" style="min-height: 500px;">
<div class="row">
<?php foreach ($result as $row) { ?>
<form class="form-horizontal" id="dc_forms" data-parsley-validate novalidate  method="post"   action="<?php echo base_url();?>material_dc/update" >
...
<input type="text" class="form-control" name="purpose" id="purpose" value="<?php echo $row['purpose']; ?>" style="width:500px;">
<div id="invoiceno_valid"></div>
</div>
</div>
...
<div class="form-group">
<label>Process</label>
<input type="text" class="form-control" name="process" id="process" value="<?php echo $row['process']; ?>" style="width:500px;">
<div id="invoiceno_valid"></div>
</div>
</div>
...
<div class="form-group">
<label>Remarks</label>
<input type="text" class="form-control" name="remarkss" id="remarkss" value="<?php echo $row['remarkss']; ?>" style="width:500px;">
<div id="invoiceno_valid"></div>
</div>
</div>
...
{
var id=$('#id').val();
$.post('<?php echo base_url();?>material_dc/geteditinward_details',{'dctype':dctype,'id':id},function(data){
...
{
var id=$('#id').val();
$.post('<?php echo base_url();?>material_dc/geteditinwarddetails',{'id':id},function(data){
$('.inwarddetails').html(data);
});
}
else
