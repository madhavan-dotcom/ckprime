...
class Dcbill extends CI_Controller {
  ...
  public function index()
  {
      ...
      $query_update1 =mysql_query("SELECT * FROM dcbill_details WHERE status ='1' ORDER BY id DESC LIMIT 1");
                  ...
                  $year=date('Y');
                   ...
                   if($old)
                   {
                        ...
                        else 
                        {
                          ...
                          if($bond_length == 1)
                          {
                            $new_bond_noo = 'D0000'.$va;  
                          } 
                          else if($bond_length == 2)
                          {  
                            $new_bond_noo = 'D000'.$va; 
                          }
  ...
  Public function create()
  {
    ...
    public function insert()
    {
      ...
      @$inwardno=implode('||',array_filter($_POST['inwardno']));
      @$customerdcno=implode('||',array_filter($_POST['customerdcno']));
      @$customerdcdate=implode('||',array_filter($_POST['customerdcdate']));
         ...
         public function ajax_list()
  {
    ...
    {   
        $bill_format=$this->session->userdata('rcbio_bill_format');                
                ...
                {
                  $data['invoice']=$this->dcbill_model->search_billing();
                  ...
                  foreach ($data as $datas) 
                  {
                      ...
                      $html.='<tr>
                        ...
                        <input class="form-control" parsley-trigger="change" readonly id="hsnno" type="text" name="hsnno[]" value="'.$rows['hsnno'].'">
                          ...
                          <td><input class="form-control" parsley-trigger="change" required id="" readonly type="text" name="customerdcno[]" value="'.$rows['customerdcno'].'"><input class="form-control" parsley-trigger="change" required id="" readonly type="hidden" name="customerdcdate[]" value="'.$rows['customerdcdate'].'">
                          <div id="itemname_valid"></div></td>

                             <td><input class="form-control" parsley-trigger="change" required id="" readonly type="text" name="itemname[]" value="'.$rows['itemname'].'">
                          <div id="itemname_valid"></div></td>

                          <td><input class="form-control" value="'.$rows['uom'].'" readonly id="uom" type="text" name="uom[]"  autocomplete="off">
                              <div id="qty_valid"></div></td>
                            <td><input class="form-control" parsley-trigger="change" required id="qty'.$rows['id'].'" type="text" name="qty[]"  autocomplete="off">
                              <input class="form-control"  id="inwardqty'.$rows['id'].'" type="hidden" name="inwardqty[]" value="'.$rows['balanceqty'].'" autocomplete="off">
                              <div id="qty_valid" style="color:green;">Inward Qty : '.$rows['balanceqty'].'</div></td>
                               <td><input class="form-control" id="remarks" type="text" name="remarks[]"  value="'.$rows['remarks'].'" autocomplete="off">
                              <div id="qty_valid"></div></td>
                    ...
                    <tbody>';
                      ...
                      $html.='<tr>
                        ...
                        <input class="form-control" parsley-trigger="change" readonly id="hsnno" type="text" name="hsnno[]" value="'.$rows['hsnno'].'">
                          ...
                          <td><input class="form-control" value="'.$rows['uom'].'" readonly id="uom" type="text" name="uom[]" autocomplete="off">
                              <div id="qty_valid"></div></td>
                            <td><input class="form-control" parsley-trigger="change" required id="qty'.$rows['id'].'" value="'.$rows['qty'].'" type="text" name="qty[]"  autocomplete="off">
                              <input class="form-control"  id="inwardqty'.$rows['id'].'" type="hidden" name="inwardqty[]" value="'.$totalqty.'" autocomplete="off">
                              <div id="qty_valid" style="color:green;">Remaining Inward Qty : '.$balanceqty.'</div></td>
                               <td><input class="form-control" id="remarks" type="text" name="remarks[]"  value="'.$rows['remarks'].'" autocomplete="off">
                              <div id="qty_valid"></div></td>
