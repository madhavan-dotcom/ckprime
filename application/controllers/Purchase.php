                ...
                if ($purchasetypes == 'purchase Order') {
                    ...
                    if (!empty($joborder_no[$j])) {
                        ...
                        if (!empty($currentJOs)) {
                            ...
                            $originalQty = isset($currentJO['qty']) ? intval($currentJO['qty']) : (isset($currentJO['balanceqty']) ? intval($currentJO['balanceqty']) : 0);
            ...
            foreach ($data as $datas) {
                ...
                <tr data-original="1">
                 ...
                 <td style="width:100px;">
                    ...
                    <input type="text" name="itemid[]" id="itemid' . $k . '" data-id="' . $k . '" value="' . $rows['itemid'] . '" readonly>
                </td>
                    <td style="width:30px;">
