...
class Ut_model extends CI_Model
{
    var $table = 'ut_report';
    var $column = array('ut_report_no', 'ut_date', 'customername', 'id'); //set column field database for order and search
    var $column_search = array('ut_report_no', 'customername', 'id'); //set column field database for datatable searchable 
    ...
    private function _get_datatables_query()
    {
        if ($this->input->post('fromdate')) {
            $this->db->where('inspection_date >=', date('Y-m-d', strtotime($this->input->post('fromdate'))));
        }
        if ($this->input->post('todate')) {
            $this->db->where('inspection_date <=', date('Y-m-d', strtotime($this->input->post('todate'))));
        }
