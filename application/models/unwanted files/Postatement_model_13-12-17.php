...
class Postatement_model extends CI_Model {


        var $table = 'po_party_statements';
  ...
  public function count_all()
  {
    ...
    {
    	$this->db->select('*');
    	$this->db->from('po_party_statements');
                     ...
                     public function search_billing()
  {
    ...
    return $query=$this->db->get('po_party_statements')->result_array();
