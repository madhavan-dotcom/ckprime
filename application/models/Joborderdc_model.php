...
class Joborderdc_model extends CI_Model {




	    var $table = 'jobworkdc_details';
...
return $query=$this->db->get('jobworkdc_details')->result_array();
...
return $query->result_array();
	...
	{
          $this->db->insert('jobworkdc_details',$data);
  ...
  {       
          $this->db->where('id',$id);
          $this->db->update('jobworkdc_details',$data);
          return $this->db->affected_rows()!=1? false:true;
  }
	...
	{
		$this->db->select('*');
		$this->db->from('jobworkdc_details');
  ...
  public function select_pending()
  {
    ...
    $this->db->from('jobworkdc_delivery');
    return $this->db->get()->result_array();
  } 
}
