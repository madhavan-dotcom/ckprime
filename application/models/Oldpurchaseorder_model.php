...
class Oldpurchaseorder_model extends CI_Model {

  var $table = 'purchaseorder_details_backup';
...
public function __construct()
{
  ...
  public function count_all()
  {
      ...
      public function pay_amount($id)
    {
        ...
        $this->db->select('*');
        $this->db->where('id',$id);
            $this->db->from('purchaseorder_details_backup');
            return $this->db->get()->result_array();
    }
  ...
  public function search_billing()
  {
    ...
    return $query=$this->db->get('purchaseorder_details_backup')->result_array();
