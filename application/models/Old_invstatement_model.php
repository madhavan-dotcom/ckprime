...
class Old_invstatement_model extends CI_Model {


 var $table = 'invoice_party_statement_backup';
  ...
  public function count_all()
  {
    ...
    {
    	$this->db->select('*');
    	$this->db->from('invoice_party_statement_backup');
    ...
    public function search_collection()
    {
        ...
        return $query= $this->db->get('invoice_party_stmt_backup')->result_array();
	...
	{
		//print_r($this->session->userdata('rcbio_customername'));
		//exit;
		...
		if(@$this->session->userdata('rcbio_customername')) { $this->db->where('customername',$this->session->userdata('rcbio_customername')); }

		return $query=$this->db->get('invoice_party_statement_backup')->result_array();
