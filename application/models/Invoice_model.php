...
var $column_search = array('invoicedate','invoiceno','customername','grandtotal','typesgst','typecgst','typeigst','id'); // 'paid', //set column field database for order and search
...
public function delete_by_id($id)
{
    $this->db->where('invoiceno', $id);
		$this->db->where('einvoice_status',0);
