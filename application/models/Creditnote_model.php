...
class Creditnote_model extends CI_Model {
  ...
  var $column_order = array(null, 'voucherdate','invoiceno','name','debitAmount'); //set column field database for datatable orderable
  var $column_search = array('voucherdate','invoiceno','name','debitAmount'); //set column field database for datatable searchable 
