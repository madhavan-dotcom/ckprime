...
{
    var $table = 'inspection_report';
    var $column = array('insno', 'tcdate', 'customername', 'id'); //set column field database for order and search
    var $column_search = array('insno', 'customername', 'id'); //set column field database for datatable searchable 
