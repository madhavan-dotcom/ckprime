...
class Sup_purchaseorder_model extends CI_Model
{
  var $table = 'sup_purchaseorder_details';
  var $column_order = array('purchaseorderno', 'customername', 'grandtotal', 'id'); //set column field database for datatable orderable
  var $column_search = array('purchaseorderno', 'customername', 'grandtotal', 'id'); //set column field database for datatable searchable 
  ...
  public function search_billing()
  {
    ...
    return $query = $this->db->get('sup_purchaseorder_details')->result_array();
