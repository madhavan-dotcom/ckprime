...
class Old_purchase_model extends CI_Model {


       

  var $table = 'purchase_details_backup';
  var $column_order = array('invoiceno','suppliername','grandtotal','id'); //set column field database for datatable orderable
  var $column_search = array('invoiceno','suppliername','grandtotal','id'); //set column field database for datatable searchable 
...
public function __construct()
{
  ...
  public function count_all()
  {
      ...
      public function pay_amount($id)
    {
        ...
        $this->db->select('*');
        $this->db->where('id',$id);
            $this->db->from('purchase_details_backup');
                     ...
                     public function search_billing()
  {
    ...
    return $query=$this->db->get('purchase_details_backup')->result_array();
