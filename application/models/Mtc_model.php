...
{
    var $table = 'mtc_report';
    var $column = array('tcno', 'tcdate', 'customername', 'id'); //set column field database for order and search
    var $column_search = array('tcno', 'customername', 'id'); //set column field database for datatable searchable 
    ...
    private function _get_datatables_query()
    {
        ...
        if ($this->input->post('fromdate')) {
            $this->db->where('tcdate >=', date('Y-m-d', strtotime($this->input->post('fromdate'))));
        }
        if ($this->input->post('todate')) {
            $this->db->where('tcdate <=', date('Y-m-d', strtotime($this->input->post('todate'))));
        }
