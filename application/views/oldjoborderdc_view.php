...
<i class="zmdi zmdi-view-headline">&nbsp;Old Jobwork Dc Reports</i>
</header>
...
$.ajax({ 
url: "<?php echo base_url();?>oldjoborder_dc/autocomplete_cusname",
...
"ajax": {
"url": "<?php echo site_url('oldjoborder_dc/ajax_list')?>",
"type": "POST",
"data": function ( data ) {
...
$.post('<?php echo base_url();?>oldjoborder_dc/search',{'fromdate':fromdate,'customername':customername,'todate':todate},function(data){

window.open('<?php echo base_url();?>oldjoborder_dc/search_reports', '_blank');
...
$.post('<?php echo base_url(); ?>oldjoborder_dc/delete',{id:id},function(res){
...
$.post('<?php echo base_url();?>oldjoborder_dc/viewdc',{'id':id},function(data){
