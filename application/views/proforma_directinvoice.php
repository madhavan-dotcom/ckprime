...
<?php 	$itemcode = $this->db->select('itemcode')->where('id',1)->get('preference_settings')->row()->itemcode;
			...
			<tr>
				...
				<?php 	$itemcode = $this->db->select('itemcode')->where('id',1)->get('preference_settings')->row()->itemcode;
											if($itemcode==1){?>
				<td><input class="" id="itemcode0" parsley-trigger="change" required readonly type="text" name="itemcode[]" value=""><div id="itemcode_valid0"></div></td>
                      <?php }?>
	...
	<div class="col-sm-offset-4">
		<button  class="btn btn-info" id="submit" name="save" value="save">Add Proforma Invoice</button>
		<button  class="btn btn-primary" type="submit" name="print" id="print" value="print">Print Proforma Invoice</button>
	</div>
  ...
  $("#myform").attr("target", "_blank");
	...
	$('.add').click(function(){
      ...
      $(' <tr>'
        ...
        <?php 	$itemcode = $this->db->select('itemcode')->where('id',1)->get('preference_settings')->row()->itemcode;
											if($itemcode==1){?>
		+ '<td><input class="" id="itemcode'+total+'" readonly type="text" name="itemcode[]" value=""><div id="itemcode_valid'+total+'"></div></td>'
		<?php }?>
