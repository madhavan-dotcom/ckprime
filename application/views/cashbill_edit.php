                                    	...
                                    	<select type="text" class="form-control" parsley-trigger="change" required name="taxtype" id="taxtype" value="">
                                    	   ...
                                    	   <script>document.editForm.taxtype.value='<?php echo $r['taxtype'];?>';</script>
											...
											<div class="table-responsive myform" >
												...
												<?php 
														if($r['taxtype']=='with_tax'){ ?>
														<td class="sgst"><input class="decimals"  id="taxableamount<?php echo $i;?>" value="<?php echo $taxableamount[$i];?>" readonly style="border:1px solid #605f5f;" type="text" name="taxableamount[]" value=""  autocomplete="off"><input type="hidden" name="discountamount[]" id="discountamount<?php echo $i;?>"></td>
															
															
															<td class="sgst" <?php } if($r['taxtype']=='with_tax'){
															if($r['gsttype']=='interstate') { echo 'style="display:none"'; }  ?>><input class="decimals"  value="<?php echo $cgst[$i];?>" readonly id="cgst<?php echo $i;?>"  type="text" name="cgst[]" value="" style="border:1px solid #605f5f;"  onkeypress="return isNumberKey(event)" autocomplete="off" ><div id="cgst_valid"></div></td>
