...
<div class="content-page">
  ...
  <div class="content">
    <div class="container">
        ...
        <div class="col-sm-12">
          <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
            <header class="panel-heading" style="color:rgb(255, 255, 255)">
              <i class="zmdi zmdi-view-headline">&nbsp;Invoice Reports</i>
            </header>
      ...
      <!--         <form method="post" action="<?php echo base_url();?>oldInvoiceReports/search">
                <table>
                  <td style="width: 88px;">
                    From Date
                  </td>
...
<!--                 <tbody>
                  <?php 
                  $i=1;
                  foreach($oldInvoiceReports as $u)
                    {?><tr>
                  <td><?php echo $i++;?></td>
...
<?php } ?>
			...
			<button id="download" class="btn btn-primary" value=""><i class="fa fa-bar-chart-o"></i> Download as Excel</button>
            ...
            <?php if($_POST) {?>
        <form name="form" method="post" action="<?php echo base_url();?>oldInvoiceReports/reports" target="_blank" >
            <table>
                <tr>
...
"ajax": {
  "url": "<?php echo site_url('oldInvoiceReports/ajax_list')?>",
  "type": "POST",
  "data": function ( data ) {
...
$('#print').click(function(){
  ...
  $.post('<?php echo base_url();?>oldInvoiceReports/search',{'fromdate':fromdate,'cusname':cusname,'todate':todate,'invoiceno':invoiceno,gsttype:gsttype},function(data)
  {

    window.open('<?php echo base_url();?>oldInvoiceReports/search_reports', '_blank');
	...
	$('#download').click(function(){
		...
		var cusname = $('#name').val();
		var gsttype = '';//$('#gsttype').val();
		$.post('<?php echo base_url();?>oldInvoiceReports/billing_reportdownload',{'fromdate':fromdate,'todate':todate,'invoiceno':invoiceno,'cusname':cusname,gsttype:gsttype},function(data){
			window.open('<?php echo base_url();?>oldInvoiceReports/search_reports', '_blank');
		});
	});
...
$('#delete_form').submit(function(){
  ...
  $.post('<?php echo base_url(); ?>oldInvoiceReports/delete',{id:id},function(res){
