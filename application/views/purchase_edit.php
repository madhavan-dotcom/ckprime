...
<style type="text/css">
    ...
    .card-box {
        padding: 0px 20px 10px 11px !important;
    }
                ...
                <div class="col-sm-12">
                    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
                        ...
                        <header class="panel-heading" style="color:rgb(255, 255, 255)">
                            <i class="zmdi zmdi-shopping-cart"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Edit Purchase Receipt - <?php echo $vi['invoiceno']; ?>
                                </span></i>
                        </header>
                        <div class="card-box">
                            <div class="row">
                                ...
                                <div class="card-box">
                                    <div class="row">
                                        <form class="horizontal-form myform" name="editForm" method="post" action="<?php echo base_url(); ?>purchase/update" data-parsley-validate novalidate>
                                            <input type="hidden" id="discountBy" name="hiddenDiscountBy" value="<?php echo $discountBy; ?>" />
                                            <div class="form-group ">
                                                <div class="col-md-8 forms" style="margin-bottom: 10px;">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Date</label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="purchasetype" name="purchasetype" value="<?php echo $vi['purchasetype']; ?>">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <script>
                                                                document.editForm.gsttype.value = '<?php echo $vi['gsttype']; ?>';
                                                            </script>
                                                        </div>
                                                    </div>
                                                    <?php if ($vi['purchasetype'] == "purchase Order") {
                                                        $ptype = "Against PO";
                                                    } else if ($vi['purchasetype'] == "Job Order") {
                                                        $ptype = "Against Job Order";
                                                    } else {
                                                        $ptype = "Direct Purchase";
                                                    } ?>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Purchase Type</label>
                                                            <input type="text" auotocomplete="off" class="form-control" value="<?php echo $ptype; ?>" readonly>
                                                            <input type="hidden" auotocomplete="off" class="form-control" name="purchasetype" value="<?php echo $vi['purchasetype']; ?>" readonly>
                                                        </div>
                                                    </div>
                                            ...
                                            <table class="table table-bordered table-striped" style="min-width:1300px;">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        ?>
                                                        <?php if ($vi['purchasetype'] == 'purchase Order') { ?>
                                                            <th <?php echo $hidden ?>>Item Code</th>
                                                            <th>Heat No</th>
                                                        <?php } ?>
                                                        <th>Item Name</th>
                                                        <th>Qty</th>
                                                        <th>UOM</th>
                                                        <?php if ($vi['purchasetype'] !== 'Job Order') { ?>
                                                            <th>Grade</th>
                                                        <?php } ?>
                                                        <th>Weight</th>
                                                        <th>Rate</th>
                                                        ...
                                                        <th class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                        ...
                                                        <th class="igst" <?php if ($vi['gsttype'] == 'intrastate') {
                                                                                echo 'style="display:none"';
                                                                            } ?>>&nbsp;&nbsp;&nbsp;IGST</th>
                                                        <th class="igst" <?php if ($vi['gsttype'] == 'intrastate') {
                                                                                echo 'style="display:none"';
                                                ...
                                                <tbody>
                                                    ...
                                                    $itemcodez = explode('||', $vi['itemcode']);
                                                    $heatno = explode('||', $vi['heatno']);
                                                    $itemid = explode('||', $vi['itemid']);
                                                    ...
                                                    $purchaseorderno = explode('||', $vi['purchaseorderno']);
                                                    $purchaseorder   = explode('||', $vi['purchaseorder']);
                                                    $porecord_id     = explode('||', $vi['poRecordId']);
                                                    $joborder_no     = explode('||', $vi['joborder_No']);
                                                    $joborder_id     = explode('||', $vi['JO_RecordId']);

                                                    for ($i = 0; $i < count($itemname); $i++) {
                                                        //echo $itemname[$i].'='.htmlspecialchars(stripslashes($itemname[$i])).'<br>';
                                                        $this->db->select('*');
                                                        $this->db->from('additem');
                                                        $this->db->where('itemname', $itemname[$i]);
                                                        $this->db->where('itemcode', $itemcode[$i]);
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            ?>
                                                            <?php if ($vi['purchasetype'] == 'purchase Order') { ?>
                                                                <td><input class="itemcode_class form-control" data-id="<?php echo $i; ?>" id="itemcode<?php echo $i; ?>" style="width:70px;border:1px solid #605f5f;" type="text" name="itemcode[]" value="<?php echo $itemcodez[$i]; ?>"></td>
                                                                <input type="hidden" name="inwNo[]" value="<?php echo $purchaseorderno[$i] ?>">
                                                                <input type="hidden" name="purchaseorder[]" value="<?php echo $purchaseorder[$i] ?>">
                                                                <input type="hidden" name="poRecordId[]" value="<?php echo $porecord_id[$i] ?>">
                                                                <td><input class="form-control" data-id="<?php echo $i; ?>" id="heatno<?php echo $i; ?>" style="width:70px;border:1px solid #605f5f;" type="text" name="heatno[]" value="<?php echo $heatno[$i]; ?>"></td>
                                                            <?php } ?>
                                                            <td>
                                                                <input class="itemname_class" data-id="<?php echo $i; ?>" id="itemname<?php echo $i; ?>" value="<?php echo htmlspecialchars(stripslashes(@$itemname[$i])); ?>" style="width:150px;border:1px solid #605f5f;" type="text" name="itemname[]" value="" readonly>
                                                                <input type="hidden" data-id="<?php echo $i ?>" id="itemcodes<?php echo $i ?>" name="itemcode[]" value="<?php echo $itemcodez[$i]; ?>">
                                                                <div id="itemname_valid<?php echo $i; ?>"></div><input type="hidden" id="priceType<?php echo $i; ?>" name="priceType[]" value="<?php echo @$item_result->priceType; ?>" /><input type="hidden" name="itemid[]" id="itemid" value="<?php echo $itemid[$i]; ?>">
                                                            </td>
                                                            <td>
                                                            ...
                                                            <?php if ($vi['purchasetype'] !== 'Job Order') { ?>
                                                                <td>
                                                                    <select name="grade[]" id="grade<?php echo $i; ?>" data-id="<?php echo $i; ?>"
                                                                ...
                                                                <input type="hidden" name="joborder_No[]" value="<?php echo $joborder_no[$i] ?>">
                                                                <input type="hidden" name="JO_RecordId[]" value="<?php echo $joborder_id[$i] ?>">
                                                            <?php } ?>

                                                            <td><input class="weight_class" value="<?php echo $weight[$i]; ?>" id="weight<?php echo $i; ?>" data-id="<?php echo $i; ?>" style="width:50px;border:1px solid #605f5f;" type="text" name="weight[]" autocomplete="off"></td>
                                                            ...
                                                            <td><input class="discount_class decimals" data-id="<?php echo $i; ?>" id="discount<?php echo $i; ?>" value="<?php echo $discount[$i]; ?>" style="width:40px;border:1px solid #605f5f;" type="text" name="discount[]" value="0" autocomplete="off" onkeypress="return isNumberKey_With_Dot(event)">
                                                                <div id="discount_valid<?php echo $i; ?>"></div><input type="hidden" id="oldDisc<?php echo $i; ?>" value="<?php echo $discount[$i]; ?>">
                                                            </td>
                                                            ...
                                                            <td class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                                                    echo 'style="display:none"';
                                                                                } ?>><input class="decimals" value="<?php echo $cgst[$i]; ?>" readonly id="cgst<?php echo $i; ?>" required type="text" name="cgst[]" value="" style="width:45px;border:1px solid #605f5f;" onkeypress="return isNumberKey(event)" autocomplete="off" required>
                                                                <div id="cgst_valid<?php echo $i; ?>"></div>
                                                            </td>
                                                            <td class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                                                    echo 'style="display:none"';
                                                                                } ?>><input class="decimals" value="<?php echo $cgstamount[$i]; ?>" id="cgstamount<?php echo $i; ?>" required type="text" name="cgstamount[]" onkeypress="return isNumberKey(event)" autocomplete="off" readonly style="width:80px;border:1px solid #605f5f;" value=""></td>
                                                            <td class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                                                    echo 'style="display:none"';
                                                                                } ?>><input class="decimals" id="sgst<?php echo $i; ?>" value="<?php echo $sgst[$i]; ?>" required type="text" name="sgst[]" value="" readonly style="width:45px;border:1px solid #605f5f;" onkeypress="return isNumberKey(event)" autocomplete="off" required>
                                                                <div id="sgst_valid<?php echo $i; ?>"></div>
                                                            </td>
                                                            <td class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                                                    echo 'style="display:none"';
                                                                                } ?>><input class="decimals" value="<?php echo $sgstamount[$i]; ?>" id="sgstamount<?php echo $i; ?>" required type="text" name="sgstamount[]" onkeypress="return isNumberKey(event)" autocomplete="off" readonly style="width:80px;border:1px solid #605f5f;" value="">
                                                                <input type="hidden" id="igst<?php echo $i; ?>" value="<?php echo $item_result->igst; ?>" />
                                                            </td>
                                                            <td class="igst" <?php if ($vi['gsttype'] == 'intrastate') {
                                                                                    echo 'style="display:none"';
                                                                                } ?>><input class="decimals" id="igst<?php echo $i; ?>" type="text" name="igst[]" readonly style="width:45px;border:1px solid #605f5f;" value="<?php echo $igst[$i]; ?>" onkeypress="return isNumberKey(event)" autocomplete="off">
                                                                <div id="igst_valid<?php echo $i; ?>"></div>
                                                            </td>
                                                            <td class="igst" <?php if ($vi['gsttype'] == 'intrastate') {
                                                                                    echo 'style="display:none"';
                                                                                } ?>><input class="decimals" id="igstamount<?php echo $i; ?>" value="<?php echo $igstamount[$i]; ?>" type="text" name="igstamount[]" onkeypress="return isNumberKey(event)" autocomplete="off" readonly style="width:80px;border:1px solid #605f5f;" value=""></td>
                                            ...
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                                            echo 'style="display:none"';
                                                                        } ?>><input class="decimals" id="freightcgst" type="text" name="freightcgst" placeholder="CGST" value="<?php if ($vi['freightcgst'] != "") {
                                                                                                                                                                                    echo $vi['freightcgst'];
                                                                                                                                                                                } else {
                                                                                                                                                                                    echo '0';
                                                                                                                                                                                } ?>" style="border:1px solid #605f5f;" autocomplete="off"></td>
                                                    <td class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                                            echo 'style="display:none"';
                                                                        } ?>><input class="decimals" readonly id="freightcgstamount" placeholder="CGST Amount" type="text" name="freightcgstamount" autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $vi['freightcgstamount']; ?>"></td>
                                                    <td class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                                            echo 'style="display:none"';
                                                                        } ?>><input class="decimals" id="freightsgst" placeholder="SGST" type="text" name="freightsgst" readonly value="<?php if ($vi['freightsgst'] != "") {
                                                                                                                                                                                            echo $vi['freightsgst'];
                                                                                                                                                                                        } else {
                                                                                                                                                                                            echo '0';
                                                                                                                                                                                        } ?>" style="border:1px solid #605f5f;" autocomplete="off">
                                                        <div id="sgst_valid"></div>
                                                    </td>
                                                    <td class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                                            echo 'style="display:none"';
                                                                        } ?>><input class="decimals" id="freightsgstamount" type="text" name="freightsgstamount" placeholder="SGST Amount" readonly autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $vi['freightsgstamount']; ?>"></td>


                                                    <td class="igst" <?php if ($vi['gsttype'] == 'intrastate') {
                                                                            echo 'style="display:none"';
                                                                        } ?>><input class="decimals" id="freightigst" type="text" name="freightigst" placeholder="IGST" value="<?php if ($vi['freightigst'] != "") {
                                                                                                                                                                                    echo $vi['freightigst'];
                                                                                                                                                                                } else {
                                                                                                                                                                                    echo '0';
                                                                                                                                                                                } ?>" style="border:1px solid #605f5f;" autocomplete="off">
                                                    ...
                                                    <td class="igst" <?php if ($vi['gsttype'] == 'intrastate') {
                                                                            echo 'style="display:none"';
                                                                        } ?>><input class="decimals" id="freightigstamount" type="text" name="freightigstamount" placeholder="IGST Amount" autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $vi['freightigstamount']; ?>"></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input class="decimals" id="loadingamount" parsley-trigger="change" placeholder="Amount" style="border:1px solid #605f5f;" type="text" name="loadingamount" value="<?php echo $vi['loadingamount']; ?>" autocomplete="off">
                                                        <div id="rate_valid"></div>
                                                    </td>

                                                    <td class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                                            echo 'style="display:none"';
                                                                        } ?>><input class="decimals" id="loadingcgst" type="text" name="loadingcgst" placeholder="CGST" value="<?php if ($vi['loadingcgst'] != "") {
                                                                                                                                                                                    echo $vi['loadingcgst'];
                                                                                                                                                                                } else {
                                                                                                                                                                                    echo '0';
                                                                                                                                                                                } ?>" style="border:1px solid #605f5f;" autocomplete="off">
                                                    ...
                                                    <td class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                                            echo 'style="display:none"';
                                                                        } ?>><input class="decimals" readonly id="loadingcgstamount" type="text" name="loadingcgstamount" placeholder="CGST Amount" autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $vi['loadingcgstamount']; ?>"></td>
                                                    <td class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                                            echo 'style="display:none"';
                                                                        } ?>><input class="decimals" id="loadingsgst" placeholder="SGST" type="text" name="loadingsgst" readonly value="<?php if ($vi['loadingsgst'] != "") {
                                                                                                                                                                                            echo $vi['loadingsgst'];
                                                                                                                                                                                        } else {
                                                                                                                                                                                            echo '0';
                                                                                                                                                                                        } ?>" style="border:1px solid #605f5f;" autocomplete="off">
                                                    ...
                                                    <td class="sgst" <?php if ($vi['gsttype'] != 'intrastate') {
                                                                            echo 'style="display:none"';
                                                                        } ?>><input class="decimals" id="loadingsgstamount" type="text" name="loadingsgstamount" readonly placeholder="SGST Amount" autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $vi['loadingsgstamount']; ?>"></td>


                                                    <td class="igst" <?php if ($vi['gsttype'] == 'intrastate') {
                                                                            echo 'style="display:none"';
                                                                        } ?>><input class="decimals" id="loadingigst" type="text" name="loadingigst" placeholder="IGST" value="<?php if ($vi['loadingigst'] != "") {
                                                                                                                                                                                    echo $vi['loadingigst'];
                                                                                                                                                                                } else {
                                                                                                                                                                                    echo '0';
                                                                                                                                                                                } ?>" style="border:1px solid #605f5f;" autocomplete="off">
                                                    ...
                                                    <td class="igst" <?php if ($vi['gsttype'] == 'intrastate') {
                                                                            echo 'style="display:none"';
                                                                        } ?>><input class="decimals" id="loadingigstamount" placeholder="IGST Amount" type="text" name="loadingigstamount" autocomplete="off" readonly style="border:1px solid #605f5f;" value="<?php echo $vi['loadingigstamount']; ?>"></td>
        ...
        $(document).ready(function() {
            ...
            $("#suppliername").autocomplete({
                ...
                select: function(event, ui) {
                    ...
                    if (name != '') {
                        $.post('<?php echo base_url(); ?>purchase/getsupplier', {
                            name: name
                        }, function(res) {
                            if (res > 0) {
            ...
            $('.add').click(function() {
                ...
                $(' <tr>' +
                    '<td hidden><input class="" id="hsnno' + total + '" style="width:70px;border:1px solid #605f5f;" readonly type="text" name="hsnno[]" value="" style="width:70px;border:1px solid #605f5f;"><div id="hsnno_valid' + total + '"></div></td>'
                    <?php
                    $itemcode = $this->db->select('itemcode')->where('id', 1)->get('preference_settings')->row()->itemcode;
                    $hidden = '';
                    if ($itemcode == '') {
                    ...
                    ?> +
                    '<td <?php echo $hidden ?>><input class="itemcode_class" data-id="' + total + '" id="itemcode' + total + '" style="width:70px;border:1px solid #605f5f;" type="text" name="itemcode[]" value="0" style="width:70px;border:1px solid #605f5f;"><div id="itemcode_valid' + total + '"></div></td>' +
        ...
        function amount_calculation(rowNumber) {
            ...
            if (qty != '' && rate != '')
                if (purchasetype == "purchase Order" || purchasetype == "Direct Purchase") {
                    amo = parseFloat(rate) * parseFloat(qty) * parseFloat(weight);
                } else {
                    amo = parseFloat(rate) * parseFloat(qty);
                }
