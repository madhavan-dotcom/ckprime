	...
	?>
		...
		<?php if($_POST) {?>
		<form name="form" method="post" action="<?php echo base_url();?>oldPurchaseReports/reports" target="_blank" >
		<table>
		<tr>
		...
		"ajax": {
		"url": "<?php echo site_url('oldPurchaseReports/ajax_list')?>",
		"type": "POST",
		"data": function ( data ) {
		...
		$.post('<?php echo base_url();?>oldPurchaseReports/search',{'fromdate':fromdate,'suppliername':suppliername,'todate':todate,'invoiceno':invoiceno},function(data){

		window.open('<?php echo base_url();?>oldPurchaseReports/search_reports', '_blank');
		...
		$.post('<?php echo base_url();?>oldPurchaseReports/billing_reportdownload',{'fromdate':fromdate,'todate':todate,'invoiceno':invoiceno,'suppliername':suppliername},function(data){
		...
		$.post('<?php echo base_url(); ?>oldPurchaseReports/delete',{id:id},function(res){
		...
		$.ajax({ 
		url: "<?php echo base_url();?>oldPurchaseReports/autocomplete_customername1",
		...
		source: function(request, response) {
		$.ajax({ 
		url: "<?php echo base_url();?>oldPurchaseReports/autocomplete_invoiceno1",
