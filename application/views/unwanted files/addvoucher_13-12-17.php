					...
					<div class="col-sm-12">
						<section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
							<header class="panel-heading" style="color:rgb(255, 255, 255)">
								<i class="zmdi zmdi-money-box">&nbsp;Voucher</i> (<?php echo $voucherid;?>)
							</header>
							<div class="card-box">
								<div class="row">
									<form class="form-horizontal" role="form" method="post" onsubmit="setTimeout(function () { location.href = '<?php echo base_url();?>voucher';},2000)" target="_blank" action="<?php echo base_url();?>voucher/insert">
										...
										<div class="form-group">
											...
											<div class="controls col-sm-2">
												<input type="radio" name="vouchertype" style="width:50px;" checked onchange="payment()" id="optionsRadios33" value="Receivable"  required>Receivable                                
											</div>
											<div class="controls col-sm-2">
												<input type="radio" onchange="receipt()" style="width:50px;" name="vouchertype" id="optionsRadios5" value="Payable"  required>Payable
											</div>
										</div>
