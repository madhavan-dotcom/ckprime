									...
									?>
											<form class="form-horizontal" name="editForm" role="form" method="post"  action="<?php echo base_url();?>voucher/update">
												...
												<div class="form-group">
													...
													<div class="col-lg-4">
														<input type="text" class="form-control" name="vouchertype" id="vouchertype" value="<?php echo $row['vouchertype'];  ?>" readonly>
													</div>
												</div>
