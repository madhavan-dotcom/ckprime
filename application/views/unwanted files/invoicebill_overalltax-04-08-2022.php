...
<td width="60" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center"><strong>Units</strong></td>
...
<table width="700" border="0" align="center" style="border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;border-bottom: 1px solid #000;">
    <tbody>
        <tr>
            <td style="padding: 3px 10px;"><b>Descriptions: <?php echo $orderno;?></b></td>
        </tr>
    </tbody>
</table>
...
<tr>
<td colspan="3" style="border-right: 1px solid #000;">&nbsp;&nbsp;A/c Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</td>
...
<tr>
 <td colspan="3" style="border-right: 1px solid #000;">&nbsp;&nbsp;Branch &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <b><?php echo $profile->bankbranch;?></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;IFSC Code:<b><?php echo $profile->ifsccode;?></b></td>
...
<td colspan="2" align="right" style="border-bottom: 1px solid black">For &nbsp;&nbsp; <b style="font-size:14px;"><?php echo $profile->companyname;?></b>
<table>
    <tbody>
        <tr>
            <td> </td>
