									...
									<form class="form-horizontal myform"  method="post" action="<?php echo base_url();?>purchase/update" data-parsley-validate novalidate>
										...
										<table class="table">
											<tr>
												...
												<?php if($vi['gsttype']=='intrastate') { ?>
												<td ><input class="decimals"  id="freightcgst"  type="text" name="freightcgst" placeholder="CGST"  value="<?php if($vi['freightcgst']!="") { echo $vi['freightcgst']; } else { echo '0'; } ?>" style="border:1px solid #605f5f;"   autocomplete="off" ></td>
												...
												<td ><input class="decimals" id="freightsgst" placeholder="SGST"  type="text" name="freightsgst" readonly value="<?php if($vi['freightsgst']!="") { echo $vi['freightsgst']; } else { echo '0'; } ?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="sgst_valid"></div></td>
												...
												{
												?> 
												<td ><input class="decimals" id="freightigst"  type="text" name="freightigst"  placeholder="IGST" value="<?php if($vi['freightigst']!="") { echo $vi['freightigst']; } else { echo '0'; } ?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="igst_valid"></div></td>
											...
											<tr>
												...
												<?php if($vi['gsttype']=='intrastate') { ?>
												<td ><input class="decimals"  id="loadingcgst"  type="text" name="loadingcgst" placeholder="CGST" value="<?php if($vi['loadingcgst']!="") { echo $vi['loadingcgst']; } else { echo '0'; } ?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="cgst_valid"></div></td>
												...
												<td ><input class="decimals" id="loadingsgst" placeholder="SGST"  type="text" name="loadingsgst" readonly value="<?php if($vi['loadingsgst']!="") { echo $vi['loadingsgst']; } else { echo '0'; } ?>" style="border:1px solid #605f5f;"   autocomplete="off" ><div id="sgst_valid"></div></td>
												...
												{
												?> 
												<td ><input class="decimals" id="loadingigst"  type="text" name="loadingigst" placeholder="IGST" value="<?php if($vi['loadingigst']!="") { echo $vi['loadingigst']; } else { echo '0'; } ?>"  style="border:1px solid #605f5f;"   autocomplete="off" ><div id="igst_valid"></div></td>
