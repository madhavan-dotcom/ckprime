...
<i class="zmdi zmdi-shopping-cart">&nbsp;Edit Purchase Order </i> <?php echo $vi['purchaseorderno'];?>
</header>
<div class="card-box">
<div class="row">
...
<div class="card-box">
<div class="row">
<form class="horizontal-form myform"  method="post" action="<?php echo base_url();?>purchaseorder/update" data-parsley-validate novalidate>
...
<td  <?php echo $hidden;?>><input class="itemcode_class" data-id="<?php echo $i;?>" type="text" style="width:80px;border:1px solid #605f5f;" name="itemcode[]" id="itemcode<?php echo $i;?>" value="<?php echo @$itemcode[$i];?>"></td>
<td>
<input class="itemname_class" data-id="<?php echo $i;?>" id="itemname<?php echo $i;?>" value="<?php echo $itemname[$i];?>" style="width:150px;border:1px solid #605f5f;" type="text" name="itemname[]" <?php if($vi['potype']=='BOM') { echo 'readonly'; } ?>><div id="itemname_valid<?php echo $i;?>"></div><input type="hidden" id="priceType<?php echo $i;?>" name="priceType[]" value="<?php echo @$item_result->priceType;?>" /></td>
<td>
<input class="qty_class" data-id="<?php echo $i;?>" id="qty<?php echo $i;?>" required type="text" name="qty[]" value="<?php echo $qty[$i];?>"   autocomplete="off" style="width:50px;border:1px solid #605f5f;"><input type="hidden" name="qtys[]" id="qtys<?php echo $i;?>" value="<?php echo $qty[$i];?>"><div id="qty_valid<?php echo $i;?>"><?php if($vi['potype']=='BOM') { ?><input type="hidden" name="bomqty[]" id="bomqty<?php echo $i;?>" value="<?php echo $qty[$i];?>" ><div style="color:green;">BOM Qty : <?php echo $qty[$i];?></div><?php } ?></div>
</td>  
...
<td><input class="discount_class decimals" data-id="<?php echo $i;?>"  id="discount<?php echo $i;?>" value="<?php echo $discount[$i];?>"  style="width:40px;border:1px solid #605f5f;" type="text" name="discount[]" value="0"  autocomplete="off" onkeypress="return isNumberKey_With_Dot(event)"><div id="discount_valid<?php echo $i;?>"></div><input type="hidden" id="oldDisc<?php echo $i;?>" value="<?php echo $discount[$i];?>" ></td>
...
$.post('<?php echo base_url();?>purchaseorder/getbomdetails_edit',{'po_id':po_id,'selected_bom':selected_bom},function(data){
$('#inwarddetails').html(data);
call_keyup();
});
$('.bomClass').show();
...
+'<td <?php echo $hidden?>><input class="itemcode_class" id="itemcode'+total+'" data-id="'+total+'" style="width:80px;border:1px solid #605f5f;" type="text" name="itemcode[]"  value="0" autocomplete="off"></td>'
