...
<i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Material Dc Reports</span></i>
</header>
...
<div align="center">
<button id="print" class="btn btn-info" value="Print">Print Material DC</button>
</div>
<div align="center">
...
$.ajax({ 
url: "<?php echo base_url();?>material_dc/autocomplete_cusname",
...
"ajax": {
"url": "<?php echo site_url('material_dc/ajax_list')?>",
"type": "POST",
"data": function ( data ) {
...
$.post('<?php echo base_url();?>material_dc/search',{'fromdate':fromdate,'customername':customername,'todate':todate},function(data){

window.open('<?php echo base_url();?>material_dc/search_reports', '_blank');
...
$.post('<?php echo base_url(); ?>material_dc/delete',{id:id},function(res){
...
$.post('<?php echo base_url();?>material_dc/viewdc',{'id':id},function(data){
