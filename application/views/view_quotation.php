...
*/?>
					 <input type="hidden" name="quotationno" id="invoiceno" value="<?php echo $vi['quotationno'];?>" >
                      <input type="hidden" name="id" value="<?php echo $vi['id'];?>">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <label >Date</label>
                            <input type="text" class="form-control datepicker-autoclose" name="quotationdate" parsley-trigger="change" disabled id="datepicker-autoclose" required value="<?php echo date('d-m-Y',strtotime($vi['quotationdate']));?>" 
                            style="width:148px;">
                          </div>
                        </div>
                        ...
                        <div class="col-md-5">
                          <div class="form-group">
                            ...
                            <input type="text" disabled class="form-control" parsley-trigger="change" required name="customername" id="customername" value="<?php echo $vi['customername'];?>">
					...
					<input type="hidden" name="gstinno" value="<?php echo $vi['gstinno'];?>" />
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label>Address</label>
                          <textarea type="text" disabled class="form-control" name="address" id="address"  rows="4"><?php echo $vi['address'];?></textarea>
                        </div>
                      </div>
                    </div>
					<?php 
                  ...
                  <table class="table myform">
                      ...
                      ?>
                        <tr>
                          ...
                          <td><input class="itemname_class" required data-id="<?php echo $i;?>" id="itemname<?php echo $i;?>" value="<?php echo $itemname[$i];?>"  disabled type="text" name="itemname[]" value="" >
                            <div id="itemname_valid<?php echo $i;?>"></div>
                          </td>

                           <td><input class="qty_class" id="qty<?php echo $i;?>"  data-id="<?php echo $i;?>"  required type="text" name="qty[]" value="<?php echo $qty[$i];?>"   autocomplete="off" disabled style="width:100px;">
                          ...
                          <td><input class="rate_class decimals" data-id="<?php echo $i;?>"  value="<?php echo $rate[$i];?>" id="rate<?php echo $i;?>" disabled required type="text" name="rate[]"   autocomplete="off">
							...
							<td class="sgst" <?php echo $cgstStyle;?>><input class="decimals cgst_class" data-id="<?php echo $i;?>" value="<?php echo $cgst[$i];?>" disabled id="cgst<?php echo $i;?>"  type="TEXT" name="cgst[]" onkeypress="return isNumberKey(event)" autocomplete="off" ><div id="cgst_valid<?php echo $i;?>"></div></td>

							<td class="sgst" <?php echo $cgstStyle;?>><input class="decimals" value="<?php echo $cgstamount[$i];?>" id="cgstamount<?php echo $i;?>"  type="text" disabled name="cgstamount[]"   onkeypress="return isNumberKey(event)" autocomplete="off" readonly ></td>

							<td class="sgst" <?php echo $cgstStyle;?>> <input class="decimals sgst_class" data-id="<?php echo $i;?>"  id="sgst<?php echo $i;?>" value="<?php echo $sgst[$i];?>"  disabled type="text" name="sgst[]" onkeypress="return isNumberKey(event)" autocomplete="off" ></td>

							<td class="sgst" <?php echo $cgstStyle;?> ><input class="decimals" value="<?php echo $sgstamount[$i];?>" id="sgstamount<?php echo $i;?>"  type="text" disabled name="sgstamount[]" onkeypress="return isNumberKey(event)" autocomplete="off" readonly ></td>

							<td class="igst"  <?php echo $igstStyle;?>><input class="decimals igst_class" data-id="<?php echo $i;?>" id="igst<?php echo $i;?>" disabled type="text" name="igst[]"  value="<?php echo $igst[$i];?>"  onkeypress="return isNumberKey(event)" autocomplete="off"  ><div id="igst_valid<?php echo $i;?>"></div></td>

							<td class="igst"  <?php echo $igstStyle;?>><input class="decimals" id="igstamount<?php echo $i;?>" value="<?php echo $igstamount[$i];?>" disabled type="text" name="igstamount[]"   onkeypress="return isNumberKey(event)" autocomplete="off" readonly  ></td>
        ...
        <?php /*         <div class="col-sm-offset-5">
                  ...
                  <br>  */ ?>
                   ...
                   <div class="col-sm-offset-5">
                    ...
                    <div class="col-sm-7">
                      <input class="form-control"  type="text" name="othercharges" id="othercharges" disabled value="<?php echo $vi['othercharges'];?>" placeholder="0" value="0">
                    </div>
                  </div>
                  <br>
                  <br>  
