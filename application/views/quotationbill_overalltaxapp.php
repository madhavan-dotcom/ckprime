  ...
  <table width="750" border="0" style="border:1px solid black;border-collapse: collapse;" align="center">
    <tr>
      ...
      <td width="590" align="right" valign="top" style="font-size:14px;">
        ...
        <br><b>GSTIN: <?php echo $profile->gstin;?><!--  | CST No : --> <!-- <?php echo $profile->cstno;?> --> </b><br>Phone : <?php echo $profile->phoneno;?>,&nbsp;Mobile : <?php echo $profile->mobileno;?><br>Email id : <?php echo $profile->emailid;?>, Website : <?php echo $profile->website;?> </td>
        <td width="10"></td>
    </tr>
</table>
...
//215
    ...
    <table width="750"   height="470" align="center"  style="border-bottom:1px solid black;border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;">
      <tr style="font-size: 13px;">   
        ...
        <td width="<?php echo $itemwidth;?>" colspan="2" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center"><b>Item Description</b></td>
		<!--<td width="100" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center"><b>Description</b></td>-->
        <td width="1" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center"><strong>UOM</strong></td>
        ...
        for($i=0; $i< $count; $i++){
         ...
         @$cgsth[]=@$cgstamt;
          ...
          <tr style="height:1px;">
            ...
            <td align="left"  colspan="2" style="border-right: 1px solid black;padding:3px;font-size:13px;"><strong><?php echo $itemname[$i];?><br>
            <span align="center" style="font-size:11px;">(HSN:&nbsp;<?php echo $hsnno[$i];?>)</span><?php echo $dc_details;?></strong></td>
             <!--<td align="left" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong><?php echo $description[$i]?></strong></td>-->
          ...
          ?>
              ...
              <td align="right" style="border-right: 1px solid black;padding:3px;font-size:13px;"><strong><?php echo number_format((float)@$overalltotal[$i],2);?></strong></td>                 
      </tr>
            <?php } }?>      
            <tr >
