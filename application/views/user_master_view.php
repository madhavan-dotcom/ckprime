...
<div class="caption">
<li style="font-size: 14px;position: relative;list-style: none;"><i class="fa fa-user" style="padding-right: 4px;"></i>User Manager</li>
</div>
<div class="tools">
...
<div class="col-md-3">
<div class="form-group">
<label class="control-label" style="border-bottom: 2px solid #e8e8e8;color: #2477c9;padding: 4px;margin-bottom: 12px;border-radius: 1px;font-size: 17px;">Select Menu Privileges</label>
...
<li data-value="purchase/view" data-alt="Purchase">Purchase Reports</li>
...
<input type="button" class="btn btn-danger" value="Cancel" onclick="window.location.href='<?php echo base_url();?>index.php/usermaster';"/>
<?php } else { ?>
<button type="submit" id="submit" class="btn btn-success" >Save</button>
<input type="button" class="btn btn-warning" value="Cancel" data-toggle="collapse" data-target="#form_div" />
<?php } ?>
</div>
</div>
</div>
