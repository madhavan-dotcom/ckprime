...
"ajax": {
"url": "<?php echo site_url('oldexpenses/ajax_list')?>",
"type": "POST",
"data": function ( data ) {
data.name = $('#name').val();
...
$.post('<?php echo base_url();?>oldexpenses/search',{'fromdate':fromdate,'name':name,'headers':headers,'todate':todate},function(data){
window.open('<?php echo base_url();?>oldexpenses/search_reports', '_blank');
});
});
...
var name = $('#name').val();
var headers = $('#headers').val();
$.post('<?php echo base_url();?>oldexpenses/billing_reportdownload',{'fromdate':fromdate,'todate':todate,'headers':headers,'name':name},function(data){
window.open('<?php echo base_url();?>oldexpenses/search_reports', '_blank');
});
});
...
$.post('<?php echo base_url(); ?>oldexpenses/delete',{id:id},function(res){
