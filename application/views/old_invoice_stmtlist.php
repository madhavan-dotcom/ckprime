...
<?php } ?> -->
	...
	<!--<div align="center">
		<form method="post" name="printForm" id="printForm" target="_blank" action="<?php echo base_url();?>old_invoice_statement/search_reports">
  ...
  $(document).ready(function(){
    ...
    $( "#customername" ).autocomplete({
     ...
     $( "#invoiceno" ).autocomplete({
      source: function(request, response) {
        $.ajax({ 
          url: "<?php echo base_url();?>old_invoice_statement/autocomplete_name",
...
"ajax": {
  "url": "<?php echo site_url('old_invoice_statement/ajax_list')?>",
  "type": "POST",
  "data": function ( data ) {
...
table.ajax.reload(null,false);  //just reload table
	...
	$('#print').click(function(){
		...
		$.post('<?php echo base_url();?>old_invoice_statement/search',{'fromdate':fromdate,'customername':customername,'todate':todate,'invoiceno':invoiceno},function(data){
			window.open('<?php echo base_url();?>old_invoice_statement/search_reports', '_blank');
		});
	});
...
$('#download').click(function(){
 var fromdate = $('#fromdate').val();
  ...
  $.post('<?php echo base_url();?>old_invoice_statement/billing_reportdownload',{'fromdate':fromdate,'todate':todate,'invoiceno':invoiceno,'customername':customername},function(data){
