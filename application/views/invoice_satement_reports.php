...
<table width="1000" border="0" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif; font-size: 15px;">
	...
	if ($customername) {
		...
		$lastmodifiy = $this->db->select('last_modified')->where('name', $customername)->where("(type = 'Inter customer' OR type = 'Intra customer')")->get('customer_details')->row()->last_modified;
	...
	?>
			<tr>
				...
				<td align="right" style="border-bottom:1px dotted black;"><?php echo @number_format((float)$receiptamt, 2); ?></td>
		...
		$totalamount = ($openingbalance + $pur);
		...
		<tr>
			...
			<td align="right" style="border-top:1px solid black;">&nbsp;<b>Last Modified (<?php echo date("d-m-Y", strtotime($lastmodifiy)) ?>)</b></td>
		...
		<tr>
			...
			<td align="right">&nbsp;</td>
			<td align="right">&nbsp;</td>
			<td align="right" style="padding:5px;margin-bottom:2px solid black">Total Amount</td>
			<td align="right" style="padding:5px;margin-bottom:2px solid black"><strong><?php echo number_format(@$totalamount, 2); ?></strong></td>
		</tr>

		<tr>
			<td align="left" style="margin-top:2px solid black">&nbsp;</td>
			<td align="left">&nbsp;</td>
			<td align="left">&nbsp;</td>
			<td align="left">&nbsp;</td>
			<td align="right">&nbsp;</td>
			<td align="right">&nbsp;</td>
			<td align="right">Return(Debit) Amount</td>
		...
		<tr>
			...
			<td align="right">&nbsp;</td>
			<td align="right">&nbsp;</td>
			<td align="right">Receipt Amount (Paid Amount)</td>
