                ...
                <div class="col-sm-12">
                    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
                        <header class="panel-heading" style="color:rgb(255, 255, 255)">
                            <i class="zmdi zmdi-shopping-cart"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Edit Invoice - <?php echo $r['invoiceno']; ?></span></i>
                        </header>
                        <div class="card-box">
                            <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" auotocomplete="off" class="form-control datepicker-autoclose" name="orderdate" id="orderdate" value="<?php if ($r['orderdate'] == '1970-01-01' || '1969-12-31') {
                                                                                                                                                                            } else {
...
<div id="invoiceno_valid"></div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control " name="removalDate" value="<?php echo $r['removalDate']; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="shipTo" id="shipTo" value="<?php echo $r['shipTo']; ?>">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <?php $itemcode = $this->db->select('itemcode')->where('id', 1)->get('preference_settings')->row()->itemcode;
                                                            if ($itemcode == 1) { ?>
                                                                <td><input class="itemcode_class" data-id="<?php echo $i; ?>" id="itemcode<?php echo $i; ?>" parsley-trigger="change" required type="text" name="itemcode[]" value="<?php echo $itemcodes[$i]; ?>">
                                                            ...
                                                            <td style="width:200px;"><input class="itemname_class" data-id="<?php echo $i; ?>" id="itemname<?php echo $i; ?>" value="<?php echo $itemname[$i]; ?>" <?php echo $readonly; ?> style="border:1px solid #605f5f;" required type="text" name="itemname[]" value="">
                                                                <div id="itemname_valid<?php echo $i; ?>"></div><input type="text" name="item_desc[]" value="<?php echo @$item_desc[$i]; ?>" style="margin-top: 2px;border:1px solid #605f5f;"><?php if ($checkItemType == 'without_item') {
                                                            ...
                                                            <td><input class="weight_class" data-id="<?php echo $i; ?>" value="<?php echo $weight[$i]; ?>" id="weight<?php echo $i; ?>" style="border:1px solid #605f5f;" type="text" name="weight[]" autocomplete="off"></td>
                                                            ...
                                                            <td><input class="rate_class decimals" data-id="<?php echo $i; ?>" value="<?php echo $rate[$i]; ?>" id="rate<?php echo $i; ?>" required style="border:1px solid #605f5f;" type="text" name="rate[]" autocomplete="off">
                                                            ...
                                                            <td><input class="discount_class decimals" data-id="<?php echo $i; ?>" id="discount<?php echo $i; ?>" value="<?php echo $discount[$i]; ?>" style="border:1px solid #605f5f;" type="text" name="discount[]" value="0" autocomplete="off" onkeypress="return isNumberKey_With_Dot(event)">
