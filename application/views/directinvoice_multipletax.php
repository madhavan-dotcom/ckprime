...
<th style="width:50px">Disc <?php if($discountBy=='percent_wise') { echo '%'; } ?></th>
<th -style="width:100px">&nbsp;&nbsp;&nbsp;Taxable <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Amount</th>
<th class="sgst" style="width:65px">&nbsp;&nbsp;&nbsp;CGST</th>
<th class="sgst" style="width:100px">&nbsp;&nbsp;&nbsp;CGST <br> &nbsp;&nbsp;&nbsp;Amount</th>
<th class="sgst" style="width:45px">&nbsp;&nbsp;&nbsp;SGST</th>
<th class="sgst" -style="width:80px">&nbsp;&nbsp;&nbsp;SGST <br>&nbsp;&nbsp;&nbsp;Amount</th>
<th style="display:none;" class="igst igstreadonly">&nbsp;&nbsp;&nbsp;IGST</th>
<th style="display:none;" class="igst igstreadonly">&nbsp;&nbsp;&nbsp;IGST <br> &nbsp;&nbsp;&nbsp;Amount</th>
<th -style="width:110px" class="igstreadonly">Total</th>
...
<td><input class="itemname_class" data-id="0" id="itemname0" parsley-trigger="change" required  type="text" name="itemname[]" value="" ><div id="itemname_valid0"></div><input type="text" placeholder="Description"  name="item_desc[]" value="" style="margin-top: 2px;" ><input type="hidden" name="priceType[]" id="priceType0" /></td>
...
<td><input class="discount_class decimals" style="text-align:center;" data-id="0" id="discount0"  type="text" name="discount[]" maxlength="2" onkeypress="return isNumberKey_With_Dot(event)" value="0"  autocomplete="off"><div id="discount_valid0"></div></td>
...
<td class="igst" style="display:none;"><input data-id="0" class="decimals igstreadonly igst_class" id="igst0"  type="text" name="igst[]" readonly onkeypress="return isNumberKey(event)" autocomplete="off" ><div id="igst_valid0"></div></td>

<td class="igst" style="display:none;"><input data-id="0" class="decimals igstreadonly" id="igstamount0"  type="text" name="igstamount[]"   onkeypress="return isNumberKey(event)" autocomplete="off" readonly value=""></td>

<td><input class="igstreadonly" id="total0" type="text" name="total[]" value=""  readonly ></td>
<td style="width:10px;">&nbsp;</td>
<td><div class="col-sm-offset-11">
...
<td class="sgst"><input class="decimals frightamt" id="freightsgstamount"  type="text" name="freightsgstamount" placeholder="SGST Amount" readonly  autocomplete="off" readonly style="" value=""></td>

<td class="igst" style="display:none;"><input class="decimals frightamt" id="freightigst"  type="text" name="freightigst"  placeholder="IGST"  value="0"   autocomplete="off" ><div id="igst_valid"></div></td>

<td class="igst" style="display:none;"><input class="decimals frightamt" id="freightigstamount"  type="text" name="freightigstamount"  placeholder="IGST Amount"  autocomplete="off" readonly style="" value=""></td>
...
<td class="sgst"><input class="decimals frightamt" id="loadingsgstamount"  type="text" name="loadingsgstamount" readonly  placeholder="SGST Amount" autocomplete="off" readonly style="" value=""></td>

<td class="igst" style="display:none;"><input class="decimals frightamt" id="loadingigst"  type="text" name="loadingigst" placeholder="IGST"   value="0"   autocomplete="off" ><div id="igst_valid"></div></td>

<td class="igst" style="display:none;"><input class="decimals igst_class frightamt" id="loadingigstamount" placeholder="IGST Amount" type="text" name="loadingigstamount"    autocomplete="off" readonly style="" value=""></td>
...
+'<td class="sgst" style="display:'+samples1+';"><input class="decimals" id="sgstamount'+total+'"  type="text" name="sgstamount[]"  readonly onkeypress="return isNumberKey(event)" autocomplete="off" value=""></td>'
