        ...
        <div class="col-sm-12">
          <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
            <header class="panel-heading" style="color:rgb(255, 255, 255)">
              <i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Proforma Invoice Reports</span></i>
            </header>
...
<?php } ?>
              ...
              <div align="center">
             <button id="print" class="btn btn-info" value="Print">Print Invoice Reports</button>
