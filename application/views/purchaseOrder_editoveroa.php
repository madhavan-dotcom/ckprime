...
<i class="zmdi zmdi-shopping-cart"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Work Order - <?php echo $result->purchaseorderno;?></span></i>
</header>
<div class="card-box">
<div class="row">
<form class="form-horizontal"  method="post" name="logoForm" id="myform"  action="<?php echo base_url();?>purchaseorder/save_oa"><!---->
<input type="hidden" class="form-control" name="purchaseorderno" id="purchaseorderno" value="<?php echo $result->purchaseorderno;?>" 
readonly>
...
<div class="col-md-2">
<label >Date</label>
<input type="text" class="form-control datepicker-autoclose" name="purchasedate" parsley-trigger="change" id="datepicker-autoclose" required value="<?php echo $result->purchasedate;?>" readonly>
</div>
...
<input type="text" class="form-control" parsley-trigger="change" required name="customername" id="customername" value="<?php echo $result->customername;?>" readonly>
...
<input type="text" class="form-control" parsley-trigger="change" required name="purchaseorder" id="purchaseorder" value="<?php echo $result->purchaseorder;?>" readonly>
<div id="purchaseorder_valid" style="position: absolute;"></div>
</div>
</div>
<div class="col-md-3">
<label>Work Order  Date</label>
<input type="text" auotocomplete="off" class="form-control datepicker-autoclose" required name="invoicedate" id="invoicedate" value="<?php echo $result->invoicedate;?>" readonly>
</div>


<div class="col-md-3">
<label>Delivery Date</label>
<input type="text" auotocomplete="off" class="form-control datepicker-autoclose" required name="deliverydate" id="deliverydate" value="<?php echo $result->deliverydate;?>" readonly>
...
<div class="col-md-4">
<label>Address</label>
<textarea type="text" class="form-control" readonly name="address" id="address" required value="<?php echo $result->address;?>" rows="4"><?php echo $result->address;?></textarea>
</div>
</div>
...
<th style="width:10px">Delivery Date</th>
</tr>    
</thead>
<tbody>
...
<?php 
 ...
 $deliverydate = explode('||',$result->oa_deliverydate);
...
<tr>
<td><input class="" id="hsnno<?php echo $i;?>" parsley-trigger="change" required readonly type="text" name="hsnno[]" value="<?php echo $hsnno[$i];?>" readonly><div id="hsnno_valid<?php echo $i;?>"></div></td>


<td><input class="itemcode_class" data-id="<?php echo $i;?>" id="itemcode<?php echo $i;?>" parsley-trigger="change" required type="text" name="itemcode[]" value="<?php echo $itemcode[$i];?>" readonly><div id="itemcode_valid0"></div></td>

<td><input class="itemname_class" style="width: 250px;" data-id="<?php echo $i;?>" id="itemname<?php echo $i;?>" parsley-trigger="change" required  type="text" name="itemname[]" value="<?php echo $itemname[$i];?>" readonly><div id="itemname_valid<?php echo $i;?>"></div><input type="text" name="item_desc[]" value="<?php echo $itemdesc[$i];?>" placeholder="Description" style="margin-top: 2px;" readonly><input type="hidden" name="priceType[]" id="priceType<?php echo $i;?>" /></td>

<td><input class="" data-id="<?php echo $i;?>" id="drawingno<?php echo $i;?>" parsley-trigger="change" required type="text" name="drawingno[]" value="<?php echo $drawingno[$i];?>" readonly></td>

<td>
    <select name="grade[]" id="grade<?= $i ?>" data-id="<?= $i ?>" class="form-control grade_class" style="width:120px;" readonly> 
...
<td><input class="qty_class decimals" data-id="<?php echo $i;?>" id="qty<?php echo $i;?>"   parsley-trigger="change" required type="text" name="qty[]" value="<?php echo $qty[$i];?>" readonly  autocomplete="off" ><input class="" id="qtys<?php echo $i;?>"   type="hidden" name="qtys[]"><div id="qty_valid<?php echo $i;?>"></div></td>  

<td><input class="" id="uom<?php echo $i;?>" parsley-trigger="change" required readonly  type="text" name="uom[]" value="<?php echo $uom[$i];?>" autocomplete="off" readonly></td>

<td><input class="" id="weight<?php echo $i;?>" parsley-trigger="change" required   type="text" name="weight[]" value="<?php echo $weight[$i];?>" autocomplete="off" readonly></td>

<td><input class="rate_class decimals"  data-id="<?php echo $i;?>" parsley-trigger="change" required id="rate<?php echo $i;?>"  type="text" name="rate[]" value="<?php echo $rate[$i];?>"  autocomplete="off" readonly><div id="rate_valid<?php echo $i;?>"></div></td>

<td><input class="decimals" id="amount<?php echo $i;?>" parsley-trigger="change" required readonly type="text" name="amount[]" value="<?php echo $amount[$i];?>"  autocomplete="off readonly"><div id="amount_valid<?php echo $i;?>"></div></td>

<td><input class="discount_class decimals" data-id="<?php echo $i;?>" id="discount<?php echo $i;?>"  type="text" name="discount[]" maxlength="2" onkeypress="return isNumberKey_With_Dot(event)" value="<?php echo $discount[$i];?>"  autocomplete="off" readonly><div id="discount_valid0"></div></td>
...
<td><input  style="width:100px" type="text" auotocomplete="off" class="form-control datepicker-autoclose" required name="deliverydate[]" id="deliverydate" value="<?php echo $deliverydate[$i];?>" ></td>
...
<button  class="btn btn-info" name="save"  id="submit">Update  Work Order</button>
...
+'<td><select name="grade[]" id="grade'+total+'" data-id="'+total+'" class="form-control grade_class" style="width:120px;"> <option value="">Select Grade</option><?php foreach($grades as $g){ ?><option value="<?php echo $g->id;?>"><?php echo $g->grade;?></option><?php } ?></select></td>'
...
+'<td><input class="" id="weight'+total+'" parsley-trigger="change" required   type="text" name="weight[]"  autocomplete="off"></td>'
...
$.post('<?php echo base_url();?>purchase/get_itemcodes',{name:name},function(rest){
