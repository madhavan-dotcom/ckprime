...
<table width="1066" border="0" align="center" style="border-collapse:collapse; font-family:Calibri ;font-size:18px;">
    ...
    <tr align="center">
        <td class="padding" style="font-size:13px;" width="1060"><b><?php echo $address1; ?><br><?php echo $address2; ?>
            <br>Mobile No :&nbsp;<?php echo $phoneno; ?>,&nbsp; Email:&nbsp;<?php echo $emailid; ?></b><br><b>GSTIN :&nbsp;<?php echo $gstin; ?></b>
        </td>
    </tr>
    </tr>
</table>
...
<table width="1066" border="0" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif;">
    <tr style="font-size: 16px;">
        <td height="35" width="273" align="left" style="border-bottom:1px solid black;text-transform:uppercase;"><strong>Jobwork DC Reports </strong></td>
...
<table width="1066" border="0" align="center" style="border-collapse:collapse; font-family: Arial, Helvetica, sans-serif; font-size: 15px;">
    <tr>
        ...
        <td width="142" align="right" style="border-bottom:1px solid black;"><strong>DC Type</strong></td>
        <td width="112" align="right" style="border-bottom:1px solid black;"><strong>Qty</strong></td>
    </tr>
    ...
    foreach ($purchase as $row) {
        ...
        $getdcdelivery = $this->db->where('insertid', $row['id'])->get('jobworkdc_delivery')->result();

        $qty = 0;
        foreach ($getdcdelivery as $d) {
            $qty += $d->balanceqty;
        }
    ...
    ?>
        <tr>
            ...
            <td align="right" style="border-bottom:1px dotted black;"><?php echo $qty; ?></strong></td>
        </tr>
    <?php } ?>
