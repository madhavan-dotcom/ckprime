                ...
                <div class="col-sm-12">
                    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
                        <header class="panel-heading" style="color:rgb(255, 255, 255)">
                            <i class="zmdi zmdi-shopping-cart"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Edit Supplier Purchase Order - <?php echo $vi['purchaseorderno']; ?></span></i>
                        </header>
                        <!-- <div class="card-box">
                            <div class="row"> -->
                        ...
                        <div class="card-box">
                            <div class="row">
                                <form class="horizontal-form myform" method="post" action="<?php echo base_url(); ?>supplier_purchaseorder/update" data-parsley-validate novalidate>
...
<option value="<?php echo $vi['potype']; ?>"><?php echo $vi['potype']; ?></option>
                                                    ...
                                                    <!-- <input type="hidden" name="balanceqty" id="balanceqty" value="<?php echo $vi['balanceqty'] ?>" /> -->
                                                    <input type="hidden" name="workorderno" id="workorderno" value="<?php echo $vi['workorderno'] ?>" />
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                              ...
                                              <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="purchaseorder" id="purchaseorder" value="<?php echo $vi['purchaseorder']; ?>" readonly>
												...
												<select class="form-control" name="tcctype" id="tcctype">
    <option value="">Select Terms and Condition</option>

    <option value="1" <?php if($vi['tcctype'] == 1) echo 'selected'; ?>>
        Casting
    </option>

    <option value="2" <?php if($vi['tcctype'] == 2) echo 'selected'; ?>>
        Pattern
    </option>

    <option value="3" <?php if($vi['tcctype'] == 3) echo 'selected'; ?>>
        Inspection
    </option>
</select>
											...
											<input type="text" name="vendor_quot" id="vendor_quot" class="form-control" value="<?php echo $vi['vendor_quot']; ?>">
											</div>
											
												<div class="col-md-4">
												<label>Vendor Quot Date</label>
												<input type="text" auotocomplete="off" class="form-control datepicker-autoclose" required name="quot_date" id="quot_date" value="<?php echo $vi['quot_date']; ?>">
											</div> 
...
<input type="text" auotocomplete="off" class="form-control datepicker-autoclose" name="invoicedate" id="invoicedate" value="<?php echo date('d-m-Y', strtotime($vi['invoicedate'])); ?>" >
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            $grades = explode('||', $vi['grade']);
                                            $qty = explode('||', $vi['qty']);
                                            $weight = explode('||', $vi['weight']);
                                            $uom = explode('||', $vi['uom']);
                                            $rate = explode('||', $vi['rate']);
                                            $amount = explode('||', $vi['amount']);
                                             $workorderid = explode('||', $vi['workorderid']);
                                            $taxableamount = explode('||', $vi['taxableamount']);
                                            $deliverydates = explode('||',$vi['deliverydates']);

                                            $balanceqty = explode('||', $vi['balanceqty']);
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input class="form-control" id="id<?php echo $i; ?>" type="hidden" value="<?php echo $i; ?>">
                                                         <input class="form-control" id="itemid<?php echo $i; ?>" style="width:70px;border:1px solid #605f5f;" readonly type="text" value="<?php echo $itemid[$i]; ?>">
                                                        <div id="hsnno_valid<?php echo $i; ?>"></div>
                                                    </td>
<input type="hidden" name="workorderid[]" id="workorderid<?php echo $i; ?>" value="<?php echo $workorderid[$i]; ?>" />
<input type="hidden" name="balanceqty[]" id="balanceqty<?php echo $i; ?>" value="<?php echo $balanceqty[$i]; ?>" />

                                                    <td><input class="itemcode_class" data-id="<?php echo $i; ?>" id="itemcode<?php echo $i; ?>" parsley-trigger="change" required type="text" name="itemcode[]" value="<?php echo $itemcode[$i]; ?>"></td>
                                                    <td>
                                                        ...
                                                        <input type="text" data-id="<?php echo $i; ?>" id="item_desc<?php echo $i; ?>" name="item_desc[]" value="<?php echo $itemdesc[$i]; ?>" placeholder="Description" style="margin-top: 2px;">
                                                    ...
                                                    <td><select name="grade[]" id="grade<?php echo $i; ?>" data-id="<?php echo $i; ?>" class="form-control grade_class" style="width: 120px;" required>
                                                            ...
                                                            <?php foreach ($grade as $g) { ?>
                                                                <option value="<?php echo $g->id; ?>" <?php if ($g->id == $grades[$i]) echo 'selected'; ?>><?php echo $g->grade; ?></option>
                                                    ...
                                                    <td><input class="decimals" id="taxableamount<?php echo $i; ?>" value="<?php echo $taxableamount[$i]; ?>" readonly style="width:100px;border:1px solid #605f5f;" type="text" name="taxableamount[]" value="" autocomplete="off"><input type="hidden" name="discountamount[]" id="discountamount<?php echo $i; ?>"></td>
                                                     	...
                                                     	<td><input class="form-control datepicker-autoclose" id="deliverydates<?php echo $rows->id; ?>"  type="text" name="deliverydates[]" autocomplete="off" value="<?php echo $deliverydates[$i];?>"></td>
    ...
    <div class="col-md-12" style="margin-top: 25px;">
                                                ...
                                                <textarea rows="5" name="requirements" style="width:30%;"><?php echo $vi['requirements'];?></textarea>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            //         '<td><input class="itemcode_class" data-id="' + total + '"  parsley-trigger="change" required id="itemcode' + total + '"  style="width:150px;border:1px solid #605f5f;" type="text" name="itemcode[]" value=""></td>' +
            //         '<td><input class="itemname_class" data-id="' + total + '"  parsley-trigger="change" placeholder="itemname" required id="itemname' + total + '"  style="width:210px;border:1px solid #605f5f;" type="text" name="itemname[]" value=""><input data-id="' + total + '"  parsley-trigger="change" required id="item_desc' + total + '"  style="width:210px;border:1px solid #605f5f;" type="text" name="item_desc[]" value=""></td>' +
            //         '<td><input class="" data-id="' + total + '" id="drawingno' + total + '"    parsley-trigger="change" required type="text" name="drawingno[]" placeholder="drawingno" autocomplete="off" ><div id="qty_valid' + total + '"></div></td>' +

            //         '<td><select name="grade[]" id="grade' + total + '" class="form-control grade_class"><?php $grade =  $this->db->where('status', 1)->get('grade')->result();
            //                                                                                                 foreach ($grade as $g) { ?><option value="<?php echo $g->id; ?>"><?php echo $g->grade; ?></option><?php  ?></select></td>' +

            //         '<td><input class="qty_class" data-id="' + total + '" id="qty' + total + '"    parsley-trigger="change" required type="text" name="qty[]" placeholder="qty" onkeypress="return isNumberKey(event)" autocomplete="off" style="width:50px;border:1px solid #605f5f;"><div id="qty_valid' + total + '"></div><input type="hidden" id="qtys' + total + '" value="0" /></td>' +

            //         '<td><input class="" readonly id="uom' + total + '" placeholder="uom"  style="width:50px;border:1px solid #605f5f;" type="text" name="uom[]"   autocomplete="off"></td>' +

            //         '<td><input class="weight" id="weight' + total + '" placeholder="weight" data-id="' + total + '" input type = "text" name="weight[]" ></td>' +

            //         '<td><input class="rate_class placeholder="rate" decimals" data-id="' + total + '" id="rate' + total + '"  style="width:70px;border:1px solid #605f5f;" type="text" name="rate[]" required autocomplete="off"><div id="rate_valid' + total + '"></div></td>' +
            //         '<td><input class="decimals" placeholder="amount" id="amount' + total + '" readonly style="width:100px;border:1px solid #605f5f;" type="text" name="amount[]" value=""  autocomplete="off"><input type="hidden" name="gstcal[]" id="gstcal' + total + '" value=""></td>' +
