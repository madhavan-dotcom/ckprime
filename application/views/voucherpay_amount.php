  ...
  <div class="content-page">
    ...
    <div class="content">
      <div class="container">
          ...
          <div class="col-sm-12">
            <section>
              <header class="panel-heading" style="color:rgb(255, 255, 255)">
                <i class="zmdi zmdi-money-box"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Voucher</span></i>
              </header>
       ...
       <form class="form-horizontal" role="form" method="post" target="_blank"  action="<?php echo base_url();?>voucher/add">
