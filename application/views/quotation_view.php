        ...
        <div class="col-sm-12">
          <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
            <header class="panel-heading" style="color:rgb(255, 255, 255)">
              <i class="zmdi zmdi-shopping-cart"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Quotation Reports</span></i>
            </header>
              ...
              <form method="post" id="form-filter" action="<?php echo base_url();?>quotation/search">
                <table style="margin: 0 auto;">
                  ...
                  <!--<td> &nbsp;&nbsp; &nbsp;&nbsp;<input type="submit" class="btn btn-info" value="Search"></td>-->
					<td>
						<button type="button" id="btn-filter" class="btn btn-primary" style="margin-left:20px;">Search</button>
                  ...
                  <table>
                    <tr>
                      <td><input type="hidden" name="fromdate" id="pfromdate" class="form-control" 
                        ...
                        <td><input type="submit" class="btn btn-info" name="submit" value="Print Reports" style="margin-left:600px;"></td>
                      </tr>
                    </table>
                  </form>
                  <?php //}?> 
