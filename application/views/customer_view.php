...
<header class="panel-heading" style="color:rgb(255, 255, 255);background: #2477c9;    margin-top: 68px;">
<i class="zmdi zmdi-account"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Supplier / Customer Reports</span></i>
</header>
...
<div class="col-lg-4">
<div class="form-group">
<label for="inputPassword">Branch<span style="color:red;">&nbsp;</span></label>
<input type="text" name="printname" value="<?php echo $v['printname'];?>" class="form-control" id="printname" placeholder="Enter Branch" disabled>
</div>
</div>
...
<div class="col-lg-4">
<div class="form-group">
<label for="inputPassword">IFC Code</label>
<input type="text" name="chequename" class="form-control" value="<?php echo $v['chequeno'];?>" id="chequename" placeholder="Enter The IFC Code" disabled>
</div>
</div>
...
<td><button type="button" id="excel" style="margin-left:30px;" name="excel" class="btn btn-primary" value="">Download as Excel</button></td>
</tr>
</table>
</form>
<?php }?>
...
$.post('<?php echo base_url();?>customer/download',{'partytype':partytype},function(data){
window.open('<?php echo base_url();?>customer/excel_download', '_blank');
