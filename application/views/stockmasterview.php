...
<input type="text" class="form-control" name="itemcode" autocomplete="off" id="itemcode" value="" >
...
<input type="text" autocomplete="off" autocomplete="off" required class="form-control decimal" name="qty" id="qty" maxlength="4">
...
// $('#itemcode').focus();
// $('#itemcode').val('');
// $('#itemcode_valid').html('<div><font color="red">Invalid Item code</font></div>');
