...
<tr>
<td width="200" ><img src="<?php echo base_url();?>upload/<?php echo $profileimage->image;?>" width="130" height="70" alt="logo" /></td>
<td width="450" align="center" valign="top" style="font-size:14px;">
<strong style="font-size: 18px;"><?php echo $profile->companyname;?></strong>
<br><?php echo $profile->address1;?>, <?php echo $profile->address2;?><br><?php echo $profile->city;?> - <?php echo $profile->pincode;?>, Tamilnadu, India<br><b>GSTIN: <?php echo $profile->gstin;?>  | PAN No :   <?php echo $profile->aadharno;?> </b>
...
<table width="750"   height="<?php echo $tot_width;?>" align="center"  style="border-bottom:1px solid black;border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;">
...
<td width="38" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center"><strong>HSN / SAC</strong></td>
...
<td align="left" style="border-right: 1px solid black;padding:3px;font-size:14px;"><?php echo $itemname[$i];?><?php echo $dc_details.$descDet;?>
</td>
...
<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><?php echo number_format($rate[$i],2);?></strong></td>
...
<tr>
<td colspan="3" rowspan="3" valign="top" style="font-size:14px;font-weight:bold; border-right: 1px solid black;">Grand Total in words<br><span style="font-size:13px;">Rupees :<b style="font-size:13px;"><?php echo $fin;?> only</b></span><br><br>Total Tax Amount &nbsp;&nbsp;:&nbsp;<?php echo number_format($taxAmt,2); ?> <br><span style="font-size:13px;">Rupees :<b style="font-size:13px;"><?php echo @$fins;?> only</b></span></td>
...
<tr>
<td align="right" style=""><span style="font-size:16px;font-weight:bold;">Frieght Charges&nbsp;&nbsp;:</span></td>
<td align="right" ><b><?php echo  number_format($bil->freightamount,2);?></b></td>
</tr>
<tr>
<td align="right" style=""><span style="font-size:16px;font-weight:bold;">P & F Charges&nbsp;&nbsp;:</span></td>
<td align="right" ><b><?php echo  number_format($bil->loadingamount,2);?></b></td>
</tr>

<tr>
<td width="126" colspan="3" rowspan="4" align="left" style="border-right: 1px solid black; border-bottom: 1px solid black;"></td>
...
<td align="right" ><b><?php echo  number_format($bil->cgstamount,2);?></b></td>
</tr>

<tr>
<td align="right" style=""><span style="font-size:16px;font-weight:bold;">&nbsp;&nbsp;SGST&nbsp;&nbsp;@<?php echo $bil->sgst;?>%:</span></td>
<td align="right" ><b><?php echo  number_format($bil->sgstamount,2);?></b></td>
<?php }
if($bil->gsttype=='interstate')
{
?>   
...
<tr>
<td align="right" style="border-bottom: 1px solid black"><span style="font-size:16px;font-weight:bold;">Grand Total &nbsp;&nbsp;:</span></td>
...
<tr>
<td width="180" style="font-size:13px;border-right:1px solid black; "><b>&nbsp;&nbsp;<u>Bank Details</b></u></td>
 
<td width="280" style="font-size:13px;border-right:1px solid black;" align="right">For <b style="font-size:15px;"><?php echo $profile->companyname;?></b></td>
</tr>
<td width="180" height="65" valign="top" style="font-size:13px;border-right:1px solid black;">&nbsp;&nbsp;Bank Name &nbsp;: <b><?php echo $profile->bankname;?></b><br>&nbsp;&nbsp;Branch &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <b><?php echo $profile->bankbranch;?></b><br>&nbsp;&nbsp;Account No &nbsp;: <b><?php echo $profile->accountno;?></b><br>&nbsp;&nbsp;IFSC Code &nbsp;&nbsp;: <b><?php echo $profile->ifsccode;?></b></td>
