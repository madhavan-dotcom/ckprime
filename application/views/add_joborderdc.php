                ...
                <div class="col-sm-12">
                    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
                        <header class="panel-heading" style="color:rgb(255, 255, 255)">
                            <i class="zmdi zmdi-assignment-o"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Jobwork Dc (<?php echo $cusno; ?>)</span></i>
                        </header>
                        <div class="card-box" style="min-height: 500px;">
                            <div class="row">
                                <form class="form-horizontal" id="dc_forms" data-parsley-validate novalidate method="post" target="_blank" onsubmit="setTimeout(function () { location.href = '<?php echo base_url(); ?>joborder_dc'; },2000)" action="<?php echo base_url(); ?>joborder_dc/insert">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-8 forms">
                                            ...
                                            <div class="col-md-3">
                                                <label>DC Date</label>
                                                <input type="text" required class="form-control datepicker-autoclose"
                                                    name="dcdate" id="dcdate" value="<?php echo date('d-m-Y'); ?>">
                                            </div>

                                            <div class="col-md-6">
                                                <label>Customer Name</label>
                                                <input type="text" required class="form-control" name="customername" id="cusname">
                                            ...
                                            <div class="col-md-6" style="margin-top: 13px;">
                                                <label>Remarks</label>
                                                <input type="text" class="form-control" name="remarkss" id="remarkss">
                                            </div>
        ...
        $(document).ready(function() {
            $("#cusname").autocomplete({
                source: function(request, response) {
                    $.ajax({
                        url: "<?php echo base_url(); ?>joborder_dc/autocomplete_customername",
                        data: {
                            keyword: $("#cusname").val()
                        },
                        dataType: "json",
                ...
                select: function(event, ui) {
                    ...
                    if (name != '') {
                        $.post('<?php echo base_url(); ?>joborder_dc/getcustomer', {
                            name: name
                        }, function(res) {
                            console.log(res);
                            if (res > 0) {
            ...
            if (dctype == 'Direct DC') {
                ...
                $.post('<?php echo base_url(); ?>joborder_dc/getinward_details', {
                    'dctype': dctype
                }, function(data) {
                ...
                if (inwardno == 'null') {
                    ...
                    $.post('<?php echo base_url(); ?>joborder_dc/getinwarddetails', {
                        'inwardno': inwardno
                    }, function(data) {
                        $('.inwarddetails').html(data);
                    });
