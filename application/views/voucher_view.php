                        ...
                        <div class="col-sm-12">
                            <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
                                <header class="panel-heading" style="color:rgb(255, 255, 255)">
									<i class="zmdi zmdi-money-box"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Voucher Reports</span></i>
                                </header>
...
$('#excel').click(function(){
 var fromdate = $('#fromdate').val();
  ...
  $.post('<?php echo base_url();?>voucher/download',{'fromdate':fromdate,'todate':todate,'name':name,type:type},function(data){

    window.open('<?php echo base_url();?>voucher/excel_download', '_blank');
