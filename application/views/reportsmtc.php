    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="alert btn-info alert-micro btn-rounded pastel light dark success">
                <a href="#" class="close" data-dismiss="alert">&times;</a>MTC report Deleted Successfully !
            </div>

            <div class="alert btn-info alert-micro btn-rounded pastel light dark unsuccess">
                <a href="#" class="close" data-dismiss="alert">&times;</a>MTC report Unsuccessfully
            </div>
                ...
                <div class="col-sm-12">
                    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
                        <header class="panel-heading" style="color:rgb(255, 255, 255)">
                            <i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">MTC Reports</span></i>
                        </header>
                            ...
                            <form name="from" id="form-filter" method="post">
                                <table style="margin: 0 auto;">
                                    <tr>
                                        ...
                                        <td>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="customername" id="name" style="font-size:16px;width: 185px;" placeholder="Customer Name">
                                            </div>
                                        </td>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#table').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url('Mtc/ajax_list') ?>",
                        "type": "POST",
                        "data": function(data) {
                ...
                $('#delete_form').submit(function() {
                    ...
                    $.post('<?php echo base_url(); ?>Mtc/delete_mtc', {
                        id: id
                    }, function(res) {
