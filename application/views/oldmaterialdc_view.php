...
<i class="zmdi zmdi-view-headline">&nbsp;Old Material Dc Reports</i>
</header>
...
$.ajax({ 
url: "<?php echo base_url();?>oldmaterial_dc/autocomplete_cusname",
...
"ajax": {
"url": "<?php echo site_url('oldmaterial_dc/ajax_list')?>",
"type": "POST",
"data": function ( data ) {
...
$.post('<?php echo base_url();?>oldmaterial_dc/search',{'fromdate':fromdate,'customername':customername,'todate':todate},function(data){

window.open('<?php echo base_url();?>oldmaterial_dc/search_reports', '_blank');
...
$.post('<?php echo base_url(); ?>oldmaterial_dc/delete',{id:id},function(res){
...
$.post('<?php echo base_url();?>oldmaterial_dc/viewdc',{'id':id},function(data){
