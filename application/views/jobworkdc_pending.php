...
<i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Job Work DC Pending</span></i>
</header>
...
{?><tr>
<td><?php echo $i++;?></td>
<td><?php echo date('d-m-Y',strtotime($u['dcdate']));?></td>
<td><?php echo $u['dcno'];?></td>
