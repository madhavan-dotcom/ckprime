...
<i class="zmdi zmdi-assignment-o"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Dc (<?php echo $cusno;?>)</span></i>
</header>
<div class="card-box" style="min-height: 500px;">
<div class="row">
<form class="form-horizontal" id="myform" data-parsley-validate novalidate  method="post" onsubmit="setTimeout(function () { location.href = '<?php echo base_url();?>dcbill';},2000)" action="<?php echo base_url();?>dcbill/insert" >
...
<input type="text" class="form-control" name="dispatchthrough" id="dispatchthrough" value="">
<div id="invoiceno_valid"></div>
</div>
</div>
...
<div class="form-group">
<label>Address</label>
<textarea type="text" class="form-control" name="address" readonly="" id="address" parsley-trigger="change" required  rows="5" style="width: 98%;"></textarea>
</div>
</div>
</div>
<div class="clearfix"></div>
