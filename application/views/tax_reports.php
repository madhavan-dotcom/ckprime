        ...
        <div class="col-sm-12">
          <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
            <header class="panel-heading" style="color:rgb(255, 255, 255)">
              <i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Sales GST Reports</span></i>
            </header>
            <div class="card-box table-responsive">
              ...
              <div align="center">
             <button id="print" class="btn btn-info" value="Print"><i class="fa fa-print"></i>  Print Reports</button>
			<button id="download" class="btn btn-primary" ><i class="fa fa-bar-chart-o"></i> Download as Excel</button>
      <button id="hsnexcel_download" class="btn btn-primary" ><i class="fa fa-bar-chart-o"></i> Download as Excel with Hsnno</button>
    </div>
</div>
</div>
</div>
...
$('#print').click(function(){
  ...
  $('#hsnexcel_download').click(function(){
    ...
    var gsttype   = $('#gsttype').val();
    var tax_percent = $('#tax_percent').val();
    $.post('<?php echo base_url();?>tax/hsnexcel_download',{'fromdate':fromdate,'cusname':cusname,'todate':todate,'invoiceno':invoiceno,gsttype:gsttype,tax_percent:tax_percent},function(data){
         window.open('<?php echo base_url();?>tax/search_reports','_blank');
    });
   });
