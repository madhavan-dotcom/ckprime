                                ...
                                <div class="row" style="margin:10px 0;">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ut_report_no" autocomplete="off" id="ut_report_no" value="<?php echo $utno;?>">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ut_date" autocomplete="off" id="ut_Date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="test_date" autocomplete="off" id="test_date">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="calibration_block" autocomplete="off" id="calibration_block">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="equipment" autocomplete="off" id="equipment">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="couplant" autocomplete="off" id="couplant">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="probe" autocomplete="off" id="probe">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="range_of_crt" autocomplete="off" id="range_of_crt">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="frequency" autocomplete="off" id="frequency">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="gain" autocomplete="off" id="gain">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="area_coverage" autocomplete="off" id="area_coverage">
                                ...
                                <div class="row" style="margin:50px 0 10px 0;">   
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="description" autocomplete="off" id="itemname">
                                            <input type="hidden" class="form-control" name="itemid" autocomplete="off" id="itemid">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="drawing" autocomplete="off" id="drawingno">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="heat_no" autocomplete="off" id="heat_no">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="ut_no" autocomplete="off" id="ut_no">
                                        </div>
                                    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $.ajax({
            url : '<?php echo base_url(); ?>Mtc/save_ut',
            type : 'POST',
            data : $('#gradeForm').serialize(),
            success : function(res){
                alert('Ut saved successfully !');
