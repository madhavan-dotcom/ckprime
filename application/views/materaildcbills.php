...
<td align="left" style="border-right: 1px solid black;font-size: 14px;"><strong>&nbsp;&nbsp;&nbsp;<?php echo $itemname[$i];?></strong><br>&nbsp;&nbsp; <small><?php echo $dc_details.$item_descs;?></small></td>
...
<td width="250" valign="top" align="right" ><b>Value (Approx) : Rs. <?php echo $bil->approximate_value; ?>&nbsp;&nbsp;</b> </td>
</tr>

</table>
<table width="750" height="80" align="center" style="border-collapse:collapse;border-bottom:1px solid black;border-right:1px solid black;border-left:1px solid black;">
<tr>  
<td width="380" valign="top" align="right" ><b>For <?php echo $profile->companyname;?></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
</tr>
