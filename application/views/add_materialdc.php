...
<i class="zmdi zmdi-assignment-o"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Material Dc (<?php echo $cusno;?>)</span></i>
</header>
<div class="card-box" style="min-height: 500px;">
<div class="row">
<form class="form-horizontal" id="dc_forms" data-parsley-validate novalidate  method="post" target="_blank" onsubmit="setTimeout(function () { location.href = '<?php echo base_url();?>material_dc'; },2000)"  action="<?php echo base_url();?>material_dc/insert" >
...
<div class="form-group">
<label>Time</label>
<input type="text" class="form-control" name="time" id="time" value="<?php echo date('h:i:A'); ?>">
...
<div class="col-md-3">
<div class="form-group">
<label>Purpose Of Transport</label>
...
<div class="form-group">
<label>Process</label>
<input type="text" class="form-control" name="process" id="process" value="">
<div id="invoiceno_valid"></div>
</div>
</div>
...
<div class="form-group">
<label>Remarks</label>
<input type="text" class="form-control" name="remarkss" id="remarkss" value="">
<div id="invoiceno_valid"></div>
</div>
</div>
...
<div class="form-group">
<label>Address</label>
<textarea type="text" class="form-control" name="address" id="address" parsley-trigger="change" required  rows="5"></textarea style="width: 97%;">
</div>
</div>
</div>
<div class="clearfix"></div>
...
$.post('<?php echo base_url();?>material_dc/get_name',{cusname:cusname},function(res){
...
$.ajax({
type: "POST",
url: "<?php echo base_url();?>material_dc/get_inwardno",
data:{id:cusname}, 
beforeSend :function(){
...
$.ajax({
type: "POST",
url: "<?php echo base_url();?>material_dc/getdc_item",
data:{id:cusname}, 
beforeSend :function(){
...
if(cusname !='')
{
$.post('<?php echo base_url();?>material_dc/check_cusname',{cusname:cusname},function(res){
if(res > 0)
{
$('#cusname_valid').html('<span><font color="green">Available!</span>');
$('#submit').attr('disabled',false);
...
$.post('<?php echo base_url();?>material_dc/getinward_details',{'dctype':dctype},function(data){
...
{
$.post('<?php echo base_url();?>material_dc/getinwarddetails',{'inwardno':inwardno},function(data){
$('.inwarddetails').html(data);
});
}
}
