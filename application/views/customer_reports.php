...
<div align="center">
  <table width="900" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
    ...
    border-top: 1px dotted #000;">
      <td class="heading1" width="316"><div align="left"><strong>Party Reports</strong></div></td>
...
<div align="center">
  <table width="900" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
    <tr style="border-bottom: 1px dotted #000;">
      ...
      <td class="heading2">Party Name</td>
      <td class="heading2">Party Type</td>
...
<?php   $count=1; foreach($cus as $p) {
    ...
    echo'<tr>
      ...
      <td class="padding" valign="top">'.$customertype.'</td>
