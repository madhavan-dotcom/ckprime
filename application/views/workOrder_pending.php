                ...
                <div class="col-sm-12">
                    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
                        <header class="panel-heading" style="color:rgb(255, 255, 255)">
                            <i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Work Order Pending</span></i>
                        </header>
            ...
            $(document).ready(function() {
                $("#customername").autocomplete({
                    source: function(request, response) {
                        $.ajax({
                            url: "<?php echo base_url(); ?>Purchaseorder/autocomplete_customer",
                            data: {
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                table = $('#table').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url('Purchaseorder/ajax_pending_list') ?>",
                        "type": "POST",
                        "data": function(data) {
                ...
                $('#download').click(function() {
                    ...
                    var customername = $('#customername').val(); // Add this if needed

                    // Create a hidden form to submit POST data
                    var form = document.createElement('form');
                    form.method = 'POST';
                    form.action = '<?php echo base_url(); ?>Purchaseorder/excel_download';
                    form.target = '_blank';
                    ...
                    input3.type = 'hidden';
                    input3.name = 'customerId';
                    input3.value = customerId;
                    form.appendChild(input3);

                    // Add customername if needed for filtering
                    var input4 = document.createElement('input');
                    input4.type = 'hidden';
                    input4.name = 'customername';
                    input4.value = customername;
