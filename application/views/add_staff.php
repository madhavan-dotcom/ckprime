        ...
        <div class="col-sm-12">
          <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
            <header class="panel-heading" style="color:rgb(255, 255, 255)">
              <i class="zmdi zmdi-account">&nbsp;Add Staff -(<?php echo $cid;?>)</i> <span style="float: right;"  >
          
            </header>
            <div class="card-box">
              <div class="row">
                <form class="form-horizontal" role="form" data-parsley-validate novalidate method="post" action="<?php echo base_url();?>attendance/insert">
                <input type="hidden" id="staff_id" name="staff_id" value="<?php echo $cid;?>" >
                <div class="forms">
				  <!--ROW 1 -->
                  <div class="col-lg-4">
                      <div class="form-group">
                      <label for="inputStandard">Staff Name<span style="color:red;">&nbsp;*</span></label>
                        <input type="text" name="staff_name" id="staff_name" class="form-control" required parsley-trigger="change" placeholder="Staff Name" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="mobileno" class="form-control" id="mobileno" placeholder="Enter The Mobile Number" data-parsley-type="number"  required data-parsley-length="[10,12]" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="amobileno" class="form-control" id="amobileno" required data-parsley-length="[10,12]"    placeholder="Enter the  Mobile Number">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="dob" id="dob" class="form-control datepicker-autoclose" required parsley-trigger="change" placeholder=" Enter Dob" required>
                        <div id="type_valid"></div>
                      </div>
                    </div>
<!-- 
          ...
          <div class="form-group">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="referred" class="form-control"  id="referred" parsley-trigger="change"  placeholder="Enter The referred name">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="salary" class="form-control"  id="salary" parsley-trigger="change" required placeholder="Enter The Salary">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="perdaysalary" class="form-control"  id="perdaysalary" parsley-trigger="change"  placeholder="Enter The salary ">
                      </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="ot" class="form-control" id="ot" parsley-trigger="change"  placeholder="Enter The over time hours ">
                      </div>
                    </div>
                  ...
                  <div class="col-lg-12" align="center">
                    ...
                    <button type="submit" id="submit" class="btn btn-primary">Add Staff</button>
