...
<tr><td width="100" ><img src="<?php echo base_url();?>upload/<?php echo $profileimage->image;?>" width="100" height="100" alt="logo" /></td> <td width="750" align="center" valign="top" style="font-size:14px;">
<strong style="font-size: 22px;"><?php echo $profile->companyname;?></strong>
<br><?php echo $profile->address1;?><br><?php echo $profile->address2;?>,<?php echo $profile->city;?> - <?php echo $profile->pincode;?>, Tamilnadu<br>    <b style="font-size: 16px;">GSTIN: <?php echo $profile->gstin;?>    </b>
<br>Phone : <?php echo $profile->phoneno;?>&nbsp;<br>Email id : <?php echo $profile->emailid;?> </td>
<td width="180"></td>
</tr>
</table>
...
<tr>
	<td style="font-size:14px;border-right:1px solid black;">
		<table>
			...
			<tr>
	<td width="500"  valign="top" style="font-size:14px;padding: 0;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<?php echo @$addresss1;?>,&nbsp;<?php echo @$addresss2;?>, <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; <?php echo @$citys;?>&nbsp;,&nbsp;<?php echo $states; ?>-<?php echo @$pincode;?>,<?php echo @$mobileno;?> </td>
	</tr>
	<tr>
...
if ($bil->shipTo=='') {
?>
<td width="500" style="font-size:14px;    padding: 3px 0 0px;" ><b>Ship To<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $bil->customername;?></b></td>
<?php } 
else { ?>
<td width="500" height="60" style="font-size:14px;" ><b>Ship To</b> <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<?php echo $bil->shipTo;?></b></td>
<?php } ?>
</tr>
<tr>
	<?php 
...
?> 
<td width="700" style="font-size:14px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo @$bil->shipToAddress;?></td>
<?php } ?>
</tr>
		</table>
	</td>
...
<table width="750" height="400" align="center" style="border: 1px solid #000;    border-collapse: collapse;">
	   <tr style="font-size: 13px;">   
		<th width="35" height="30" align="center" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" rowspan="2"><b>S.No</b></th>
	 
	 
		<th width="<?php echo $itemwidth;?>" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center" rowspan="2"><b>Item Description</b></th>
	 
		  
		<th width="38" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center" rowspan="2"><strong>UOM</strong></th>
	  
		<th width="29" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center" rowspan="2"><b>Qty</b></th>
	 
		<th width="42" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center" rowspan="2"><b>Rate</b></th>
	 
	  
		<th width="66" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center" rowspan="2"><b>Amount</b></th>
		...
		{
			?>
			<th width="40" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center" rowspan="2"><strong>Disc</strong></th>

			<th width="55" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center" rowspan="2"><strong>Taxable Value</strong></th>
		<?php } ?>
		<?php 
		if($bil->gsttype=='intrastate')
		{
			?>
			<th width="47" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center" colspan="2"><b>CGST</b>
		 
			</th>
		 
                
             
			<th width="47" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center" colspan="2"><b>SGST</b></th>
			<th width="48" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center" rowspan="2"><b>Total</b></th>
			<?php
		}
		if($bil->gsttype=='interstate')
		{
			?>
			<th width="43" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center" colspan="2"><b>&nbsp;IGST</b></th>
			<th width="48" style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;" align="center" rowspan="2"><b>Total</b></th>
		<?php }
		if($bils->gsttype=='export')
		{
	...
	<tr> 
	   <th style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;"> % </th> 
	   <th style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;"> Amt</th> 
 	   <th style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;"> %</th> 
	   <th style="border-right:1px solid black;border-bottom:1px solid black;padding:5px;"> Amt</th>
	</tr>
...
// $amount=explode('||',$vob->total);
		...
		for($i=0; $i< $count; $i++){
			...
			else
			{
				...
				@$dc_details='&nbsp;&nbsp;<span align="center" style="font-size:12px;">Dcno: '.$dcnos[$i].' Dt: '.date('d-m-y',strtotime($dcdates)).'</span>';
			...
			<tr style="height:1px;">
				...
				<td align="left" style="border-right: 1px solid black;padding:3px;font-size:14px;"><strong><?php echo $itemname[$i];?><br>
					...
					{
						?>
						<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong>@<?php echo number_format($cgst,2);?>%</td>
	
						<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong><?php echo number_format($cgstamt,2);?></td>
				
						
					
					
						<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong>@<?php echo number_format($sgst,2);?>%</td>
						<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong><?php echo number_format($sgstamt,2);?></td>
						...
						{
							?>
								<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong>@<?php echo number_format($igst,2);?>%</td>
							<td align="right" style="border-right:1px solid black;padding:3px;font-size:12px;"><strong><?php echo number_format($igstamt,2);?></td>
					...
					if($vob->freightamount)
					{
						...
						<tr style="height:1px;">
							...
							if($bil->gsttype=='intrastate')
							{
								...
								?>
									<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong>@<?php echo number_format(@$vob->freightcgst,2);?>%</td>

								<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong><?php echo number_format(@$vob->freightcgstamount,2);?></td>
								<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong>@<?php echo number_format(@$vob->freightsgst,2);?>%</td>

							<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong><?php echo number_format(@$vob->freightsgstamount,2);?></td>
								...
								if($bil->gsttype=='interstate')
								{
									...
									?>
									<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong>@<?php echo number_format(@$vob->freightigst,2);?>%</td>


									<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong><?php echo number_format(@$vob->freightigstamount,2);?></td>
							...
							if($vob->loadingamount)
							{
								...
								<tr style="height:1px;">
									...
									if($bil->gsttype=='intrastate')
									{
										...
										?>
										<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong>@<?php echo number_format(@$vob->loadingcgst,2);?>%</td>
										...
										<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong>@<?php echo number_format(@$vob->loadingigst,2);?>%</td>
											<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong><?php echo number_format(@$vob->loadingsgstamount,2);?></td>
										...
										if($bil->gsttype=='interstate')
										{
											...
											?>
												<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong>@<?php echo number_format(@$vob->loadingigst,2);?>%</td>
>
											<td align="right" style="border-right:1px solid black;padding:3px;font-size:13px;"><strong><?php echo number_format(@$vob->loadingigstamount,2);?></td>
									...
									<tr style="height: 270px;border-bottom: 1px Solid #000;">
									...
									<tfoot>
										...
										<tr >
											...
											{
												?> 
														<td align="right" style="border-bottom:1px solid black;border-right:1px solid black;padding:5px;font-size:14px;font-weight:bold;">&nbsp;</td>
								...
								<table width="750" border="0" align="center" style="border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;">
									<tr>
										<td width="459" valign="top" style="font-size:14px;font-weight:bold;" colspan="3"><span style="font-size:13px;">Rupees : <b style="font-size:13px;"><?php echo $fin;?> only</b></span></td>
										<td width="201" align="right" style=""><span style="font-size:16px;font-weight:bold;">&nbsp;&nbsp;</span></td>
										<td width="90" align="right">&nbsp;<b></b></td>
									</tr>
									<tr>
										<td width="459" valign="top" style="font-size:14px;font-weight:bold;" colspan="3"><span style="font-size:15px;">Bank Details</span></td>
...
<td colspan="2"><span style="font-size:14px;"><?php echo $profile->bankname;?></span>&nbsp;</td>
...
<tr>
	<td  style=""><span style="font-size:14px;">&nbsp;Bank Branch&nbsp;:</span></td>
	<td align="left" style=""  colspan="2"><span style="font-size:14px;"><?php echo $profile->bankbranch;?></span>&nbsp;&nbsp;</td>
	<!-- <td></td>	 -->
	<td align="right" style=""><span style="font-size:16px;font-weight:bold;">Other Charges&nbsp;&nbsp;:</span></td>
	<td align="right" ><b><?php echo  number_format((float)$bil->othercharges,2);?></b>&nbsp;</td>
</tr>
<tr>
	<td style="font-size:14px;"><span style="font-size:14px;">&nbsp;Account No&nbsp;&nbsp;&nbsp;:</span></td>
	<td  colspan="2"><span style="font-size:14px;"><?php echo $profile->accountno;?></span></td>
	<!-- <td></td> -->
...
<tr>
 ...
 --><tr>
	...
	<td  style=""><span style="font-size:14px;">&nbsp;IFSC Code&nbsp;&nbsp;&nbsp;&nbsp;:</span></td>
	<td align="left" style="" colspan="2"><span style="font-size:14px;"><?php echo $profile->ifsccode;?></span></td>
	<td align="right">&nbsp;</td>
	<td align="right">&nbsp;</td>
</tr>
