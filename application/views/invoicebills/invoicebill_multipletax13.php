...
<tr><td width="200" ><img src="<?php echo base_url();?>upload/<?php echo $profileimage->image;?>" width="150" height="100" alt="logo" /></td> <td width="1500" align="center" valign="top" style="font-size:14px;">
