...
<tr>
<td width="150" ><img src="<?php echo base_url();?>upload/<?php echo $profileimage->image;?>" width="150" height="100" alt="logo" /></td>
<td width="450" align="center" valign="top" style="font-size:14px;">
<strong style="font-size: 18px;"><?php echo $profile->companyname;?></strong><br><?php echo $profile->address1;?>,<?php echo $profile->address2;?><?php echo $profile->city;?> - <?php echo $profile->pincode;?>, Tamilnadu<br><b>GSTIN: <?php echo $profile->gstin;?></b>
...
<?php $odate=$orderdate; if($odate == '1970-01-01'||'1969-01-01'){echo "";}else{ $order_date=date('d/m/Y',strtotime($odate)); echo date('d/m/Y',strtotime($orderdate));}?>
</b></td>
</tr>
<tr>
...
<table width="<?php echo $page_width;?>"   height="350" align="center"  style="border-bottom:1px solid black;border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;border-collapse:collapse;">
