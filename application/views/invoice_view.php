...
<div class="content-page">
    ...
    <div class="content">
                ...
                <div class="col-sm-12">
                    <section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
                        <header class="panel-heading" style="color:rgb(255, 255, 255)">
                            <i class="zmdi zmdi-view-headline"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Invoice Reports</span></i>
                        </header>
                ...
                <table>
                    <tr>
                        <td><input type="hidden" name="fromdate" class="form-control"
                                value="<?php if ($this->input->post('fromdate')) {
                                            echo $this->input->post('fromdate');
                                        } ?>"></td>
                        <td><input type="hidden" name="todate" class="form-control" value="<?php if ($this->input->post('todate')) {
        ...
        <div id="delete_billing" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form id="delete_form">
                    <div class="modal-content">
                        ...
                        <div align="center">
                            ...
                            <button type="button" id="dialogCancel" data-dismiss="modal" class="btn btn-primary waves-effect">Cancel</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('#delete_form').submit(function(e) {
                    ...
                    var $confirmBtn = $('#dialogConfirm');
                    var $modal = $('#delete_billing');

                    $confirmBtn.text('Processing...');
                    $confirmBtn.prop('disabled', true);

                    $.post('<?php echo base_url(); ?>invoice/delete', {
                        id: id
                    }, function(res) {
                        ...
                        if (res.trim() == 'yes') {
                            ...
                            $('.unsuccess').fadeIn().delay(3000).fadeOut();
                        } else if (res == 'einvoice') {
                            $('.success1').fadeIn().delay(3000).fadeOut();
                        }
                    }).fail(function() {
                        $confirmBtn.text('Confirm');
                        $confirmBtn.prop('disabled', false);
