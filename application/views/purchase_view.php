    ...
    padding-bottom: 0px;
			...
			<div class="col-sm-12">
				<section class="panel" style="background: #267296 none repeat scroll 0% 0%;border: 1px solid #267296;">
					<header class="panel-heading" style="color:rgb(255, 255, 255)">
						<i class="zmdi zmdi-shopping-cart"><span style="font-family: 'Quicksand', sans-serif;padding-left: 6px;">Purchase Reports</span></i>
					</header>
					<div class="card-box table-responsive">
						...
						<div align="center">
							<button id="print" class="btn btn-info" value="Print">Print Purchase Reports</button>
		...
		$.post('<?php echo base_url();?>purchase/download',{'fromdate':fromdate,'suppliername':suppliername,'todate':todate,'invoiceno':invoiceno},function(data){

		window.open('<?php echo base_url();?>purchase/excel_download', '_blank');
