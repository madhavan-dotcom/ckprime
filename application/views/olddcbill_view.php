...
<i class="zmdi zmdi-view-headline">&nbsp;Old Dc Reports</i>
</header>
...
$.ajax({ 
url: "<?php echo base_url();?>olddcbill/autocomplete_cusname",
...
"ajax": {
"url": "<?php echo site_url('olddcbill/ajax_list')?>",
"type": "POST",
"data": function ( data ) {
...
$.post('<?php echo base_url();?>olddcbill/search',{'fromdate':fromdate,'customername':customername,'todate':todate},function(data){

window.open('<?php echo base_url();?>olddcbill/search_reports', '_blank');
...
$.post('<?php echo base_url(); ?>olddcbill/delete',{id:id},function(res){
...
$.post('<?php echo base_url();?>olddcbill/viewdc',{'id':id},function(data){
